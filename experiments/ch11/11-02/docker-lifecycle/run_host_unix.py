...
def main():
    ...
    save(O/'environment.json',dict(runid=runid,base_image_id=base,
        ...
        source_hashes={n:hashlib.sha256((R/n).read_bytes()).hexdigest() for n in ['run_host_unix.py','worker_unix.py','PROTOCOL.md']}))
