...
| quality_and_deadline_probability_exact | `"0"` |
...
| cost_per_quality_and_deadline_success_exact | `null` |

| 节点路径 | 终点 | 路径概率 | 全路径费用 | 时间秒 | CPU核秒 | 驻留bytes·s | 质量且按时 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| initial | success | 4/5 | 1/100 | 10 | 3 | 21474836480 | False |
| initial → repair | success | 9/125 | 2/125 | 14 | 4 | 30064771072 | False |
