...
上传有效输入 **2,336 B**；响应有效输出 **32 B**；声明模型工作 **1 s**。
...
|---|---:|---:|---:|---:|---:|---:|
| up | 9824 | 1 | 4 | 3664 | 112 | 3776 |
| down | 736 | 1 | 4 | 256 | 112 | 368 |

截至 horizon 实际串行线上字节：**4144 B**；已开始包的完整声明字节可能包含截止后尚未发完部分。接收唯一字节：**2368 B**。
...
| down/0 | ack | 控制 | 2 | 3 | 4 | None | 92 | True | None | —/— |
| down/1 | ack | 控制 | 3 | 4 | 5 | 5 | 92 | False | None | —/— |
| down/2 | data | business:[0,32) | 4 | 5 | 6 | 6 | 92 | False | None | —/— |
| up/2 | data | business:[0,1168) | 5 | 6 | 7 | 7 | 1228 | False | 0 | —/— |
| up/3 | ack | 控制 | 6 | 1865/307 | 2172/307 | 2172/307 | 92 | False | None | —/— |
| down/3 | ack | 控制 | 7 | 8 | 9 | 9 | 92 | False | None | —/— |
...
| 6 | application_prefix | down | `{"prefix": 32}` |
...
{
  "wire_bytes": 4144,
  "serialized_wire_bytes_by_horizon": "4144",
  "unique_received_bytes": 2368,
  "pending_packets": {
    "up": 0,
    "down": 0
  },
