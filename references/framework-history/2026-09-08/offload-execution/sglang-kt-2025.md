<!-- 从 sglang-kt-2025.html 迁移的资料快照；原始 HTML SHA-256: ede1b00af0751a9966078bd5721cd99bebc2350ece19bca8b498c23aad688514。 -->
...
- [Background: Hybrid Inference for Sparse MoE Models](#background-hybrid-inference-for-sparse-moe-models)
- [KTransformers: Unleashing the Full Potential of CPU/GPU Hybrid Inference for MoE Models](#ktransformers-unleashing-the-full-potential-of-cpugpu-hybrid-inference-for-moe-models)
- [1. AMX-Specialized CPU Kernels](#1-amx-specialized-cpu-kernels)
- [2. Efficient Device Coordination](#2-efficient-device-coordination)
- [3. Expert Deferral: Overlapping Model Execution](#3-expert-deferral-overlapping-model-execution)
- [Integrating KTransformers into SGLang](#integrating-ktransformers-into-sglang)
- [Installation](#installation)
- [Prerequisites](#prerequisites)
- [Step 1: Install SGLang](#step-1-install-sglang)
- [Step 2: Install KTransformers CPU Kernels](#step-2-install-ktransformers-cpu-kernels)
- [Usage Example](#usage-example)
- [Downloading Models](#downloading-models)
- [Launching the Server](#launching-the-server)
- [Key Parameters](#key-parameters)
- [Hardware Requirements](#hardware-requirements)
- [Benchmark Results (Preview)](#benchmark-results-preview)
- [Single-GPU + CPU Performance](#single-gpu--cpu-performance)
- [Multi-GPU + CPU Performance](#multi-gpu--cpu-performance)
- [ShareGPT Benchmark on NVIDIA L20 × 8 Setup](#sharegpt-benchmark-on-nvidia-l20--8-setup)
- [Acknowledgements](#acknowledgements)
- [Related resources](#related-resources)

# Accelerating Hybrid Inference in SGLang with KTransformers CPU Kernels

KVCache.AI and Approaching AIOctober 22, 2025
...
![](/images/blog/ktransformers/heterogeneous_computing.png)
...
![](/images/blog/ktransformers/expert_deferral.png)
...
![](/images/blog/ktransformers/prefill_performance.png)
...
![](/images/blog/ktransformers/decode_performance.png)
...
![](/images/blog/ktransformers/multigpu_performance.png)
