<!-- 从 linux-v69-pin-user-pages.html 迁移的资料快照；原始 HTML SHA-256: 9b222b36a667f530c5deb4dbb6e8c82ea4adecbf7fbb58f300b8a7e7853ff65d。 -->

# pin_user_pages() and related calls[¶](#pin-user-pages-and-related-calls "Permalink to this heading")

- [Overview](#overview)

- [Basic description of FOLL_PIN](#basic-description-of-foll-pin)

- [Which flags are set by each wrapper](#which-flags-are-set-by-each-wrapper)

- [Tracking dma-pinned pages](#tracking-dma-pinned-pages)

- [FOLL_PIN, FOLL_GET, FOLL_LONGTERM: when to use which flags](#foll-pin-foll-get-foll-longterm-when-to-use-which-flags)

  - [CASE 1: Direct IO (DIO)](#case-1-direct-io-dio)

  - [CASE 2: RDMA](#case-2-rdma)

  - [CASE 3: MMU notifier registration, with or without page faulting hardware](#case-3-mmu-notifier-registration-with-or-without-page-faulting-hardware)

  - [CASE 4: Pinning for struct page manipulation only](#case-4-pinning-for-struct-page-manipulation-only)

  - [CASE 5: Pinning in order to write to the data within the page](#case-5-pinning-in-order-to-write-to-the-data-within-the-page)

- [page_maybe_dma_pinned(): the whole point of pinning](#page-maybe-dma-pinned-the-whole-point-of-pinning)

- [Another way of thinking about FOLL_GET, FOLL_PIN, and FOLL_LONGTERM](#another-way-of-thinking-about-foll-get-foll-pin-and-foll-longterm)
...
## [Basic description of FOLL_PIN](#id2)[¶](#basic-description-of-foll-pin "Permalink to this heading")
...
## [Which flags are set by each wrapper](#id3)[¶](#which-flags-are-set-by-each-wrapper "Permalink to this heading")
...
For large folios, the GUP_PIN_COUNTING_BIAS scheme is not used. Instead, the extra space available in the [`struct`` ``folio`](mm-api.html#c.folio "folio") is used to store the pincount directly.
...
## [Tracking dma-pinned pages](#id4)[¶](#tracking-dma-pinned-pages "Permalink to this heading")
...
## [FOLL_PIN, FOLL_GET, FOLL_LONGTERM: when to use which flags](#id5)[¶](#foll-pin-foll-get-foll-longterm-when-to-use-which-flags "Permalink to this heading")

Thanks to Jan Kara, Vlastimil Babka and several other -mm people, for describing these categories:

### [CASE 1: Direct IO (DIO)](#id6)[¶](#case-1-direct-io-dio "Permalink to this heading")
...
### [CASE 2: RDMA](#id7)[¶](#case-2-rdma "Permalink to this heading")
...
### [CASE 3: MMU notifier registration, with or without page faulting hardware](#id8)[¶](#case-3-mmu-notifier-registration-with-or-without-page-faulting-hardware "Permalink to this heading")
...
### [CASE 4: Pinning for struct page manipulation only](#id9)[¶](#case-4-pinning-for-struct-page-manipulation-only "Permalink to this heading")
...
### [CASE 5: Pinning in order to write to the data within the page](#id10)[¶](#case-5-pinning-in-order-to-write-to-the-data-within-the-page "Permalink to this heading")
...
## [page_maybe_dma_pinned(): the whole point of pinning](#id11)[¶](#page-maybe-dma-pinned-the-whole-point-of-pinning "Permalink to this heading")
...
## [Another way of thinking about FOLL_GET, FOLL_PIN, and FOLL_LONGTERM](#id12)[¶](#another-way-of-thinking-about-foll-get-foll-pin-and-foll-longterm "Permalink to this heading")
...
## [Unit testing](#id13)[¶](#unit-testing "Permalink to this heading")
...
## [Other diagnostics](#id14)[¶](#other-diagnostics "Permalink to this heading")
...
## [References](#id15)[¶](#references "Permalink to this heading")
