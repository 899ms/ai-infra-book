...
输入：`{"accumulator": "FP32", "bandwidth_multiplier": 1.0, "batch": 1, "compute_input": "BF16", "compute_multiplier": 1.0, "device": "h100-sxm", "kv_append_bytes_per_request": 0, "kv_history_bytes_per_request": 0, "metadata_bytes": 0, "parameters": 70000000000, "sparsity": "dense", "weight_bits": 4, "workspace_bytes": 0}`
...
| weight_payload_bytes | 35,000,000,000 |
| declared_read_write_bytes | 35,000,000,000 |
| declared_resident_bytes | 35,000,000,000 |
| nominal_capacity_bytes | 80,000,000,000 |
| fits_declared_budget | `true` |
| arithmetic_intensity_flops_per_byte | 4.0 |
| compute_service_seconds | 0.00014149989892864363 |
| memory_service_seconds | 0.010447761194029851 |
| resource_lower_bound_seconds | 0.010447761194029851 |
| capacity_feasible_throughput_upper_tokens_per_second | 95.71428571428571 |
| compute_memory_crossover_batch | 74 |
