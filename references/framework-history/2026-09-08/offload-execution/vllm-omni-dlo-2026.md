<!-- 从 vllm-omni-dlo-2026.html 迁移的资料快照；原始 HTML SHA-256: 51764cc15018c8f3af034d3542aee152eb67e51b32cc8ac1b8ba329f9f23b4d8。 -->

[Blog](/blog)

# Distributed Layerwise Offload: Scaling Toward 200B+ DiT Models Efficiently in vLLM-Omni

August 17, 202623 min read

vLLM-Omni Diffusion Team

[\#performance](/blog/tags/performance)[\#distributed](/blog/tags/distributed)[\#vllm-omni](/blog/tags/vllm-omni)[\#cosmos3](/blog/tags/cosmos3)

- [TL;DR](#tldr)
- [Quickstart](#quickstart)
- [The Problem: Large Diffusion Models vs. HBM and Host Memory](#the-problem-large-diffusion-models-vs-hbm-and-host-memory)
- [Solution Overview](#solution-overview)
- [1. Meta Device + mmap Weight Loading](#1-meta-device--mmap-weight-loading)
- [2. Weight Sharding with AllGather Reconstruction](#2-weight-sharding-with-allgather-reconstruction)
- [3. Double-Buffered Prefetch with H2D + AllGather Overlap](#3-double-buffered-prefetch-with-h2d--allgather-overlap)
- [4. DP Multi-Concurrency: N Requests in Parallel](#4-dp-multi-concurrency-n-requests-in-parallel)
- [Ascend Memory Accounting: cgroup-visible vs. Physical RAM](#ascend-memory-accounting-cgroup-visible-vs-physical-ram)
- [Validation Results](#validation-results)
- [Correctness](#correctness)
- [Host Memory (cgroup peak)](#host-memory-cgroup-peak)
- [NPU HBM](#npu-hbm)
- [Performance](#performance)
- [NVIDIA B300 GPU Results](#nvidia-b300-gpu-results)
- [1024×1024 T2I, 50 steps](#10241024-t2i-50-steps)
- [832×480 T2V, 29 frames, 35 steps](#832480-t2v-29-frames-35-steps)
- [Workload Latency and HBM (35 steps, DLO+AG DP4 vs HSDP+USP4)](#workload-latency-and-hbm-35-steps-dloag-dp4-vs-hsdpusp4)
- [MiniMax-H3 on 8× B300: DLO mode is topology-dependent](#minimax-h3-on-8-b300-dlo-mode-is-topology-dependent)
- [Extrapolation to 400 GB](#extrapolation-to-400-gb)
...
![Why Distributed Layerwise Offload is needed](/blog-assets/figures/2026-07-30-distributed-layerwise-offload/dlo-problem-overview.svg)
...
![Meta-device and mmap loading memory comparison](/blog-assets/figures/2026-07-30-distributed-layerwise-offload/mmap-loading-memory.svg)
...
![Weight sharding and AllGather reconstruction](/blog-assets/figures/2026-07-30-distributed-layerwise-offload/weight-sharding-allgather.svg)
...
![DLO Double-Buffer Prefetch Pipeline](/blog-assets/figures/2026-07-30-distributed-layerwise-offload/dlo_pipeline_last_frame.png)
...
![DLO Double-Buffer Prefetch Pipeline Animation](/blog-assets/figures/2026-07-30-distributed-layerwise-offload/dlo_pipeline.gif)
...
![HBM usage for Cosmos3-Nano and Cosmos3-Super](/blog-assets/figures/2026-07-30-distributed-layerwise-offload/hbm-nano-vs-super.svg)
...
![DP multi-concurrency request flow](/blog-assets/figures/2026-07-30-distributed-layerwise-offload/dp-multi-concurrency.svg)
...
![Ascend host and HBM memory accounting](/blog-assets/figures/2026-07-30-distributed-layerwise-offload/ascend-memory-accounting.svg)
...
![Topology-aware DLO policy for MiniMax-H3 on eight B300 GPUs](/blog-assets/figures/2026-07-30-distributed-layerwise-offload/minimax-h3-topology-policy.svg)
...
![FL2VA and Ref2VA latency-throughput Pareto frontiers on MiniMax-H3](/blog-assets/figures/2026-07-30-distributed-layerwise-offload/minimax-h3-multimodal-frontiers.png)
...
[](/blog/2026-07-01-qwen3-omni-optimization)
