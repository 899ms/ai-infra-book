<!-- 从 sglang-hicache.html 迁移的资料快照；原始 HTML SHA-256: ad9cdbf20502a13855b9d11546e55d707e90ae925490f23e6c3745071981788e。 -->
...
- [Why Hierarchical KV Caching Matters](#why-hierarchical-kv-caching-matters)
- [Design of SGLang HiCache:](#design-of-sglang-hicache)
- [Optimized data plane](#optimized-data-plane)
- [Versatile control plane](#versatile-control-plane)
- [Pick your favorite storage backend or bring your own!](#pick-your-favorite-storage-backend-or-bring-your-own)
- [Benchmark](#benchmark)
- [Acknowledgement:](#acknowledgement)

# SGLang HiCache: Fast Hierarchical KV Caching with Your Favorite Storage Backends

Zhiqiang XieSeptember 10, 2025
