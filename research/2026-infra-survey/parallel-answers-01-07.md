...
类别：计量定义缺口，低优先级。位置：[题表](interview-directions.md)第 39 行；对应[第 5 章](../../archive/outlines/05-算子与运行时.md)第 291–305 行。
...
类别：证据状态表述矛盾，非性能算术错误。位置：[第 5 章](../../archive/outlines/05-算子与运行时.md)第 295、305 行；[实验 5-9](../../experiments/ch05/05-09/README.md)第 28、43–75 行。
