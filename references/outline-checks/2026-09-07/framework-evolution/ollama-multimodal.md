<!-- 从 ollama-multimodal.html 迁移的资料快照；原始 HTML SHA-256: 6989f6fc4475a892462e54cab30740e0f1f738a956a9c963d77edd47d301828a。 -->
...
![multimodality Ollama](/public/blog/multimodal.png)
...
![video frame analysis example](/public/blog/multimodal-example1-min.png)

![video frame analysis example answer](/public/blog/multimodal-example1-answer-min.png)
...
![multiple images](/public/blog/multi-images.png)

![gemma 3 answers](/public/blog/gemma3-answer.png)
...
![check example](/public/blog/check-example.jpg)

![check answer](/public/blog/check-example-answer-min.png)

Example understanding and translating vertical Chinese spring couplets to English:

![spring couplets example](/public/blog/spring-couplets.jpg)

![spring couplets answer](/public/blog/spring-couplets-answer.png)

## Ollama’s new multimodal engine

![Ollama’s new car](/public/blog/ollama-car.png)

Ollama has so far relied on the [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) project for model support and has instead focused on ease of use and model portability.
...
Examples of how some models are implemented are available on [Ollama’s GitHub repository](https://github.com/ollama/ollama/tree/main/model/models).
...
Thank you to the GGML team for the tensor library that powers Ollama’s inference. Being able to access GGML directly from Go has given a portable way to design custom inference graphs and tackle harder model architectures not available before in Ollama.
