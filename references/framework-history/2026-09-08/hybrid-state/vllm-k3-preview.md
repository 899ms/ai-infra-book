<!-- 从 vllm-k3-preview.html 迁移的资料快照；原始 HTML SHA-256: 994a088f711a36a4149c5e7cbb024f05dd68051a95a5887dee65ef1e8e8ec57f。 -->
...
[\#models](/blog/tags/models)[\#performance](/blog/tags/performance)[\#prefix caching](/blog/tags/prefix%20caching)[\#multimodal](/blog/tags/multimodal)

- [TL;DR](#tldr)
- [Kimi K3 at a Glance](#kimi-k3-at-a-glance)
- [A Collaboration Built Over Multiple Kimi Generations](#a-collaboration-built-over-multiple-kimi-generations)
- [The Hardest Part: Prefix Caching for KDA](#the-hardest-part-prefix-caching-for-kda)
- [Performance Work: Removing the New Bottlenecks](#performance-work-removing-the-new-bottlenecks)
- [KDA prefill and decode](#kda-prefill-and-decode)
- [Attention Residuals](#attention-residuals)
- [Optimized MLA module for native PD disaggregation deployment](#optimized-mla-module-for-native-pd-disaggregation-deployment)
- [MXFP4 MoE](#mxfp4-moe)
- [What to Expect on Open-Source Day](#what-to-expect-on-open-source-day)
- [Acknowledgements](#acknowledgements)
- [One More Thing: Why the Announcement and Open-Source Release Are Separated](#one-more-thing-why-the-announcement-and-open-source-release-are-separated)
...
![How conventional attention and KDA represent cached prefixes](/blog-assets/figures/2026-07-22-kimi-k3-preview/kda-prefix-state.png)
...
![Fine-grained prefix matching inside a larger physical KDA state block](/blog-assets/figures/2026-07-22-kimi-k3-preview/fine-grained-prefix-cache.png)
