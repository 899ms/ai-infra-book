...
```json
{
  ...
  "bandwidth": {
    "fabric_bytes_per_second": 6250000000,
    "sender_bytes_per_second": 6250000000,
    "receiver_bytes_per_second": 6250000000
  },
  ...
  "annotation": "Migration traffic shares one 50 GbE port (6.25 GB/s per direction). Nine runtime terms of 1 s each are declared teaching inputs."
}
```
...
| 字段 | 值 |
| --- | --- |
| fabric_bytes_per_second | 25702572/9765625 |
| sender_bytes_per_second | 36712456/48828125 |
| receiver_bytes_per_second | 18361044/48828125 |
| network_bytes | 16449646080 |
| transfer_lower_bound_exact_seconds | 25702572/9765625 |
| partial_known_transfer_bound_exact_seconds | 25702572/9765625 |
| missing_runtime_terms | [] |
| known_serial_runtime_seconds_exact | 9 |
| conditional_serial_switch_lower_bound_exact_seconds | 113593197/9765625 |
