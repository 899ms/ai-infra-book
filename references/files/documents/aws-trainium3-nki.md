<!-- 从 aws-trainium3-nki.html 迁移的资料快照；原始 HTML SHA-256: 013c406f63e790d32511c9b9600d577685b6723c740a92c79db2167c5aefbdf4。 -->

- [ Repository](https://github.com/aws-neuron/aws-neuron-sdk "Source repository")
- [ Suggest edit](https://github.com/aws-neuron/aws-neuron-sdk/edit/master/nki/guides/architecture/trainium3_arch.rst "Suggest edit")
- [ Open issue](https://github.com/aws-neuron/aws-neuron-sdk/issues/new?title=Issue%20on%20page%20%2Fnki/guides/architecture/trainium3_arch.html&body=Your%20issue%20content%20here. "Open an issue")

- [ .rst](../../../_sources/nki/guides/architecture/trainium3_arch.rst "Download source file")
-  .pdf
...
- [NeuronCore-v4 Compute Engine Updates](#neuroncore-v4-compute-engine-updates)
- [Tensor Engine](#tensor-engine)
  - [Quad-MXFP8/MXFP4 Matmul Performance](#quad-mxfp8-mxfp4-matmul-performance)
  - [BF16 Matmul Results in PSUM](#bf16-matmul-results-in-psum)
  - [Background Transpose](#background-transpose)
- [Vector Engine](#vector-engine)
  - [MX data-type Quantization](#mx-data-type-quantization)
  - [Fast Exponential Evaluation](#fast-exponential-evaluation)
  - [XORWOW-based PRNG](#xorwow-based-prng)
- [Scalar Engine](#scalar-engine)
  - [Performance mode](#performance-mode)
  - [More flexible `nisa.activation`](#more-flexible-nisa-activation)
- [Data Movement and DMA updates](#data-movement-and-dma-updates)
  - [SBUF/PSUM indirect access](#sbuf-psum-indirect-access)
  - [SBUF Read-Add-Write](#sbuf-read-add-write)
  - [DMA Traffic Shaping](#dma-traffic-shaping)

**This document is relevant for**: `Trn2`, `Trn3`

<a id="trainium3-architecture-guide-for-nki"></a>

# Trainium3 Architecture Guide for NKI
In this guide, we will dive into the hardware architecture of fourth-generation NeuronDevices: Trainium3. This guide will highlight major architectural updates compared to the previous generation (Trainium2). Therefore, we assume readers are familiar with [Trainium/Inferentia2 Architecture Guide](trainium_inferentia2_arch.html) and [Trainium2 Architecture Guide for NKI](trainium2_arch.html) to understand the basics of NeuronDevice Architecture.
...
<a id="neuroncore-v4-compute-engine-updates"></a>
...
Table 11 Compute Engine Specifications[\#](#id3 "Permalink to this table") {#id3}

Sync Engine has not changed since [previous Trainium architectures](trainium_inferentia2_arch.html). Next, we will go over major architectural updates to each compute engine.
...
![](../../../_images/nki-trn3-arch-9.png)

<a id="background-transpose"></a>
...
<a id="mx-data-type-quantization"></a>
...
In NKI, programmers can perform such an MX data type quantization using the [nisa.quantize_mx](../../api/generated/nki.isa.quantize_mx.html) API.

<a id="fast-exponential-evaluation"></a>

### Fast Exponential Evaluation
The NeuronCore-v4 Vector Engine introduces a new instruction to perform fast exponential evaluation ([nisa.exponential](../../api/generated/nki.isa.exponential.html)), at 4x the throughput compared to the [nisa.activation](../../api/generated/nki.isa.activation.html) (`op=nl.exp`) instruction on the Scalar Engine. In addition to the exponential function, the instruction on Vector Engine can also apply a subtraction before the exponential function and an accumulation after:
...
### Performance mode
The Trainium3 ScalarE now natively supports the [tensor_scalar](../../api/generated/nki.isa.tensor_scalar.html) and [tensor_copy](../../api/generated/nki.isa.tensor_copy.html) instructions (same as VectorE), and offers up to 2x performance uplift for BF16/FP16 datatypes, which is the same as the 2x performance mode on VectorE introduced with Trainium2. For those instructions, NKI users are able to select the execution engine, which can help offload either one of the engines, or load balance between them, depending on workload characteristics.

<a id="more-flexible-nisa-activation"></a>
...
<a id="data-movement-and-dma-updates"></a>

## Data Movement and DMA updates
<a id="sbuf-psum-indirect-access"></a>
...
![](../../../_images/nki-trn3-arch-15.png)

<a id="dma-traffic-shaping"></a>
...
[](trainium2_arch.html "previous page")

previous

Trainium2 Architecture Guide for NKI

[](../nki_simulator.html "next page")
