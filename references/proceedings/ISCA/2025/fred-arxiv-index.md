<!-- 从 fred-arxiv-index.html 迁移的资料快照；原始 HTML SHA-256: b32b5bdc7d9e4c74c2103b5d3bcdd3fb1e8cabebc8148bd714049755850c875e。 -->

# Computer Science \> Hardware Architecture

**arXiv:2406.19580** (cs)

\[Submitted on 28 Jun 2024 ([v1](https://arxiv.org/abs/2406.19580v1)), last revised 9 Jun 2025 (this version, v2)\]
...
Authors:[Saeed Rashidi](https://arxiv.org/search/cs?searchtype=author&query=Rashidi,+S), [William Won](https://arxiv.org/search/cs?searchtype=author&query=Won,+W), [Sudarshan Srinivasan](https://arxiv.org/search/cs?searchtype=author&query=Sudarshan), [Puneet Gupta](https://arxiv.org/search/cs?searchtype=author&query=Gupta,+P), [Tushar Krishna](https://arxiv.org/search/cs?searchtype=author&query=Krishna,+T)

View a PDF of the paper titled FRED: Flexible REduction-Distribution Interconnect and Communication Implementation for Wafer-Scale Distributed Training of DNN Models, by Saeed Rashidi and 4 other authors

[View PDF](/pdf/2406.19580) [HTML (experimental)](https://arxiv.org/html/2406.19580v2)
...
From: Saeed Rashidi \[[view email](/show-email/f60f33a2/2406.19580)\]  
**[\[v1\]](/abs/2406.19580v1)** Fri, 28 Jun 2024 00:05:53 UTC (1,626 KB)  
**\[v2\]** Mon, 9 Jun 2025 06:50:50 UTC (503 KB)  
...
- [View PDF](/pdf/2406.19580)

- [HTML (experimental)](https://arxiv.org/html/2406.19580v2)

- [TeX Source](/src/2406.19580)
...
[\< prev](/prevnext?id=2406.19580&function=prev&context=cs.AR "previous in cs.AR (accesskey p)")   \|   [next \>](/prevnext?id=2406.19580&function=next&context=cs.AR "next in cs.AR (accesskey n)")   

[new](/list/cs.AR/new) \| [recent](/list/cs.AR/recent) \| [2024-06](/list/cs.AR/2024-06)

Change to browse by:

[cs](/abs/2406.19580?context=cs)  
[cs.LG](/abs/2406.19580?context=cs.LG)  

### References & Citations

- [NASA ADS](https://ui.adsabs.harvard.edu/abs/arXiv:2406.19580)
- [Google Scholar](https://scholar.google.com/scholar_lookup?arxiv_id=2406.19580)
- [Semantic Scholar](https://api.semanticscholar.org/arXiv:2406.19580)
...
[![BibSonomy](/static/browse/0.3.4/images/icons/social/bibsonomy.png)](http://www.bibsonomy.org/BibtexHandler?requTask=upload&url=https://arxiv.org/abs/2406.19580&description=FRED:%20Flexible%20REduction-Distribution%20Interconnect%20and%20Communication%20Implementation%20for%20Wafer-Scale%20Distributed%20Training%20of%20DNN%20Models "Bookmark on BibSonomy") [![Reddit](/static/browse/0.3.4/images/icons/social/reddit.png)](https://reddit.com/submit?url=https://arxiv.org/abs/2406.19580&title=FRED:%20Flexible%20REduction-Distribution%20Interconnect%20and%20Communication%20Implementation%20for%20Wafer-Scale%20Distributed%20Training%20of%20DNN%20Models "Bookmark on Reddit")
...
[Which authors of this paper are endorsers?](/auth/show-endorsers/2406.19580) \| [Disable MathJax](javascript:setMathjaxCookie()) ([What is MathJax?](https://info.arxiv.org/help/mathjax.html))
