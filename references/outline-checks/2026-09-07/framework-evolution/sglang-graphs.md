<!-- 从 sglang-graphs.html 迁移的资料快照；原始 HTML SHA-256: c9b47157565e96997b83ebed0b0860fc6ff50e8e06b0565cef1adb19340254e7。 -->
...
- [Full CUDA Graph](#full-cuda-graph)
- [Breakable CUDA Graph](#breakable-cuda-graph)
- [TC piecewise CUDA Graph](#tc-piecewise-cuda-graph)
- [Breakable CUDA Graph: Eager Breaks without a Compiler](#breakable-cuda-graph-eager-breaks-without-a-compiler)
- [Origin and Open-Source Lineage](#origin-and-open-source-lineage)
- [Design and Mechanism](#design-and-mechanism)
- [Benefits](#benefits)
- [BCG in Diffusion](#bcg-in-diffusion)
- [Full CUDA Graph for Prefill](#full-cuda-graph-for-prefill)
- [Making prefill static](#making-prefill-static)
- [What does the padding cost?](#what-does-the-padding-cost)
- [Prefill benchmark](#prefill-benchmark)
- [Memory Footprint of CUDA Graphs](#memory-footprint-of-cuda-graphs)
- [Reuse inside a segmented capture](#reuse-inside-a-segmented-capture)
- [Capture through the chunked-prefill size](#capture-through-the-chunked-prefill-size)
- [BCG as a Standalone Library](#bcg-as-a-standalone-library)
- [Acknowledgments](#acknowledgments)

# Advanced CUDA Graph Techniques in SGLang

SGLang TeamAugust 17, 2026
...
![](/images/blog/breakable_cuda_graph/bcg-design.svg)
...
![](/images/blog/breakable_cuda_graph/prefill-build.svg)
...
![](/images/blog/breakable_cuda_graph/diffusion.svg)
...
![](/images/blog/breakable_cuda_graph/full-prefill.svg)
...
![](/images/blog/breakable_cuda_graph/prefill-ttft.svg)
...
![](/images/blog/breakable_cuda_graph/cg-memory.svg)
