<!-- 从 vllm-kv-offload-2026.html 迁移的资料快照；原始 HTML SHA-256: 506f04f9342df0a094fc7b36f615cf461a21bb8d695e981e1d9bebb858c1ae7f。 -->
...
- [The New Offloading Connector](#the-new-offloading-connector)
- [The vLLM Connector API](#the-vllm-connector-api)
- [Using the Offloading Connector](#using-the-offloading-connector)
- [Benefits of CPU Offloading via the Offloading Connector](#benefits-of-cpu-offloading-via-the-offloading-connector)
- [vLLM versions of the Offloading Connector](#vllm-versions-of-the-offloading-connector)
- [Evaluating GPU-CPU Transfer Techniques](#evaluating-gpu-cpu-transfer-techniques)
- [Changing vLLM’s Memory Layout](#changing-vllms-memory-layout)
- [End-to-end Evaluation of Copy Methods](#end-to-end-evaluation-of-copy-methods)
- [Evaluation Setup and Benchmark Code](#evaluation-setup-and-benchmark-code)
...
where num_cpu_blocks is the number of CPU blocks to allocate for the CPU KV cache.
...
![](/blog-assets/figures/2026-01-08-kv-offloading-connector/figure1.png)
...
![](/blog-assets/figures/2026-01-08-kv-offloading-connector/figure2.png)
...
To answer these questions we created the micro-benchmark [gpu_cpu_benchmark](https://github.com/orozery/playground/tree/kv-offloading-blog-dec-2025/kvcache/gpu_cpu_benchmark).  
...
![](/blog-assets/figures/2026-01-08-kv-offloading-connector/figure3.png)

  
**Figure 3**: Single GPU -\> CPU transfer throughput (NVIDIA H100, Single transfer of 1000 blocks).

![](/blog-assets/figures/2026-01-08-kv-offloading-connector/figure4.png)
...
This fragmentation is meaningless for model computation performance, but is devastating for KV offloading as it creates an unnecessary fragmentation in the KV cache layout, yielding a smaller effective block size. To overcome this, we recently [upstreamed](https://github.com/vllm-project/vllm/pull/27743) a change in vLLM’s KV cache layout which creates one contiguous physical block including the KV data of all layers. This change effectively increased the physical block size by a factor of 2\*num_layers, and this in turn **increased the throughput of the offloading connector by an order of magnitude**.
...
![](/blog-assets/figures/2026-01-08-kv-offloading-connector/figure5.png)
...
![](/blog-assets/figures/2026-01-08-kv-offloading-connector/figure6.png)
