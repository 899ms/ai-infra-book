<!-- 从 sglang-hisparse.html 迁移的资料快照；原始 HTML SHA-256: e63877bf1cdf6c4aac85f81aba9adbe899b1c8348c0e7451bc7de148745dcaaa。 -->
...
- [Why sparse attention leaves performance on the table](#why-sparse-attention-leaves-performance-on-the-table)
- [Design of HiSparse](#design-of-hisparse)
- [Efficient Swap-in Kernel](#efficient-swap-in-kernel)
- [Benchmark](#benchmark)
...
Zhiqiang Xie, Zhangheng Huang, Tingwei HuangApril 10, 2026
...
![](/images/blog/hisparse/throughput_concurrency.png)
...
![](/images/blog/hisparse/miss_count_trend.png)
...
![](/images/blog/hisparse/hisparse_sweep.png)
