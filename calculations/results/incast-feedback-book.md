...
输入：`{"declared_end_to_end_rtt_ns": 20000, "declared_one_hop_cable_m": 30, "declared_propagation_ns_per_m": 5, "egress_bytes_per_second": 50000000000, "free_buffer_bytes": 1048576, "mtu_bytes": 1500, "sender_bytes_per_second": 50000000000, "senders": [8, 16, 64]}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| free_buffer_bytes | 1,048,576 |
| one_hop_feedback_ns | 330.0 |
| end_to_end_feedback_ns | 20,000 |
| allowed_feedback_ns | `{"8": 3495.2533333333336, "16": 1497.9657142857143, "64": 338.25032258064516}` |
