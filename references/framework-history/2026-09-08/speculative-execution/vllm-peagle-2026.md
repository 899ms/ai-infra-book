<!-- 从 vllm-peagle-2026.html 迁移的资料快照；原始 HTML SHA-256: 8c9b3915c2be7a12c0c4b04e57521b329cb4598ec1e92b6705964029a53175db。 -->
...
[\#performance](/blog/tags/performance)[\#speculative-decoding](/blog/tags/speculative-decoding)

- [EAGLE's Drafting Bottleneck](#eagles-drafting-bottleneck)
- [Our Approach: Parallel-EAGLE (P-EAGLE)](#our-approach-parallel-eagle-p-eagle)
- [Training P-EAGLE on Long Sequences](#training-p-eagle-on-long-sequences)
- [Implementation in vLLM](#implementation-in-vllm)
- [Parallel drafting challenges](#parallel-drafting-challenges)
- [The Triton Kernel](#the-triton-kernel)
- [Hidden State Management](#hidden-state-management)
- [vLLM Benchmarking on P-EAGLE](#vllm-benchmarking-on-p-eagle)
...
![Figure 1: P-EAGLE over other methods on SPEED-BENCH with Concurrency of 1 on one NVIDIA B200 card.](/blog-assets/figures/2026-03-13-p-eagle/fig1_speedbench_overview.png)
...
![Figure 2: P-EAGLE architecture overview.](/blog-assets/figures/2026-03-13-p-eagle/fig2_architecture.png)
...
![Figure 3: Sequence length (prompt + generation) distribution on UltraChat dataset with GPT-OSS 120B. Reasoning level: Medium.](/blog-assets/figures/2026-03-13-p-eagle/fig3_sequence_length.png)
...
![Figure 4: MT-Bench throughput (TPS) for P-EAGLE vs EAGLE-3 on GPT-OSS-20B across concurrency levels. The P/E speedup ratios are: 1.55x (c=1), 1.29x (c=2), 1.35x (c=4), 1.28x (c=8), 1.27x (c=16), 1.09x (c=32), and 1.05x (c=64).](/blog-assets/figures/2026-03-13-p-eagle/fig4_mtbench.png)
...
![Figure 5: HumanEval throughput (TPS) for P-EAGLE vs EAGLE-3 on GPT-OSS-20B across concurrency levels. The P/E speedup ratios are: 1.55x (c=1), 1.53x (c=2), 1.45x (c=4), 1.35x (c=8), 1.31x (c=16), 1.37x (c=32), and 1.23x (c=64).](/blog-assets/figures/2026-03-13-p-eagle/fig5_humaneval.png)
...
![Figure 6: Speed-bench throughput (TPS) for P-EAGLE vs EAGLE-3 on GPT-OSS-20B across concurrency levels. The P/E speedup ratios are: 1.69x (c=1), 1.61x (c=2), 1.54x (c=4), 1.45x (c=8), 1.40x (c=16), 1.22x (c=32), and 1.25x (c=64).](/blog-assets/figures/2026-03-13-p-eagle/fig6_speedbench.png)
