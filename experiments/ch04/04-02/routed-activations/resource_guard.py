...
(a.out/'launch.json').write_text(json.dumps(dict(command=a.command,pid=proc.pid,token=token,start_s=start,
    timeout_s=3600,own_rss_limit_bytes=96*1024**3,own_gpu_limit_mib=34*1024,global_available_min_bytes=24*1024**3),indent=2)+'\n')
try:
    while proc.poll() is None:
        ...
        elif rss>96*1024**3:reason='own_rss_limit'
        elif own_gpu>34*1024:reason='own_gpu_limit'
