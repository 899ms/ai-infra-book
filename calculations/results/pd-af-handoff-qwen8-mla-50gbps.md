...
输入：`{"batch": 1, "decode_steps": 1, "element_bytes": 2, "kv_layout": "mla", "kv_model": "deepseek-v3", "length": 8192, "model": "qwen3-8b", "network_bandwidth": 50000000000, "path": "direct", "staging_bandwidth": 25000000000, "startup_ns": 5000}`
...
| hops_per_message | 1 |
| pd_serialized_ns_exact | `"287959112/25"` |
| af_serialized_ns_exact | `"9294912/25"` |
| byte_matched_extra_ns_exact | `"355000"` |
| equal_time_startup_ns_exact | `"11501568/71"` |
| af_faster_at_selected_startup | `true` |

| 交接 | payload bytes | 消息数 | 接口 | 接口bytes | 启动次数 | 载荷ns | 启动ns |
| --- | ---: | ---: | --- | ---: | ---: | --- | ---: |
| PD snapshot | 575668224 | 1 | network | 575668224 | 1 | 287834112/25 | 5000 |
| AF decode activations | 589824 | 72 | network | 589824 | 72 | 294912/25 | 360000 |
| byte-matched repeated handoffs | 575668224 | 72 | network | 575668224 | 72 | 287834112/25 | 360000 |
