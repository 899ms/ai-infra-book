<!-- 从 vllm-sleep-2025.html 迁移的资料快照；原始 HTML SHA-256: af20a7d7cc29bd0ba0587397284a52431cfc7d10a45ed9b09ae1d3baa99fe99d。 -->
...
- [Two Sleep Levels for Different Needs](#two-sleep-levels-for-different-needs)
- [Why Sleep Mode Beats Fast Weight Loaders](#why-sleep-mode-beats-fast-weight-loaders)
- [Quick Start: Using Sleep Mode](#quick-start-using-sleep-mode)
- [Online Serving API](#online-serving-api)
- [Sleep and Wake Models](#sleep-and-wake-models)
- [Performance Overview](#performance-overview)
- [Sleep Mode L1 vs No Sleep Mode Performance](#sleep-mode-l1-vs-no-sleep-mode-performance)
- [Inference Performance Boost](#inference-performance-boost)
- [Why Sleep Mode Improves Inference Speed](#why-sleep-mode-improves-inference-speed)
- [Model Switching Performance](#model-switching-performance)
- [Hardware Scalability: A4000 GPU Results](#hardware-scalability-a4000-gpu-results)
- [A4000: Inference Performance](#a4000-inference-performance)
- [A4000: Model Switching Performance](#a4000-model-switching-performance)
- [Sleep Levels: Choosing the Right Mode](#sleep-levels-choosing-the-right-mode)
- [Performance Comparison: Level 1 vs Level 2 vs No Sleep](#performance-comparison-level-1-vs-level-2-vs-no-sleep)
- [Why Level 2 is Still Faster Than No Sleep Mode](#why-level-2-is-still-faster-than-no-sleep-mode)
- [Level 2: Inference Performance](#level-2-inference-performance)
- [Level 2: Model Switching Performance](#level-2-model-switching-performance)
- [Ablation Studies](#ablation-studies)
- [Impact of Warm-Up on Sleep Mode](#impact-of-warm-up-on-sleep-mode)
- [Impact of Quantization on Sleep Mode](#impact-of-quantization-on-sleep-mode)
- [Ablation: Inference Performance (BF16 vs FP8)](#ablation-inference-performance-bf16-vs-fp8)
- [Ablation: Model Switching (BF16 vs FP8)](#ablation-model-switching-bf16-vs-fp8)
- [Decision Guide: Which Sleep Level to Use?](#decision-guide-which-sleep-level-to-use)
- [Use Sleep Level 1 When:](#use-sleep-level-1-when)
- [Use Sleep Level 2 When:](#use-sleep-level-2-when)
- [Skip Sleep Mode When:](#skip-sleep-mode-when)
...
![vLLM Sleep Mode](/blog-assets/figures/2025-vllm-sleep-mode/sleepmode.png)
