<!-- 从 sglang-unified-cache.html 迁移的资料快照；原始 HTML SHA-256: 1c9858a3731f6c746d000700900576fe29d097c164415dcc17e78c214d5d5673。 -->
...
- [One Tree, Composable Components](#one-tree-composable-components)
- [Finding a Safe Reuse Boundary](#finding-a-safe-reuse-boundary)
- [Component Hooks Across the Tree Lifecycle](#component-hooks-across-the-tree-lifecycle)
- [Native HiCache Across Memory Tiers](#native-hicache-across-memory-tiers)
- [Components, Anchors, and Sidecars](#components-anchors-and-sidecars)
- [HiCache Multi-Turn Benchmark Results](#hicache-multi-turn-benchmark-results)
- [DeepSeek-V4](#deepseek-v4)
- [Inkling](#inkling)
- [Session-Aware Eviction on the Shared Tree](#session-aware-eviction-on-the-shared-tree)
- [Session-Aware HiCache on SWE-bench Workloads](#session-aware-hicache-on-swe-bench-workloads)
- [Toward a Rust Tree Core](#toward-a-rust-tree-core)
...
Zhangheng Huang, Ke Bao, Yi Zhang, Jialin Ouyang, Sicheng PanAugust 11, 2026
...
![Unified Radix Cache shared token topology, component reuse semantics, HiCache tiers, and sidecars](/images/blog/unified-radix-cache/image1.svg)
...
![How match_prefix chooses a boundary accepted by every component](/images/blog/unified-radix-cache/image2.svg)
...
![DeepSeek-V4 components and their derived HiCache sidecars](/images/blog/unified-radix-cache/image3.svg)
...
![HiCache multi-turn benchmarks for DeepSeek-V4 and Inkling](/images/blog/unified-radix-cache/image4.png)
...
![Session-aware eviction across FULL, SWA, and MAMBA components](/images/blog/unified-radix-cache/image6.svg)
...
![SWE-bench cache hit ratios and TTFT for DeepSeek-V4-Pro and Qwen3.5-397B-A17B](/images/blog/unified-radix-cache/image7.png)
...
![Experimental Rust and Python tree-core TTFT across FULL, SWA, and hybrid SSM models](/images/blog/unified-radix-cache/image5.png)
