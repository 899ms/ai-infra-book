...
def render():
    ...
    ax.set_yticks(range(5), labels); ax.invert_yaxis(); ax.set_xlim(0, 18)
    ax.set_xlabel("Full image delivered (s)"); ax.legend(fontsize=8, loc="lower left")
