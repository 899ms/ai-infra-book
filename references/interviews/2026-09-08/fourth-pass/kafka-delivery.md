<!-- 从 kafka-delivery.html 迁移的资料快照；原始 HTML SHA-256: 5774db0d497eea09385589e68a50706f515108b06774d8030bc242f23412adf5。 -->

You are viewing documentation for an older version (4.2) of Kafka. For up-to-date documentation, see the [latest version](/43/).
...
- [Kafka](https://kafka.apache.org/tags/kafka/)
- [Docs](https://kafka.apache.org/tags/docs/)
...
Last modified June 2, 2026: [MINOR: Add 4.2.1 (#874) (3ecd6fe6ec)](https://github.com/apache/kafka-site//commit/3ecd6fe6ec1ee787fdfcd05c2fcec2ff21a90745)

[Next: Protocol ›](/42/design/protocol/)
