% English cover: the same processor / fabric / rack drawing as ../book/cover.tex,
% with the title, author line and edition stamp in English.
\begin{titlepage}
\thispagestyle{empty}
\null
\begin{tikzpicture}[remember picture,overlay,line join=round,line cap=round,
  ...
  \node[anchor=center] at ([yshift=-5.2cm]current page.north)
    {{\fontsize{34}{42}\selectfont\rmfamily\bfseries Understanding AI Infra}};
  \node[anchor=center,text=structurecolor] at ([yshift=-7.05cm]current page.north)
    {{\Large\sffamily Quantitative Analysis and System Design}};
