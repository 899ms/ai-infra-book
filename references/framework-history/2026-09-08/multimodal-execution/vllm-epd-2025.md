<!-- 从 vllm-epd-2025.html 迁移的资料快照；原始 HTML SHA-256: 857b3a03c01f509b6f7748763e3e8b1883319aab2dd6a67999a57d8973c910b1。 -->
...
[\#multimodal](/blog/tags/multimodal)[\#large-scale-serving](/blog/tags/large-scale-serving)

- [Motivation: Why Disaggregate the Encoder in LMM Serving?](#motivation-why-disaggregate-the-encoder-in-lmm-serving)
- [Problems With Colocating Encoder and Text Generation](#problems-with-colocating-encoder-and-text-generation)
- [Solutions: Encoder Disaggregation](#solutions-encoder-disaggregation)
- [1. Pipelined Execution and Elimination of Interference](#1-pipelined-execution-and-elimination-of-interference)
- [2. Independent, Fine-Grained Scaling](#2-independent-fine-grained-scaling)
- [3. Encoder Output Caching and Reuse](#3-encoder-output-caching-and-reuse)
- [Design](#design)
...
- [1. ECConnectorRole](#1-ecconnectorrole)
- [2. ECConnectorMetadata](#2-ecconnectormetadata)
- [3. ECConnectorBase](#3-ecconnectorbase)
- [Scheduler-Side Behavior](#scheduler-side-behavior)
- [1. Connector Initialization](#1-connector-initialization)
- [2. Remote Cache Check](#2-remote-cache-check)
- [3. Cache State Updates](#3-cache-state-updates)
- [4. Metadata Construction](#4-metadata-construction)
- [Worker-Side Behavior](#worker-side-behavior)
- [Execution Integration](#execution-integration)
- [Encoder Side (Saving to Remote Storage)](#encoder-side-saving-to-remote-storage)
- [Prefill/Decode Side (Loading Remote Embeddings)](#prefilldecode-side-loading-remote-embeddings)
- [Performance Results](#performance-results)
- [Short‑Text Workloads (~400 tokens)](#shorttext-workloads-400-tokens)
- [Long‑Text Workloads (~2000 tokens)](#longtext-workloads-2000-tokens)
- [Hardware Portability: Ascend NPU](#hardware-portability-ascend-npu)
- [Conclusion](#conclusion)
- [Related Work](#related-work)
- [ViT DP + LM TP](#vit-dp--lm-tp)
- [Prior Art and Industry Adoption](#prior-art-and-industry-adoption)
- [Reference](#reference)
...
![](/blog-assets/figures/2025-12-15-epd/image.png)
...
![](/blog-assets/figures/2025-12-15-epd/workflow.png)
...
![](/blog-assets/figures/2025-12-15-epd/plot_len400_epd_vs_non_epd.png)
...
![](/blog-assets/figures/2025-12-15-epd/plot_len2000_epd_vs_non_epd.png)
...
![](/blog-assets/figures/2025-12-15-epd/npu_plot_len400_epd_vs_non_epd.png)

![](/blog-assets/figures/2025-12-15-epd/npu_plot_len2000_epd_vs_non_epd.png)
