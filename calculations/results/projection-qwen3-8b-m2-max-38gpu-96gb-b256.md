...
输入：`{"accumulator_precision": "FP32", "batch": 256, "beta": 0, "device": "m2-max-38gpu-96gb", "execution_unit": "tensor", "input_precision": "BF16", "output_precision": "BF16", "sparsity": "dense", "tokens": 1}`
...
| memory_service_seconds | 9.437184e-05 |
...
- 官方本来源未披露带精度／累加格式的 GPU FLOPS；不以 Neural Engine TOPS 或相对性能倍数补造。按带宽作资源服务下界仍需扣 CPU/OS 争用与可用内存。
...
- [../references/files/specs/apple-m2-pro-max.md](https://www.apple.com/newsroom/2023/01/apple-unveils-m2-pro-and-m2-max-next-generation-chips-for-next-level-workflows/)，SHA256 `22c21a5e875155c9975c3c10031aac7f1e826ae5a90435bb4feabae6b0a4dfa5`。
