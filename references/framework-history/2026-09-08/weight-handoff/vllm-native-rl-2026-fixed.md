<!-- 从 vllm-native-rl-2026-fixed.html 迁移的资料快照；原始 HTML SHA-256: 0ac305f10930cca6984008cecaf1be4294ae69ae746bc494cf156ffde314a9ee。 -->
...
[\#reinforcement-learning](/blog/tags/reinforcement-learning)[\#async-rl](/blog/tags/async-rl)

- [Native Weight Syncing APIs in vLLM](#native-weight-syncing-apis-in-vllm)
- [Background](#background)
- [New APIs in vLLM](#new-apis-in-vllm)
- [Example](#example)
- [Customizing Weight Transfer](#customizing-weight-transfer)
- [Improved Pause/Resume Support for Asynchronous RL](#improved-pauseresume-support-for-asynchronous-rl)
- [Keep Mode for Pause/Resume](#keep-mode-for-pauseresume)
- [Fixing Deadlocks in DPEP Setups](#fixing-deadlocks-in-dpep-setups)
- [Validation](#validation)
- [Demonstrating the New RL APIs](#demonstrating-the-new-rl-apis)
- [Validation at Scale: Fully Async RL in a Wide-EP Setup](#validation-at-scale-fully-async-rl-in-a-wide-ep-setup)
...
![Figure 1: RL system overview.](/blog-assets/figures/2026-05-28-native-rl-apis/rl_system_overview.png)
...
![Figure 2: Weight transfer via NCCL with FP8 quantization on vLLM.](/blog-assets/figures/2026-05-28-native-rl-apis/weight_transfer_nccl.svg)
...
![Figure 4: DP-coordinated generation across vLLM ranks.](/blog-assets/figures/2026-05-28-native-rl-apis/dp_generate.svg)
...
![Figure 5: A deadlock scenario possible in DPEP deployments in vLLM.](/blog-assets/figures/2026-05-28-native-rl-apis/vllm_deadlock.svg)
...
![Figure 6: Deadlock-free pause/resume in DPEP deployments with the two-phase protocol.](/blog-assets/figures/2026-05-28-native-rl-apis/vllm_no_deadlock.svg)
...
![Figure 7: Asynchronous training of Qwen3-1.7B on the DAPO recipe in SkyRL using the native RL APIs.](/blog-assets/figures/2026-05-28-native-rl-apis/skyrl_validation.svg)
...
![Figure 8: Prime-RL validation of fully async RL with zai-org/GLM-5.1-FP8 across 16 8xH200 nodes.](/blog-assets/figures/2026-05-28-native-rl-apis/prime_rl.svg)
