...
输入：`{"accumulator": "FP32", "bandwidth_multiplier": 1.0, "batch": 64, "compute_input": "BF16", "compute_multiplier": 1.0, "device": "h100-sxm", "kv_append_bytes_per_request": 0, "kv_history_bytes_per_request": 1073741824, "metadata_bytes": 0, "parameters": 70000000000, "sparsity": "dense", "weight_bits": 8, "workspace_bytes": 2147483648}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| matrix_flops | 8,960,000,000,000 |
| weight_payload_bytes | 70,000,000,000 |
| declared_read_write_bytes | 138,719,476,736 |
| declared_resident_bytes | 140,866,960,384 |
| nominal_capacity_bytes | 80,000,000,000 |
| fits_declared_budget | `false` |
| arithmetic_intensity_flops_per_byte | 64.59078574129838 |
| compute_service_seconds | 0.009055993531433193 |
| memory_service_seconds | 0.04140879902567164 |
| resource_lower_bound_seconds | `null` |
| capacity_feasible_throughput_upper_tokens_per_second | `null` |
| compute_memory_crossover_batch | `null` |
| crossover_fits_declared_capacity | `false` |
