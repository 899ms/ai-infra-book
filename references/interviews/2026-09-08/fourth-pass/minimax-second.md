<!-- 从 minimax-second.html 迁移的资料快照；原始 HTML SHA-256: fd93f7d44c2ca71bd849b8cf3a4cde04d268643caa8843217a1591e879200ad2。 -->

[![头像](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKAQMAAAC3/F3+AAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAApJREFUCNdjwAsAAB4AAdpxxYoAAAAASUVORK5CYII=)](/users/867705977)

[爱写代码的菜coder](/users/867705977) [![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKAQMAAAC3/F3+AAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAApJREFUCNdjwAsAAB4AAdpxxYoAAAAASUVORK5CYII=)](/users/867705977)

08-25 18:49 南京大学 golang 发布于浙江
...
# 8.19 minimax 平台研发工程师秋招二面

很和蔼的面试官，有很多开放性的问题  
1. 自我介绍，介绍一下你最有收获的事情  
2. 蚂蚁这边实习的事情可以给我介绍一下吗？（提到了业务的视角）  
3. 怎么去观测agent infra周期的，为啥别的公司的ai产品没有透出过这种能力这个是为啥？  
4. 实习你觉得做的最好的最有设计的一个事情是什么？  
5. 能否考虑给agent协议提供更多的能力和事情？  
6. 平台侧你是要面向用用户的，那么这个平台的能力是如何进行建设的了？怎么做好产品化  
7. Agent 自进化你是怎么做的，可以给我介绍一下吗？  
8. 反问：minimax的关于我的agent infra做的是什么？ai时代如何去快速沉淀自己的经验了？  
  
感觉还是吃到对口的优势，基本上和蚂蚁实习做的一样，二面更加强调agent的设计应用，底层原理，产品话，minimax面试很舒服  
[\#秋招面试记录#](/creation/subject/14710425d5b74593b2ef7103d293606f)  [\#我的求职进度条#](/creation/subject/81e9423ee42941edb230faabe67267b2)  [\#minimax#](/creation/subject/192c9a2b58b64f9dbeaddf80e56170bc)

全部评论

推荐最新楼层

[![头像](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKAQMAAAC3/F3+AAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAApJREFUCNdjwAsAAB4AAdpxxYoAAAAASUVORK5CYII=)](/users/966974366)

[程序员拼好饭](/users/966974366) [![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKAQMAAAC3/F3+AAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAApJREFUCNdjwAsAAB4AAdpxxYoAAAAASUVORK5CYII=)](/users/966974366)

马鞍山实验小学 Java

佬面的Agent岗吗![](https://uploadfiles.nowcoder.com/images/20220815/318889480_1660553763718/D9FDAE9918A39C99254A9D8D179628E5)
...
[发布于 09-02 17:45](/discuss/comment/22875244) 安徽
...
[![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKAQMAAAC3/F3+AAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAApJREFUCNdjwAsAAB4AAdpxxYoAAAAASUVORK5CYII=)](/users/615623176)

08-17 19:42

[大专以上学历，真的“不值钱”了吗？揭开工资背后的3个真相](/discuss/918950818118631424?sourceSSR=dynamic)

[](/discuss/918950818118631424?sourceSSR=dynamic)

大专以上的学历，真的在这个社会上属于工资低吗？先给你一个不太痛快的真相：如果只看起薪，大专、甚至普通本科的毕业生，确实正在被一部分人“平均”下去。国家统计局的数据显示，2025年高校毕业生人数预计突破1200万，而与之对应的是，2024年全国城镇非私营单位就业人员年平均工资为12.1万元，但中位数远低于此。你会发现，一个刚毕业的大专生，在二线城市拿4000-6000元的月薪是常态，而一线城市的送餐员、装修工人月入过万已不新鲜。于是，一个扎心的论调出现了：“读书有什么用？大专毕业还不如我初中毕业打工赚得多。”但如果你因此得出结论——“大专以上学历=工资低”，那你就掉进了一个巨大的认知陷阱。因为“...
...
[互联网金融 agent开发 三面](/feed/main/detail/88c55ee65af04ac98c218b9d17c47a71?sourceSSR=dynamic)

[](/feed/main/detail/88c55ee65af04ac98c218b9d17c47a71?sourceSSR=dynamic)

打算看什么样的机会？通用能力怎么转成适用于垂类？要做哪些事？具体说说你之前在通用&nbsp;AI&nbsp;能力上做了哪些工作/架构设计/具体工作，才把它变成适用于某个领域的？响应/延时有要求吧？接入大模型后延时上去，模型不能太大，要靠工程策略兜。吞吐和低延时怎么保证/提上去？你需要去响应/处理线上问题吗（on-call、线上故障）？碰到什么样的场景，需要做哪些稳定性/容量动作（预案）？整个对外服务的&nbsp;SLA&nbsp;是怎么定的？在工程研发/代码优化层面，做过哪些稳定性或性能优化？用&nbsp;ReAct&nbsp;模式构建，对外服务基于大模型能力提供？最近&nbsp;Agent&nbsp;框架很多，那些代码你有去看过吗？Claude&nbsp;Code，包括&nbsp;DeepSeek&nbsp;Haress底层实现区别本地&nbsp;Agent&nbsp;移到云上怎么设计沙盒，一人一个沙盒？资源怎么隔离？WorkBuddy​了解吗？工作之外，会写一些别的、做相关的开发吗？古法记录面评，也聊了40min

![](https://static.nowcoder.com/fe/file/oss/1715049343797JOCFB.png)查看15道真题和解析
...
[![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKAQMAAAC3/F3+AAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAApJREFUCNdjwAsAAB4AAdpxxYoAAAAASUVORK5CYII=)](/users/183142040)

08-29 15:40

已编辑

[同济大学 嵌入式软件开发](/users/183142040)

[项目进阶13：数据粘包？](/discuss/923238419868700672?sourceSSR=dynamic)

[](/discuss/923238419868700672?sourceSSR=dynamic)

在做网络通信时，经常会遇到一种很奇怪的现象。发送端明明发送了两次数据：Hello、World接收端却可能一次收到：HelloWorld也可能第一次只收到：Hel，下一次才收到：loWorld实际上，TCP&nbsp;并没有出错。真正的问题是：把&nbsp;TCP&nbsp;当成了&nbsp;“一个数据包对应一次发送&nbsp;/&nbsp;接收”&nbsp;的协议。一、数据传输的不是&nbsp;“消息”，而是一串字节理解粘包和拆包，首先要改变一个认识：TCP&nbsp;≠&nbsp;消息协议TCP&nbsp;=&nbsp;字节流例如发送端执行：&nbsp;send(sock,&nbsp;&quot;Hello&quot;,&nbsp;5,&nbsp;0);&nbsp;send(sock,&nbsp;&quot;World&quot;,&nbsp;5,&nbsp;0);&nbsp;应用程序进行了两次&nbsp;...

[![](data:image/svg+xml;base64,PHN2ZyBmb2N1c2FibGU9ImZhbHNlIiB2aWV3Ym94PSIwIDAgMTAyNCAxMDI0IiBmaWxsPSJjdXJyZW50Q29sb3IiIHdpZHRoPSIxMiIgaGVpZ2h0PSIxMiIgYXJpYS1oaWRkZW49InRydWUiIGRhdGEtdi03OWJhNjllYT48L3N2Zz4=) 嵌入式大厂秋招面经/27...](/creation/manager/columnDetail/068266)
...
![头像](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKAQMAAAC3/F3+AAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAApJREFUCNdjwAsAAB4AAdpxxYoAAAAASUVORK5CYII=) [![会员标识](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKAQMAAAC3/F3+AAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAApJREFUCNdjwAsAAB4AAdpxxYoAAAAASUVORK5CYII=)](/users/vip/detail?pageSource_var=%E5%86%85%E5%AE%B9feed)

[![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKAQMAAAC3/F3+AAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAApJREFUCNdjwAsAAB4AAdpxxYoAAAAASUVORK5CYII=)](/users/406807487)

08-27 19:00

[门头沟学院 Java](/users/406807487)

[27二本鼠鼠 秋招小记录 面了个不错的公司 声网](/feed/main/detail/8716126d69254f70900aaed667860d84?sourceSSR=dynamic)

[](/feed/main/detail/8716126d69254f70900aaed667860d84?sourceSSR=dynamic)

目前没有大厂约面&nbsp;现在已经感觉大厂不是非进不可了&nbsp;我只想WLB北京初创小狸机器人&nbsp;具身智能&nbsp;agent研发&nbsp;挂上来面试官就问主要的业务场景&nbsp;怎么处理的CR&nbsp;Agent是否用到memory你说管控AI代码质量&nbsp;怎么管控&nbsp;怎么评估上海共比邻&nbsp;银发经济&nbsp;AI全栈开发&nbsp;过大概讲一讲有关的agent内容&nbsp;因为简历上没有太多全栈开发内容&nbsp;&nbsp;后面问了一嘴整体的框架&nbsp;架构&nbsp;以及agent是否是多租户声网&nbsp;开发者体验岗&nbsp;主要偏前端&nbsp;但后面还是全栈周二投当天约面&nbsp;推迟到了今天一面其实没有问太多问题&nbsp;因为前面推迟了一会&nbsp;用的声网自研的app&nbsp;然后一直听不到面试官声音&nbsp;就浪费了10min&nbsp;导致没有自我介绍&nbsp;最终面了50分钟左右&nbsp;体感良好面试官介绍岗位内容&nbsp;该岗位需要有比较好的产品sense&nbsp;开发都是次要&nbsp;说看我简历写了很多&nbsp;但大多也不会有很多都是你做的&nbsp;你大概讲一讲&nbsp;你做过的东西吧&nbsp;哈哈哈&nbsp;还是面试官懂1.讲了讲在理想做的知识图谱内容&nbsp;从0到1做的&nbsp;面试官直接惊呆2.面试官便开始问&nbsp;怎么做的&nbsp;你接到这个需求的时候怎么处理&nbsp;分析3.系统的架构&nbsp;其实我没答出来&nbsp;我一直在答有关的sop&nbsp;流程&nbsp;怎么做的&nbsp;没有答到点上4.知识图谱解析的优化&nbsp;那你在做的时候&nbsp;没有想到让agent去做有关的优化设计吗&nbsp;有的&nbsp;不过&nbsp;我那时候是只拿了简单的一笔commit去分析&nbsp;构建5.最后说用在CR&nbsp;Agent上&nbsp;问&nbsp;你是怎么评估你这个知识图谱&nbsp;对于agent是有用的&nbsp;数据是怎么样的&nbsp;怎么证明它能够work&nbsp;&nbsp;&nbsp;这个我也是巴拉巴拉说还是讲了一套流程反问没啥可说&nbsp;就是那几个问题ai时代&nbsp;技术深度还重要吗&nbsp;可以不用那么深&nbsp;但要知道&nbsp;产品sense比较重要面试建议&nbsp;你不能直接一股脑输入给面试官&nbsp;就像你在让ai写代码&nbsp;处理需求的时候&nbsp;应该是渐进式的&nbsp;不然会答偏确实&nbsp;我感觉有时候跟面试官存在gap总体感觉真的非常nice&nbsp;发现如果不考技术&nbsp;只考这样的内容&nbsp;爽啊&nbsp;不用那么焦虑希望面试官手下留情&nbsp;进下一面吧&nbsp;27届真的要鼠了哈哈哈哈

![](https://static.nowcoder.com/fe/file/oss/1715049343797JOCFB.png)查看10道真题和解析
...
[百度 广告投放 \| 27秋招 大模型研发工程师 二面问题](/discuss/920349833402011648?sourceSSR=dynamic)

[](/discuss/920349833402011648?sourceSSR=dynamic)
