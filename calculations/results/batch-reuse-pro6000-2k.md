...
输入：`{"batches": [1, 4, 16, 64], "device": "rtx-pro6000-blackwell-ws", "history": 2048, "model": "qwen3-8b", "workspace_bytes": 0}`
...
| per_request_history_read_bytes | 301,989,888 |
| nominal_device_capacity_bytes | 96,000,000,000 |
| declared_capacity_max_batch | 263 |
| kv_history_equals_weights_batch | 51 |
| compute_memory_crossover_batch | `null` |
| crossover_capacity_feasible | `false` |
| single_request_matrix_flops | 16,344,743,936 |
| hardware_ridge_flops_per_byte_exact | `"62975/224"` |

| batch | 矩阵FLOPs | 旧KV读bytes | 总声明流量bytes | 省权重读bytes | 声明驻留bytes | 容量可行 | 资源主导 |
| ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| 1 | 16344743936 | 301989888 | 15438956544 | 0 | 16683608064 | True | memory |
| 4 | 65378975744 | 1207959552 | 16345393152 | 45410433024 | 17590020096 | True | memory |
| 16 | 261515902976 | 4831838208 | 19971139584 | 227052165120 | 21215668224 | True | memory |
| 64 | 1046063611904 | 19327352832 | 34474125312 | 953619093504 | 35718260736 | True | memory |
