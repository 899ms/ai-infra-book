...
实际执行 `python3 calculations/research/shared-airtime-review/check-network-independent.py`，14 个小型输入、14 份已有完整结果各两种 disabled 入口，共 368 项检查通过。报告为 `network-review-result.json`。没有执行大例，没有修改作者引擎或公共代码。

被审候选 `calculate.py` SHA-256 为 `9c5fbd9deeaa22f030b34048402c9eda9afe4e540de0ae8412d90b82014bf6bd`；`airtime.py` 为 `131ce04a522e641ece9a851f9e6ab3b1771b7fc83a5417be3b2a52c53a717658`。报告锁定候选、输入、预写 oracle 和导入的公共 Python 文件，检查运行前后不变。
