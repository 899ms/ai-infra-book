...
核对日期：2026-09-08。以下落点已按[草案 22 的当前章节](../../archive/outlines/chapters.json)和小节内容重新核对：单实例／分布式推理为第 8／9 章，训练为第 10 章，运行环境为第 11 章，端边云为第 12 章。逐项时间、提交与读取范围保留在[框架对应记录](../../case-studies/framework-evolution.md)；这里检查主线是否连通，不将取样版本视为完整发布史，也不将计划中的实验记为已运行。
