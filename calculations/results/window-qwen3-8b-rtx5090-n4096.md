...
输入：`{"bandwidth_bytes_per_second": 1792000000000, "batch": 1, "latency_ns": 500, "length": 8192, "transaction_bytes": 128, "transactions": 4096}`
...
| throughput_bounds_exact_bytes_per_second | `{"interface": "1792000000000", "transaction_window": "1048576000000"}` |
| effective_bandwidth_upper_exact_bytes_per_second | `"1048576000000"` |
| serial_service_can_reach_interface | `true` |
| binding_limiters | `["transaction_window"]` |
| required_window_bytes | 896,000.0 |
| required_transactions | 7,000 |
| transaction_limited_bytes_per_second | 1,048,576,000,000.0 |
| effective_bandwidth_upper_bytes_per_second | 1,048,576,000,000.0 |
| bandwidth_utilization_upper | 0.5851428571428572 |
| ideal_interface_service_seconds | 0.0006740845714285714 |
| window_constrained_service_lower_seconds | 0.001152 |
| finite_transfer_lower_seconds | 0.001152 |
