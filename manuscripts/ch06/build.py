...
plt.rcParams.update({'font.family':family,'font.size':11,'axes.unicode_minus':False,'svg.fonttype':'none','svg.hashsalt':'ch06-supernodes-v1','axes.spines.top':False,'axes.spines.right':False,'figure.facecolor':'white','savefig.facecolor':'white','text.color':'#203c48','axes.labelcolor':'#203c48','pdf.fonttype':42})
...
for pos,(phase,title) in enumerate([('healthy','无故障条件'),('fault','20 ms 故障，60 ms 开始重做')]):
 ...
 ax.axvline(90,color=C['line'],ls='--');ax.set(xlim=(20,220),ylim=(0,1.2),xlabel='八步续写期限 / ms',ylabel='平均成本 / 费用单位')
