...
场景：B=1，N=8192。固定官方 revision；非完整前向或实测性能。
...
| 计算项 | 结果 |
| --- | ---: |
| 全局 KV（含 index） | 7,290,880 B |
| main / index 每条 entry | 288 / 68 B |
| SWA FP8 值载荷，未含 scales | 2,621,440 B |
| 参考 BF16 全局 KV 逻辑载荷 | 26,214,400 B |
| expert_matrix_flops_per_token_per_layer | 495,452,160 |
| decode_expert_matrix_flops | 19,818,086,400 |
| reference_full_prefill_expert_matrix_flops | 162,349,763,788,800 |
| ced_bounded_replay_prefill_expert_matrix_flops | 82,443,239,424,000 |
| ced_encoder_token_layers | 163,840 |
| ced_decoder_replay_token_layers | 2,560 |
| v4_decode_expert_matrix_flops | 15,149,826,048 |
| v4_prefill_expert_matrix_flops | 124,107,374,985,216 |
