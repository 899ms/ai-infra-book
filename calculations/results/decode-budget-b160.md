...
输入：`{"accumulator": "FP32", "bandwidth_multiplier": 1.0, "batch": 160, "compute_input": "BF16", "compute_multiplier": 1.0, "device": "h100-sxm", "kv_append_bytes_per_request": 0, "kv_history_bytes_per_request": 0, "metadata_bytes": 0, "parameters": 70000000000, "sparsity": "dense", "weight_bits": 8, "workspace_bytes": 0}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| matrix_flops | 22,400,000,000,000 |
...
| arithmetic_intensity_flops_per_byte | 320.0 |
| compute_service_seconds | 0.02263998382858298 |
| memory_service_seconds | 0.020895522388059702 |
| resource_lower_bound_seconds | 0.02263998382858298 |
| capacity_feasible_throughput_upper_tokens_per_second | 7,067.142857142858 |
| compute_memory_crossover_batch | 148 |
| crossover_fits_declared_capacity | `true` |
| dominant_resource | `"compute"` |
