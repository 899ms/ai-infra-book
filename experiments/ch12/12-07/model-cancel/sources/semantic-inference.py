    ...
    **sampling_kwargs,
    ...
    for i in tqdm(range(num_new_tokens)):
        ...
        with (
            ...
            # decode_one_token is captured as a CUDA graph, so its result lives
            # in a buffer the next call overwrites. cur_token is a view of this
            # token and is read by that next call, so it has to own its memory.
