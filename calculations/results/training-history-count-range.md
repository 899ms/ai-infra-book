...
输入：`{"comparisons": [], "duration_scenarios": [{"max_constant_gpu_count": 4096, "min_constant_gpu_count": 1024, "model": "llama2-70b"}, {"max_constant_gpu_count": 4096, "min_constant_gpu_count": 1024, "model": "qwen3-8b-proxy"}], "lifecycle": []}`
...
- `{"input": {"model": "llama2-70b", "min_constant_gpu_count": 1024, "max_constant_gpu_count": 4096}, "conditional_days_min_exact": "35/2", "conditional_days_max_exact": "70", "assumption": "Caller-supplied constant-count scenarios for the reported GPU-hour scope, not measured calendar dates."}`
- `{"input": {"model": "qwen3-8b-proxy", "min_constant_gpu_count": 1024, "max_constant_gpu_count": 4096}, "conditional_days_min_exact": null, "conditional_days_max_exact": null, "assumption": "Caller-supplied constant-count scenarios for the reported GPU-hour scope, not measured calendar dates."}`
