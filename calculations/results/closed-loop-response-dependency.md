...
|---|---:|---:|---:|---:|---:|---:|
| up | 9824 | 1 | 3 | 2464 | 84 | 2548 |
| down | 736 | 1 | 3 | 192 | 84 | 276 |

截至 horizon 实际串行线上字节：**2824 B**；已开始包的完整声明字节可能包含截止后尚未发完部分。接收唯一字节：**2368 B**。
...
| 方向 | 时刻 s | 事件 | 已知反馈 |
|---|---|---|---|
| up | 4 | ack | `{"ranges": [[0, 0]], "ack_delay": "0", "app_limited": true, "flow_limited": false}` |
...
{
  "wire_bytes": 2824,
  "serialized_wire_bytes_by_horizon": "2824",
