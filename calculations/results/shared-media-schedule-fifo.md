...
| 数量 | 值 |
| --- | --- |
| evaluated_business_count | `2` |
| all_businesses_usable | `true` |
| all_reliable_packets_delivered | `true` |
| data_wire_bytes | `5` |
| ack_wire_bytes | `5` |
| unique_received_payload_bytes | `5` |
| unique_delivered_payload_bytes | `5` |
...
```json
{
  ...
  "credit_events": [
    ...
    },
    {
      ...
      "direction": "c2s",
      "reserved_bytes": 1,
      "shared_outstanding": 3,
      "reliable_receive_outstanding": 3
    },
    {
      "at": "3",
      "event": "send",
      ...
      "direction": "c2s",
      "reserved_bytes": 1,
      "shared_outstanding": 4,
      "reliable_receive_outstanding": 4
    },
    {
      "at": "4",
      "event": "ack_received",
