<!-- 从 sglang-determinism-2025.html 迁移的资料快照；原始 HTML SHA-256: d78b812cc2966fa3b31987292898fc661abc71319bb1241a640c752464872662。 -->
...
- [Results](#results)
- [Verifying Deterministic Behavior](#verifying-deterministic-behavior)
- [CUDA Graph Acceleration](#cuda-graph-acceleration)
- [Measuring Offline Inference Performance](#measuring-offline-inference-performance)
- [Usage](#usage)
...
- [Reproducible Non-Greedy Sampling](#reproducible-non-greedy-sampling)
- [RL Framework Integration (slime)](#rl-framework-integration-slime)
- [Future Work](#future-work)
- [Acknowledgement](#acknowledgement)

# Towards Deterministic Inference in SGLang and Reproducible RL Training

The SGLang TeamSeptember 22, 2025 (Updated on September 24)
...
![slime](/images/blog/deterministic/slime.png)
...
![figure1](/images/blog/deterministic/deterministic_intro.png)
...
![](/images/blog/deterministic/chunked_prefill.png)
