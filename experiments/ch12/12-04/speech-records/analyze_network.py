...
assert env['fixture']==json.loads((R/'asr-fixture.json').read_text())
assert env['payload_sha256']==hashlib.sha256((R/'audio.wav').read_bytes()).hexdigest()
assert env['response_sha256']==hashlib.sha256((R/'transcript.txt').read_bytes()).hexdigest()
