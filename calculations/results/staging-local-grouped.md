...
输入：`{"dram_bytes_per_second": 40000000000, "intersocket_bytes_per_second": 8000000000, "order": "grouped", "pcie_bytes_per_second": 12000000000, "placement": "sender-local", "rank_to_gpu": [0, 1, 2, 3], "startup_ns": 0, "tokens": 1024}`
...
| aggregate_resource_lower_seconds | 0.001572864 |
| sum_round_resource_lower_seconds | 0.001572864 |
| barrier_lower_with_startup_seconds | 0.001572864 |
...
| 2 → 3 | B | gpu2_to_host → dram_B → dram_B → gpu3_from_host |
| 3 → 0 | B | gpu3_to_host → dram_B → dram_B → B_to_A → gpu0_from_host |

| 物理资源 | bytes | bytes/s | 服务 ms |
| --- | ---: | ---: | ---: |
| A_to_B | 12582912 | 8000000000 | 1.572864 |
| B_to_A | 12582912 | 8000000000 | 1.572864 |
| dram_A | 50331648 | 40000000000 | 1.258291 |
| dram_B | 50331648 | 40000000000 | 1.258291 |
