...
输入：`{"bandwidth_bytes_per_second": 450000000000, "batch": 1, "message_dtype": "BF16", "message_scope": "full activation per rank for all-reduce", "participants": 4, "startup_ns": 822, "tokens": 1}`
...
| chunk_bytes | 2,560 |
| all_reduce_rounds | 6 |
| all_reduce_send_bytes_per_rank | 15,360 |
| all_reduce_receive_bytes_per_rank | 15,360 |
| all_reduce_network_send_bytes | 61,440 |
| all_reduce_global_reduction_adds | 15,360 |
| all_reduce_startup_seconds | 4.932e-06 |
| all_reduce_bandwidth_seconds | 3.4133333333333335e-08 |
| all_reduce_modeled_seconds | 4.966133333333334e-06 |
| dense_tp_all_reduce_calls | 128 |
| dense_tp_serial_collective_seconds | 0.0006356650666666668 |
| measured_collective_seconds | `null` |

| 阶段 | 轮次 | sender → receiver : chunk (bytes) |
| --- | ---: | --- |
| reduce_scatter | 0 | 0 → 1 : 0 (2560); 1 → 2 : 1 (2560); 2 → 3 : 2 (2560); 3 → 0 : 3 (2560) |
| reduce_scatter | 1 | 0 → 1 : 3 (2560); 1 → 2 : 0 (2560); 2 → 3 : 1 (2560); 3 → 0 : 2 (2560) |
| reduce_scatter | 2 | 0 → 1 : 2 (2560); 1 → 2 : 3 (2560); 2 → 3 : 0 (2560); 3 → 0 : 1 (2560) |
| all_gather | 0 | 0 → 1 : 1 (2560); 1 → 2 : 2 (2560); 2 → 3 : 3 (2560); 3 → 0 : 0 (2560) |
| all_gather | 1 | 0 → 1 : 0 (2560); 1 → 2 : 1 (2560); 2 → 3 : 2 (2560); 3 → 0 : 3 (2560) |
| all_gather | 2 | 0 → 1 : 3 (2560); 1 → 2 : 0 (2560); 2 → 3 : 1 (2560); 3 → 0 : 2 (2560) |
