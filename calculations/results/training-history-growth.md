...
输入：`{"comparisons": [{"baseline": "llama1-7b", "target": "llama2-7b"}, {"baseline": "llama2-7b", "target": "qwen3-8b-proxy"}], "duration_scenarios": [], "lifecycle": []}`
...
- `{"input": {"baseline": "llama1-7b", "target": "llama2-7b"}, "parameter_proxy_growth_exact": "70/67", "training_tokens_growth_exact": "2", "proxy_flops_growth_exact": "140/67", "interpretation": "Descriptive proxy ratio; scope, architecture and quality are not controlled."}`
- `{"input": {"baseline": "llama2-7b", "target": "qwen3-8b-proxy"}, "parameter_proxy_growth_exact": "8/7", "training_tokens_growth_exact": "18", "proxy_flops_growth_exact": "144/7", "interpretation": "Descriptive proxy ratio; scope, architecture and quality are not controlled."}`
