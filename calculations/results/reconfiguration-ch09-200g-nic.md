...
```json
{
  ...
  "bandwidth": {
    "fabric_bytes_per_second": 25000000000,
    "sender_bytes_per_second": 25000000000,
    "receiver_bytes_per_second": 25000000000
  },
  ...
  "annotation": "Migration traffic shares one 200 Gb/s RDMA NIC (25 GB/s per direction), the chapter link between servers. Nine runtime terms of 1 s each are declared teaching inputs."
}
```
...
| 字段 | 值 |
| --- | --- |
| fabric_bytes_per_second | 6425643/9765625 |
| sender_bytes_per_second | 9178114/48828125 |
| receiver_bytes_per_second | 4590261/48828125 |
| network_bytes | 16449646080 |
| transfer_lower_bound_exact_seconds | 6425643/9765625 |
| partial_known_transfer_bound_exact_seconds | 6425643/9765625 |
| missing_runtime_terms | [] |
| known_serial_runtime_seconds_exact | 9 |
| conditional_serial_switch_lower_bound_exact_seconds | 94316268/9765625 |
