...
def sync_figure_index(directory):
    ...
    return [path,Path(__file__),directory.parent/'core_principles_figures.py',directory.parent/'teaching_reading.py',directory.parent/'v41_case_figures.py',directory.parents[1]/'calculations/results/v41-throughline.json']
