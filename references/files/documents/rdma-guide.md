<!-- 从 rdma-guide.html 迁移的资料快照；原始 HTML SHA-256: c5b8e5bd206c6d83c3918f6bba554668ba53743012e1fb1fc6cbe0cd9584a6ef。 -->

Breadcrumbs

1.  [Networking](/)
2.  [BlueField DPUs / SuperNICs & DOCA](/dpu-doca)
3.  [DOCA SDK Documentation](/doca/archive/3-5-0)
4.  [DOCA Documentation v3.5.0](/doca/archive/3-5-0)
5.  [DOCA Programming Guide](/doca/archive/3-5-0/doca-programming-guide)
6.  [DOCA Drivers](/doca/archive/3-5-0/doca-drivers)
7.  [MLX Drivers and Technologies](/doca/archive/3-5-0/mlx-drivers-and-technologies)
8.  [RDMA](/doca/archive/3-5-0/rdma)
9.  [RDMA-aware Networks Programming Guide](/doca/archive/3-5-0/rdma-aware-networks-programming-guide)

## On this Page

# RDMA-aware Networks Programming Guide

## 1. Introduction ![](data:image/svg+xml;base64,)
...
For further information, please refer to [RDMA Core GitHub](https://github.com/linux-rdma/rdma-core).
...
### 3.1. InfiniBand ![](data:image/svg+xml;base64,)
...
Similarly, a VPI switch can have InfiniBand-only ports, Ethernet-only ports, or a mix of both InfiniBand and Ethernet ports working at the same time. VPI adapters and switches support both the InfiniBand RDMA and the Ethernet RoCE solutions.

### 3.3. RDMA over Converged Ethernet (RoCE) ![](data:image/svg+xml;base64,)

RoCE is a standard for RDMA over Ethernet that is also defined and specified by the IBTA organization. RoCE provides true RDMA semantics for Ethernet as it does not require the complex and low performance TCP transport (needed for iWARP, for example).RoCE is the most efficient low latency Ethernet solution today. It requires a very low CPU overhead and takes advantage of Priority Flow Control in Data Center Bridging Ethernet for lossless connectivity. RoCE has been fully supported by the Open Fabrics Software since the release of OFED 1.5.1.

### 3.4. Comparison of RDMA Technologies ![](data:image/svg+xml;base64,)
...
RDMA technologies are based on networking concepts found in a traditional network but there are differences them and their counterparts in IP networks. The key difference is that RDMA provides a messaging service which applications can use to directly access the virtual memory on remote computers. The messaging service can be used for Inter Process Communication (IPC), communication with remote servers and to communicate with storage devices using Upper Layer Protocols (ULPs) such as iSCSI Extensions for RDMA (ISER) and SCSI RDMA Protocol (SRP), Storage Message Block (SMB), Samba, Lustre, ZFS and many more.
...
![Untitled.png](/doca/__attachments/a_7bd729f6ae705880646ac58ac1cf2ee93944ee2d07defd6bd49866cf6a483335/Untitled.png?cb=7f83a87f9e4d5f95e385959a34d322f3)
...
In InfiniBand, a complete message is delivered directly to an application. Once an application has requested transport of an RDMA Read or Write, the InfiniBand hardware segments the outbound message as needed into packets whose size is determined by the fabric path maximum transfer unit. These packets are transmitted through the InfiniBand network and delivered directly into the receiving application's virtual buffer where they are re-assembled into a complete message. The receiving application is notified once the entire message has been received. Thus neither the sending nor the receiving application is involved until the entire message is delivered into the receiving application's buffer.

### 3.5. Key Components ![](data:image/svg+xml;base64,)
...
#### 3.5.1. Host Channel Adapter ![](data:image/svg+xml;base64,)
...
#### 3.5.2. Range Extenders ![](data:image/svg+xml;base64,)
...
#### 3.5.3. Subnet Manager ![](data:image/svg+xml;base64,)
...
#### 3.5.4. Switches ![](data:image/svg+xml;base64,)
...
### 3.6. Support for Existing Applications and ULPs ![](data:image/svg+xml;base64,)
...
This section and its verbs are valid only for user space. See header files for the kernel space verbs.
...
### 4.1. Available Communication Operations ![](data:image/svg+xml;base64,)

#### 4.1.1. Send/Send With Immediate ![](data:image/svg+xml;base64,)
...
#### 4.1.2. Receive ![](data:image/svg+xml;base64,)
...
#### 4.1.3. RDMA Read ![](data:image/svg+xml;base64,)
...
#### 4.1.4. RDMA Write/RDMA Write With Immediate ![](data:image/svg+xml;base64,)
...
#### 4.1.5. Atomic Fetch and Add/Atomic Compare and Swap ![](data:image/svg+xml;base64,)
...
### 4.2. Transport Modes ![](data:image/svg+xml;base64,)

There are several different transport modes you may select from when establishing a QP. Operations available in each mode are shown in the following table.

[TABLE]

RD is not supported by this API.

#### 4.2.1. Reliable Connection (RC) ![](data:image/svg+xml;base64,)
...
#### 4.2.2. Unreliable Connection (UC) ![](data:image/svg+xml;base64,)
...
#### 4.2.3. Unreliable Datagram (UD) ![](data:image/svg+xml;base64,)
...
### 4.3. Key Concepts ![](data:image/svg+xml;base64,)

#### 4.3.1. Send Request (SR) ![](data:image/svg+xml;base64,)
...
#### 4.3.2. Receive Request (RR) ![](data:image/svg+xml;base64,)
...
#### 4.3.3. Completion Queue ![](data:image/svg+xml;base64,)

A Completion Queue is an object which contains the completed work requests which were posted to the Work Queues (WQ). Every completion says that a specific WR was completed (both successfully completed WRs and unsuccessfully completed WRs).A Completion Queue is a mechanism to notify the application about information of ended Work Requests (status, opcode, size, source). CQs have n Completion Queue Entries (CQE). The number of CQEs is specified when the CQ is created. When a CQE is polled it is removed from the CQ. CQ is a FIFO of CQEs. CQ can service send queues, receive queues, or both. Work queues from multiple QPs can be associated with a single CQ. struct `ibv_cq` is used to implement a CQ.

#### 4.3.4. Memory Registration ![](data:image/svg+xml;base64,)
...
#### 4.3.6. Address Vector ![](data:image/svg+xml;base64,)
...
#### 4.3.7. Global Routing Header (GRH) ![](data:image/svg+xml;base64,)
...
#### 4.3.8. Protection Domain ![](data:image/svg+xml;base64,)
...
#### 4.3.9. Asynchronous Events ![](data:image/svg+xml;base64,)
...
#### 4.3.10. Scatter Gather ![](data:image/svg+xml;base64,)
...
#### 4.3.11. Polling ![](data:image/svg+xml;base64,)
...
### 4.4. Typical Application ![](data:image/svg+xml;base64,)
...
1.  Get the device list (implemented in programming example by `resources_create`):  
...
2.  Open the requested device (implemented in programming example by `resources_create`):  
    Iterate over the device list, choose a device according to its GUID or name and open it.

3.  Query the device capabilities (implemented in programming example by `resources_create`):  
...
4.  Allocate a Protection Domain to contain your resources (implemented in programming example by `resources_create`):  
...
5.  Register a memory region (implemented in programming example by `resources_create`):  
...
6.  Create a Completion Queue (CQ) (implemented in programming example by `resources_create`):  
...
7.  Create a Queue Pair (QP) (implemented in programming example by `resources_create`):  
    Creating a QP will also create an associated send queue and receive queue.

8.  Bring up a QP (implemented in programming example by `connect_qp`, `modify_qp_to_init`, `post_receive`, `modify_qp_to_rtr`, and `modify_qp_to_rts`):  
...
9.  Post work requests and poll for completion (implemented in programming example by `post_send` and `poll_completion`):  
    Use the created QP for communication operations.

10. Cleanup (implemented in programming example by `resources_destroy`):  
...
## 5. VPI Verbs API ![](data:image/svg+xml;base64,)

This chapter describes the details of the VPI verbs API.

### 5.1. Initialization ![](data:image/svg+xml;base64,)
...
`ibv_fork_init` initializes libibverbs' data structures to handle the `fork()` function safely and avoid data corruption, whether `fork()` is called explicitly or implicitly such as in `system()` calls.
...
### 5.2. Verb Context Operations ![](data:image/svg+xml;base64,)
...
#### 5.2.1. ibv_query_device ![](data:image/svg+xml;base64,)
...
- **Output Parameters:** `struct ibv_device_attr` containing device attributes
...
![](data:image/svg+xml;base64,)

#### 5.2.2. ibv_query_port ![](data:image/svg+xml;base64,)

- **Template:** `int ibv_query_port(struct ibv_context *context, uint8_t port_num, struct ibv_port_attr *port_attr)`

- **Input** **Parameters: **

  - `context` struct `ibv_context` from `ibv_open_device`** **`port_num` physical port number (1 is first port).
...
#### 5.2.3. ibv_query_gid ![](data:image/svg+xml;base64,)
...
#### 5.2.4. ibv_query_pkey ![](data:image/svg+xml;base64,)
...
`ibv_query_pkey` retrieves an entry in the port's partition key (pkey) table. Each port is assigned at least one pkey by the subnet manager (SM). The pkey identifies a partition that the port belongs to. A pkey is roughly analogous to a VLAN ID in Ethernet networking.The user passes in a pointer to a uint16 that will be filled in with the requested pkey. The user is responsible to free this uint16.

#### 5.2.5. ibv_alloc_pd ![](data:image/svg+xml;base64,)
...
#### 5.2.8. ibv_resize_cq ![](data:image/svg+xml;base64,)

- **Template: **`int ibv_resize_cq(struct ibv_cq *cq, int cqe)`

- **Input** **Parameters:**

  - `cq` CQ to resize cqe Minimum number of entries CQ will support
...
`ibv_resize_cq` resizes a completion queue (CQ). The parameter cqe must be at least the number of outstanding entries on the queue. The actual size of the queue may be larger than the specified value. The CQ may (or may not) contain completions when it is being resized thus, it can be resized during work with the CQ.

#### 5.2.9. ibv_destroy_cq ![](data:image/svg+xml;base64,)
...
#### 5.2.10. ibv_create_comp_channel ![](data:image/svg+xml;base64,)
...
#### 5.2.11. ibv_destroy_comp_channel ![](data:image/svg+xml;base64,)
...
### 5.3. Protection Domain Operations ![](data:image/svg+xml;base64,)
...
#### 5.3.1. ibv_reg_mr ![](data:image/svg+xml;base64,)
...
#### 5.3.2. ibv_dereg_mr ![](data:image/svg+xml;base64,)
...
#### 5.3.3. ibv_create_qp ![](data:image/svg+xml;base64,)
...
struct qp_init_attr is defined as follows:
    ...
    qp_type must be one of the following:
        ...
        IBV_QPT_RAW_ETH = 8
    sq_sig_all  If this value is set to 1, all send requests (WR) will generate completion queue events (CQE). If this value is set to 0, only WRs that are flagged will generate CQE’s (see ibv_post_send). 
...
#### 5.3.4. ibv_destroy_qp ![](data:image/svg+xml;base64,)
...
- **Output** **Parameters: **
  ...
  - `ibv_srq_attr` Actual values of the struct are set

- **Return** **Value: **A pointer to the created SRQ or NULL on failure

**Description: **

`ibv_create_srq` creates a shared receive queue (SRQ). `srq_attr`-\>`max_wr` and `srq_attr`-\>`max_sge` are read to determine the requested size of the SRQ, and set to the actual values allocated on return. If `ibv_create_srq` succeeds, then max_wr and `max_sge` will be at least as large as the requested values.
...
#### 5.3.6. ibv_modify_srq ![](data:image/svg+xml;base64,)
...
#### 5.3.7. ibv_destroy_srq ![](data:image/svg+xml;base64,)
...
#### 5.3.9. ibv_create_xrc_srq ![](data:image/svg+xml;base64,)
...
- **Template:**
  ...
  ![](data:image/svg+xml;base64,)
...
`ibv_create_xrc_srq` creates an XRC shared receive queue (SRQ) associated with the protection domain pd, the XRC domain `domain_xrc` and the CQ which will hold the completion `xrc_cq`.
...
#### 5.3.10. ibv_close_xrc_domain ![](data:image/svg+xml;base64,)
...
#### 5.3.11. ibv_create_xrc_rcv_qp ![](data:image/svg+xml;base64,)
...
`ibv_modify_xrc_rcv_qp` modifies the attributes of an XRC receive QP with the number `xrc_qp_num` which is associated with the attributes in the struct attr according to the mask `attr_mask`. It then moves the QP through the following transitions: Reset→Init→RTR.
...
#### 5.3.15. ibv_create_ah ![](data:image/svg+xml;base64,)
...
#### 5.3.16. ibv_destroy_ah ![](data:image/svg+xml;base64,)
...
`ibv_destroy_ah` frees an address handle (AH). Once an AH is destroyed, it cannot be used anymore in UD QPs.

### 5.4. Queue Pair Bringup (ibv_modify_qp) ![](data:image/svg+xml;base64,)
...
#### 5.4.1. ibv_modify_qp ![](data:image/svg+xml;base64,)
...
#### 5.4.2. RESET to INIT ![](data:image/svg+xml;base64,)
...
#### 5.4.3. INIT to RTR ![](data:image/svg+xml;base64,)
...
#### 5.4.4. RTR to RTS ![](data:image/svg+xml;base64,)
...
### 5.5. Active Queue Pair Operations ![](data:image/svg+xml;base64,)
...
#### 5.5.1. ibv_query_qp ![](data:image/svg+xml;base64,)
...
- **Input** **Parameters:**
  ...
  - `xrc_domain` The XRC domain associated with this QP

  - `xrc_qp_num` The queue pair number to identify this QP

  - `attr` The `ibv_qp_attr` struct in which to return the attributes

  - `attr_mask` A mask specifying the minimum list of attributes to retrieve 

  - `init_attr` The `ibv_qp_init_attr` struct to return the initial attributes
...
The `attr_mask` specifies a minimal list to retrieve. Some RDMA devices may return extra attributes not requested. Attributes are valid if they have been set using the `ibv_modify_xrc_rcv_qp`.

The exact list of valid attributes depends on the QP state. Multiple `ibv_query_xrc_rcv_qp` calls may yield different returned values for these attributes: `qp_state`, `path_mig_state`, `sq_draining`, `ah_attr` if automatic path migration (APM) is enabled.

#### 5.5.4. ibv_post_recv ![](data:image/svg+xml;base64,)
...
#### 5.5.5. ibv_post_send ![](data:image/svg+xml;base64,)
...
`ibv_post_srq_recv` posts a list of work requests to the specified SRQ. It stops processing the WRs from this list at the first failure (which can be detected immediately while requests are being posted), and returns this failing WR through the `bad_recv_wr` parameter.
...
#### 5.5.8. ibv_get_cq_event ![](data:image/svg+xml;base64,)

- **Template: **`int ibv_get_cq_event(struct ibv_comp_channel *channel, struct ibv_cq **cq, void **cq_context)`
...
- **Output** **Parameters:**
  ...
  - `cq` pointer to completion queue (CQ) associated with event
...
#### 5.5.9. ibv_ack_cq_events ![](data:image/svg+xml;base64,)
...
`ibv_ack_cq_events` acknowledges events received from `ibv_get_cq_event`. Although each notification received from `ibv_get_cq_event` counts as only one event, the user may acknowledge multiple events through a single call to `ibv_ack_cq_events`. The number of events to acknowledge is passed in nevents and should be at least 1. Since this operation takes a mutex, it is somewhat expensive and acknowledging multiple events in one call may provide better performance. See `ibv_get_cq_event` for additional details.

#### 5.5.10. ibv_poll_cq ![](data:image/svg+xml;base64,)
...
#### 5.5.11. ibv_init_ah_from_wc ![](data:image/svg+xml;base64,)
...
#### 5.5.12. ibv_create_ah_from_wc ![](data:image/svg+xml;base64,)
...
#### 5.5.13. ibv_attach_mcast ![](data:image/svg+xml;base64,)
...
`ibv_attach_mcast` attaches the specified QP, `qp`, to the multicast group whose multicast group GID is gid, and multicast LID is `lid`.

Only QPs of Transport Service Type `IBV_QPT_UD` may be attached to multicast groups.

To receive multicast messages, a join request for the multicast group must be sent to the subnet administrator (SA), so that the fabric's multicast routing is configured to deliver messages to the local port.
...
`ibv_detach_mcast` detaches the specified QP, `qp`, from the multicast group whose multicast group GID is `gid`, and multicast LID is `lid`.

### 5.6. Event Handling Operations ![](data:image/svg+xml;base64,)

#### 5.6.1. ibv_get_async_event ![](data:image/svg+xml;base64,)
...
#### 5.6.2. ib_ack_async_event ![](data:image/svg+xml;base64,)
...
#### 5.6.3. ibv_event_type_str ![](data:image/svg+xml;base64,)
...
### 5.7. Experimental APIs ![](data:image/svg+xml;base64,)

#### 5.7.1. ibv_exp_query_device ![](data:image/svg+xml;base64,)
...
`ibv_exp_query_device` returns the attributes of the device with context context. The argument attr is a pointer to an ibv_exp_device_attr struct, as defined in `<infiniband/verbs_exp.h>`.
...
#### 5.7.2. ibv_exp_create_qp ![](data:image/svg+xml;base64,)
...
`ibv_exp_create_qp` creates a queue pair (QP) associated with the protection domain `pd`. The argument `init_attr` is an `ibv_exp_qp_init_attr` struct, as defined in `<infiniband/verbs_exp.h>`.
...
`ibv_exp_post_send` posts the linked list of work requests (WRs) starting with wr to the send queue of the queue pair `qp`. It stops processing WRs from this list at the first failure (that can be detected immediately while requests are being posted), and returns this failing WR through `bad_wr`.
...
For atomic operations, to support atomic responses in big-endian format (the only way to use atomics on NVIDIA® Connect-IB® on little-endian machines) is:
...
## 6. RDMA_CM API ![](data:image/svg+xml;base64,)

This chapter describes the details of the RDMA_CM verbs API.

### 6.1. Event Channel Operations ![](data:image/svg+xml;base64,)

#### 6.1.1. rdma_create_event_channel ![](data:image/svg+xml;base64,)
...
Event channels are used to direct all events on an `rdma_cm_id`. For many clients, a single event channel may be sufficient, however, when managing a large number of connections or `cm_ids`, users may find it useful to direct events for different `cm_id`s to different channels for processing.
...
#### 6.1.2. rdma_destroy_event_channel ![](data:image/svg+xml;base64,)
...
### 6.2. Connection Manager (CM) ID Operations ![](data:image/svg+xml;base64,)

#### 6.2.1. rdma_create_id ![](data:image/svg+xml;base64,)

**Template:** `int rdma_create_id(struct rdma_event_channel *channel, struct rdma_cm_id **id, void *context, enum rdma_port_space ps)`
...
- `PORT_SPACES` Details of the services provided by the different port spaces are outlined below.
...
#### 6.2.2. rdma_destroy_id ![](data:image/svg+xml;base64,)
...
#### 6.2.3. rdma_migrate_id ![](data:image/svg+xml;base64,)
...
#### 6.2.4. rdma_set_option ![](data:image/svg+xml;base64,)
...
#### 6.2.5. rdma_create_ep ![](data:image/svg+xml;base64,)
...
**Input** **Parameters:**  
`id` A reference where the allocated communication identifier will be returned.  
`res` Address information associated with the `rdma_cm_id` (usually returned from a prior call to `rdma_getaddrinfo`).  
`pd` Optional protection domain if a Queue Pair (QP) is going to be associated with the `rdma_cm_id`.  
`qp_init_attr` Optional initial QP attributes

**Output** **Parameters:**  
`id` The communication identifier is returned to the user through this reference

**Return** **Value:**  
0 on success, -1 on error. If the call fails, errno will be set to indicate the reason for the failure

**Description:**  
`rdma_create_ep` creates an identifier and an optional Queue Pair (QP) used to track communication information.

If `qp_init_attr` is not `NULL`, then a QP will be automatically allocated and associated with the new `rdma_cm_id` (`id`).

- If a protection domain (`pd`) is provided, then the QP will be created securely on that specific PD.

- Otherwise, the QP will be allocated on a default PD.

By default, the newly created `rdma_cm_id` will be set to use synchronous operations (meaning functions like `connect`, `listen`, and `get_request` will block the program until they finish). To use asynchronous operations instead, the `rdma_cm_id` must be migrated to a user-allocated event channel using the `rdma_migrate_id` function.

The `rdma_cm_id` must be properly released after use by calling the `rdma_destroy_ep` function.

As part of the `res` input parameter, the function relies on the `rdma_addrinfo` structure, which is defined as follows: 
...
- `ai_flags` Hint flags which control the operation. Supported flags are `RAI_PASSIVE`, `RAI_NUMERICHOST`, and `RAI_NOROUTE`.

- `ai_family` Address family for the source and destination address (e.g., `AF_INET`, `AF_INET6`, `AF_IB`).

- `ai_qp_type` The type of RDMA Queue Pair used.

- `ai_port_space` RDMA port space used (e.g., `RDMA_PS_UDP` or `RDMA_PS_TCP`).

- `ai_src_len` Length of the source address referenced by `ai_src_addr`.

- `ai_dst_len` Length of the destination address referenced by `ai_dst_addr`.

- `ai_src_addr` Address of local RDMA device, if provided.

- `ai_dst_addr` Address of destination RDMA device, if provided.

- `ai_src_canonname` The canonical name for the source.

- `ai_dst_canonname` The canonical name for the destination.
...
#### 6.2.6. rdma_destroy_ep ![](data:image/svg+xml;base64,)
...
#### 6.2.7. rdma_resolve_addr ![](data:image/svg+xml;base64,)
...
InfiniBand-specific note: This call maps the destination and, if given, source IP addresses to GIDs. In order to perform the mapping, IPoIB must be running on both the local and remote nodes.
...
#### 6.2.8. rdma_bind_addr ![](data:image/svg+xml;base64,)
...
#### 6.2.9. rdma_resolve_route ![](data:image/svg+xml;base64,)
...
#### 6.2.10. rdma_listen ![](data:image/svg+xml;base64,)
...
#### 6.2.11. rdma_connect ![](data:image/svg+xml;base64,)
...
The following is a more detailed description of the `rdma_conn_param` structure members:
...
#### 6.2.12. rdma_get_request ![](data:image/svg+xml;base64,)
...
#### 6.2.13. rdma_accept ![](data:image/svg+xml;base64,)
...
**Input** **Parameters:**  
`id` RDMA communication identifier  
`conn_param` Optional connection parameters (these parameters are described in detail under the `rdma_connect` function documentation)
...
`rdma_accept` is called from the listening (server) side to accept an incoming connection or a datagram service lookup request.

Unlike the standard TCP/IP socket `accept()` routine, `rdma_accept` is not called directly on the listening `rdma_cm_id`.

Instead, the process works like this:

1.  The user starts listening by calling `rdma_listen`.

2.  The user then waits for an `RDMA_CM_EVENT_CONNECT_REQUEST` event to occur.

3.  When a connection request event arrives, it automatically hands the user a newly created `rdma_cm_id` (similar to how standard sockets give you a new socket file descriptor upon connection). This new `rdma_cm_id` is already securely bound to a specific RDMA device.

4.  Finally, `rdma_accept` is called on this new `rdma_cm_id` to fully establish the connection, rather than the original listening ID.

#### 6.2.14. rdma_reject ![](data:image/svg+xml;base64,)
...
`private_data_len` Size (in bytes) of the private data being sent
...
#### 6.2.15. rdma_notify ![](data:image/svg+xml;base64,)
...
#### 6.2.16. rdma_disconnect ![](data:image/svg+xml;base64,)
...
**Description:**  
`rdma_disconnect` disconnects a connection and transitions any associated QP to the error state. This action will result in any posted work requests being flushed to the completion queue. `rdma_disconnect` may be called by both the client and server side of the connection. After successfully disconnecting, an `RDMA_CM_EVENT_DISCONNECTED` event will be generated on both sides of the connection.

#### 6.2.17. rdma_get_src_port ![](data:image/svg+xml;base64,)
...
#### 6.2.19. rdma_get_local_addr ![](data:image/svg+xml;base64,)
...
#### 6.2.20. rdma_get_peer_addr ![](data:image/svg+xml;base64,)
...
#### 6.2.21. rdma_get_devices ![](data:image/svg+xml;base64,)
...
#### 6.2.22. rdma_free_devices ![](data:image/svg+xml;base64,)
...
`hints` Reference to an `rmda_addrinfo` structure containing hints about the type of service the caller supports   
`res` A pointer to a linked list of `rdma_addrinfo` structures containing response information

**Output** **Parameters:**  
`res` An `rdma_addrinfo` structure which returns information needed to establish communication
...
#### 6.2.24. rdma_freeaddrinfo ![](data:image/svg+xml;base64,)
...
#### 6.2.25. rdma_create_qp ![](data:image/svg+xml;base64,)
...
#### 6.2.26. rdma_destroy_qp ![](data:image/svg+xml;base64,)
...
#### 6.2.27. rdma_join_multicast ![](data:image/svg+xml;base64,)
...
#### 6.2.28. rdma_leave_multicast ![](data:image/svg+xml;base64,)
...
### 6.3. RDMA_CM Event Handling Operations ![](data:image/svg+xml;base64,)

#### 6.3.1. rdma_get_cm_event ![](data:image/svg+xml;base64,)
...
#### 6.3.2. Event Data ![](data:image/svg+xml;base64,)
...
- `id` The `rdma_cm` identifier associated with the event. If the event type is `RDMA_CM_EVENT_CONNECT_REQUEST`, then this references a new ID for that communication.
...
#### 6.3.3. UD Event Data ![](data:image/svg+xml;base64,)
...
#### 6.3.4. Conn Event Data ![](data:image/svg+xml;base64,)
...
#### 6.3.5. Event Types ![](data:image/svg+xml;base64,)
...
#### 6.3.6. rdma_ack_cm_event ![](data:image/svg+xml;base64,)
...
**Description: **  
`rdma_ack_cm_event` frees a communication event. All events which are allocated by `rdma_get_cm_event` must be released, there should be a one-to-one correspondence between successful gets and acks. This call frees the event structure and any memory that it references.

**See** **Also: **`rdma_get_cm_event`, `rdma_destroy_id`.

#### 6.3.7. rdma_event_str ![](data:image/svg+xml;base64,)
...
**Description: **  
`rdma_event_str` returns a string representation of an asynchronous event.
...
### 7.1. RDMA Protection Domain Operations ![](data:image/svg+xml;base64,)

#### [7.1.1. rdma_reg_msgs](https://docs.nvidia.com/networking/display/rdmaawareprogrammingv17/rdma+protection+domain+operations#src-34256579_RDMAProtectionDomainOperations-rdma_reg_msgs) ![](data:image/svg+xml;base64,)
...
#### 7.1.2. rdma_reg_read ![](data:image/svg+xml;base64,)
...
**See** **Also **`rdma_cm`, `rdma_create_id`, `rdma_create_ep`, `rdma_reg_msgs`, `rdma_reg_write`, `ibv_reg_mr`, `ibv_dereg_mr`, `rdma_post_read`.

#### 7.1.3. rdma_reg_write ![](data:image/svg+xml;base64,)
...
**See** **Also: **`rdma_cm`, `rdma_create_id`, `rdma_create_ep`, `rdma_reg_msgs`, `rdma_reg_read`, `ibv_reg_mr`, `ibv_dereg_mr`, `rdma_post_write`.

#### 7.1.4. rdma_dereg_mr ![](data:image/svg+xml;base64,)
...
#### 7.1.5. rdma_create_srq ![](data:image/svg+xml;base64,)
...
#### 7.1.6. rdma_destroy_srq ![](data:image/svg+xml;base64,)
...
### 7.2. RDMA Active Queue Pair Operations ![](data:image/svg+xml;base64,)

#### 7.2.1. rdma_post_recvv ![](data:image/svg+xml;base64,)
...
#### 7.2.2. rdma_post_sendv ![](data:image/svg+xml;base64,)
...
#### 7.2.3. rdma_post_readv ![](data:image/svg+xml;base64,)
...
#### 7.2.4. rdma_post_writev ![](data:image/svg+xml;base64,)
...
#### 7.2.5. rdma_post_recv ![](data:image/svg+xml;base64,)
...
#### 7.2.6. rdma_post_send ![](data:image/svg+xml;base64,)
...
**Description: **  
`rdma_post_send` posts a work request to the send queue of the queue pair associated with the `rdma_cm_id`, `id`. The contents of the posted buffer will be sent to the remote peer of the connection.  
...
#### 7.2.7. rdma_post_read ![](data:image/svg+xml;base64,)
...
**Description: **  
`rdma_post_read` posts a work request to the send queue of the queue pair associated with the `rdma_cm_id`. The contents of the remote memory region will be read into the local data buffer.  
...
**Description: **  
`rdma_post_write` posts a work request to the send queue of the queue pair associated with the `rdma_cm_id`, `id`. The contents of the local data buffer will be written into the remote memory region.  
...
**Description: **  
`rdma_post_ud_send` posts a work request to the send queue of the queue pair associated with the `rdma_cm_id`, ID. The contents of the posted buffer will be sent to the specified destination queue pair, `remote_qpn`.  
...
#### 7.2.10. rdma_get_send_comp ![](data:image/svg+xml;base64,)
...
**Description: **  
`rdma_get_send_comp` retrieves a completed work request for a send, RDMA read or RDMA write operation. Information about the completed request is returned through the `ibv_wc`, `wc` parameter, with the `wr_id` set to the context of the request. Please see `ibv_poll_cq` for details on the work completion structure, `ibv_wc`. Note that this call polls the send completion queue associated with the `rdma_cm_id`, `id`. If a completion is not found, the call blocks until a request completes. This means, therefore, that the call should only be used on `rdma_cm_ids` which do not share CQs with other `rdma_cm_ids`, and maintain separate CQs for sends and receive completions.

#### 7.2.11. rdma_get_recv_comp ![](data:image/svg+xml;base64,)
...
## 8. Events ![](data:image/svg+xml;base64,)

This chapter describes the details of the events that occur when using the VPI API

### 8.1. IBV Events ![](data:image/svg+xml;base64,)

#### 8.1.1. IBV_EVENT_CQ_ERR ![](data:image/svg+xml;base64,)
...
#### 8.1.4. IBV_EVENT_QP_ACCESS_ERR ![](data:image/svg+xml;base64,)
...
After this event, and after ensuring that the QP is in the `IBV_QPS_SQD` state, it is safe for the user to start modifying the Send Queue attributes since there aren't are no longer any send messages in progress. Thus it is now safe to modify the operational characteristics of the QP and transition it back to the fully operational RTS state.

#### 8.1.7. IBV_EVENT_PATH_MIG ![](data:image/svg+xml;base64,)

This event is generated when a connection successfully migrates to an alternate path. The event is relevant only for connection oriented QPs, that is, it is relevant only for RC and UC QPs.When this event is generated, it means that the alternate path attributes are now in use as the primary path attributes. If it is necessary to load attributes for another alternate path, the user may do that after this event is generated.

#### 8.1.8. IBV_EVENT_PATH_MIG_ERR ![](data:image/svg+xml;base64,)
...
#### 8.1.9. IBV_EVENT_DEVICE_FATAL ![](data:image/svg+xml;base64,)

This event is generated when a catastrophic error is encountered on the channel adapter. The port and possibly the channel adapter becomes unusable.When this event occurs, the behavior of the RDMA device is undetermined and it is highly recommended to close the process immediately. Trying to destroy the RDMA resources may fail and thus the device may be left in an unstable state.

#### 8.1.10. IBV_EVENT_PORT_ACTIVE ![](data:image/svg+xml;base64,)

This event is generated when the link on a given port transitions to the active state. The link is now available for send/receive packets. This event means that the `port_attr` state has moved from one of the following states:
...
This might happen for example when the SM configures the port. The event is generated by the device only if the `IBV_DEVICE_PORT_ACTIVE_EVENT` attribute is set in the `dev_cap.device_cap_flags`.

#### 8.1.11. IBV_EVENT_PORT_ERR ![](data:image/svg+xml;base64,)

This event is generated when the link on a given port becomes inactive and is thus unavailable to send/receive packets.The port_attr.state must have been in either in either `IBV_PORT_ACTIVE` or `IBV_PORT_ACTIVE_DEFER` state and transitions to one of the following states:
...
This can happen when there are connectivity problems within the IB fabric, for example when a cable is accidentally pulled. This will not affect the QPs associated with this port, although if this is a reliable connection, the retry count may be exceeded if the link takes a long time to come back up.

#### 8.1.12. IBV_EVENT_LID_CHANGE ![](data:image/svg+xml;base64,)
...
#### 8.1.13. IBV_EVENT_PKEY_CHANGE ![](data:image/svg+xml;base64,)
...
#### 8.1.14. IBV_EVENT_SM_CHANGE ![](data:image/svg+xml;base64,)
...
#### 8.1.16. IBV_EVENT_SRQ_LIMIT_REACHED ![](data:image/svg+xml;base64,)
...
#### 8.1.17. IBV_EVENT_QP_LAST_WQE_REACHED ![](data:image/svg+xml;base64,)
...
#### 8.1.18. IBV_EVENT_CLIENT_REREGISTER ![](data:image/svg+xml;base64,)

This event is generated when the SM sends a request to a given port for client re-registration for all subscriptions previously requested for the port. This could happen if the SM suffers a failure and as a result, loses its own records of the subscriptions. It may also happen if a new SM becomes operational on the subnet.The event will be generated by the device only if the bit that indicates a client reregister is supported is set in `port_attr.port_cap_flags`.

#### 8.1.19. IBV_EVENT_GID_CHANGE ![](data:image/svg+xml;base64,)
...
### 8.2. IBV WC Events ![](data:image/svg+xml;base64,)

#### 8.2.1. IBV_WC_SUCCESS ![](data:image/svg+xml;base64,)

The Work Request completed successfully.

#### 8.2.2. IBV_WC_LOC_LEN_ERR ![](data:image/svg+xml;base64,)
...
#### 8.2.3. IBV_WC_LOC_QP_OP_ERR ![](data:image/svg+xml;base64,)
...
#### 8.2.4. IBV_WC_LOC_EEC_OP_ERR ![](data:image/svg+xml;base64,)
...
#### 8.2.5. IBV_WC_LOC_PROT_ERR ![](data:image/svg+xml;base64,)
...
#### 8.2.6. IBV_WC_WR_FLUSH_ERR ![](data:image/svg+xml;base64,)
...
#### 8.2.7. IBV_WC_MW_BIND_ERR ![](data:image/svg+xml;base64,)
...
#### 8.2.10. IBV_WC_REM_INV_REQ_ERR ![](data:image/svg+xml;base64,)
...
#### 8.2.11. IBV_WC_REM_ACCESS_ERR ![](data:image/svg+xml;base64,)
...
#### 8.2.12. IBV_WC_REM_OP_ERR ![](data:image/svg+xml;base64,)
...
#### 8.2.13. IBV_WC_RETRY_EXC_ERR ![](data:image/svg+xml;base64,)
...
#### 8.2.14. IBV_WC_RNR_RETRY_EXC_ERR ![](data:image/svg+xml;base64,)
...
#### 8.2.15. IBV_WC_LOC_RDD_VIOL_ERR ![](data:image/svg+xml;base64,)

This event is generated when the RDD associated with the QP does not match the RDD associated with the EEC.

#### 8.2.16. IBV_WC_REM_INV_RD_REQ_ERR ![](data:image/svg+xml;base64,)
...
#### 8.2.21. IBV_WC_RESP_TIMEOUT_ERR ![](data:image/svg+xml;base64,)
...
#### 8.2.22. IBV_WC_GENERAL_ERR ![](data:image/svg+xml;base64,)
...
### 8.3. RDMA_CM Events ![](data:image/svg+xml;base64,)

#### 8.3.1. RDMA_CM_EVENT_ADDR_RESOLVED ![](data:image/svg+xml;base64,)
...
#### 8.3.2. RDMA_CM_EVENT_ADDR_ERROR ![](data:image/svg+xml;base64,)
...
#### 8.3.3. RDMA_CM_EVENT_ROUTE_RESOLVED ![](data:image/svg+xml;base64,)
...
#### 8.3.4. RDMA_CM_EVENT_ROUTE_ERROR ![](data:image/svg+xml;base64,)

This event is generated when `rdma_resolve_route()` fails.

#### 8.3.5. RDMA_CM_EVENT_CONNECT_REQUEST ![](data:image/svg+xml;base64,)
...
#### 8.3.6. RDMA_CM_EVENT_CONNECT_RESPONSE ![](data:image/svg+xml;base64,)

This event may be generated on the active side of the connection to notify the user that the connection request has been successful. The event is only generated on `rdma_cm_id`s which do not have a QP associated with them.

#### 8.3.7. RDMA_CM_EVENT_CONNECT_ERROR ![](data:image/svg+xml;base64,)
...
#### 8.3.8. RDMA_CM_EVENT_UNREACHABLE ![](data:image/svg+xml;base64,)
...
#### 8.3.10. RDMA_CM_EVENT_ESTABLISHED ![](data:image/svg+xml;base64,)
...
#### 8.3.11. RDMA_CM_EVENT_DISCONNECTED ![](data:image/svg+xml;base64,)
...
#### 8.3.12. RDMA_CM_EVENT_DEVICE_REMOVAL ![](data:image/svg+xml;base64,)
...
#### 8.3.13. RDMA_CM_EVENT_MULTICAST_JOIN ![](data:image/svg+xml;base64,)
...
#### 8.3.14. RDMA_CM_EVENT_MULTICAST_ERROR ![](data:image/svg+xml;base64,)
...
#### 8.3.15. RDMA_CM_EVENT_ADDR_CHANGE ![](data:image/svg+xml;base64,)
...
#### 8.3.16. RDMA_CM_EVENT_TIMEWAIT_EXIT ![](data:image/svg+xml;base64,)
...
## 9. Programming Examples Using IBV Verbs ![](data:image/svg+xml;base64,)

This chapter provides code examples using the IBV Verbs

### 9.1. Synopsis for RDMA_RC Example Using IBV Verbs ![](data:image/svg+xml;base64,)

The following is a synopsis of the functions in the programming example, in the order that they are called.

#### 9.1.1. Main ![](data:image/svg+xml;base64,)

1.  Parse the command line: The user may set the TCP port, device name, and device port for the test.

    - If set, these values will override the default values in the configuration.

    - The last parameter is the server name. If a server name is provided, the program connects to it and operates in client mode. Otherwise, the program defaults to server mode.

2.  Call `print_config`.

3.  Call `resources_init`.

4.  Call `resources_create`.

5.  Call `connect_qp`.

6.  If in server mode, call `post_send` with the `IBV_WR_SEND` operation.

7.  Call `poll_completion`. 

    The server side expects a completion from the SEND request, while the client side expects a RECEIVE completion.

8.  If in client mode, show the message received via the RECEIVE operation; if in server mode, load the buffer with a new message.

9.  Sync the client and server.

10. At this point, the server goes directly to the next sync. All RDMA operations are done strictly by the client.

##### 9.1.1.1. Client-Only Operations ![](data:image/svg+xml;base64,)

1.  Call `post_send` with `IBV_WR_RDMA_READ` to perform an RDMA read of the server's buffer. 

2.  Call `poll_completion`.

3.  Show the server's message.

4.  Set up the send buffer with a new message.

5.  Call `post_send` with `IBV_WR_RDMA_WRITE` to perform an RDMA write to the server's buffer.

6.  Call `poll_completion`.

##### 9.1.1.2. Post-Client Operations ![](data:image/svg+xml;base64,)

1.  Sync the client and server.

2.  If in server mode, show the buffer to prove the RDMA write was successful.

3.  Call `resources_destroy`. 

4.  Free the device name string. 

5.  Done.

#### `9.1.2. print_config` ![](data:image/svg+xml;base64,)

Prints out the configuration information.

#### `9.1.3. resources_init` ![](data:image/svg+xml;base64,)

Clears the resources struct.

#### `9.1.4. resources_create` ![](data:image/svg+xml;base64,)

1.  Call `sock_connect` to connect a TCP socket to the peer.

2.  Get the list of devices, locate the desired one, and open it.

3.  Free the device list.
...
7.  Allocate a memory buffer, initialize it, and register it.

8.  Create a Queue Pair (QP).

#### `9.1.5. sock_connect` ![](data:image/svg+xml;base64,)

- Client mode – Resolves the DNS address of the server and initiates a connection to it.

- Server mode – Listens for an incoming connection on the indicated port.

#### `9.1.6. connect_qp` ![](data:image/svg+xml;base64,)

1.  Call `modify_qp_to_init`.

2.  Call `post_receive`.

3.  Call `sock_sync_data` to exchange information between the server and the client.

4.  Call `modify_qp_to_rtr`.

5.  Call `modify_qp_to_rts`.

6.  Call `sock_sync_data` to synchronize the client and server.

#### `9.1.7. modify_qp_to_init` ![](data:image/svg+xml;base64,)

Transitions the QP to the INIT state.

#### `9.1.8. post_receive` ![](data:image/svg+xml;base64,)

1.  Prepare a scatter/gather entry for the receive buffer.

2.  Prepare a Receive Request (RR).

3.  Post the RR.

#### `9.1.9. sock_sync_data` ![](data:image/svg+xml;base64,)

Uses the TCP socket created with `sock_connect` to synchronize the given set of data between the client and the server. 

Because this function is blocking, it is also called with dummy data to synchronize the timing of the client and server.

#### `9.1.10. modify_qp_to_rtr` ![](data:image/svg+xml;base64,)

Transitions the QP to the RTR (Ready to Receive) state.

#### `9.1.11. modify_qp_to_rts` ![](data:image/svg+xml;base64,)

Transitions the QP to the RTS (Ready to Send) state.

#### `9.1.12. post_send` ![](data:image/svg+xml;base64,)

1.  Prepare a scatter/gather entry for the data to be sent (or received, in the case of an RDMA read).

2.  Create a Send Request (SR). 

    The `IBV_SEND_SIGNALED` flag is redundant.

3.  If this is an RDMA operation, set the address and key.

4.  Post the SR.

#### `9.1.13. poll_completion` ![](data:image/svg+xml;base64,)

Polls the CQ until an entry is found or the `MAX_POLL_CQ_TIMEOUT` (in milliseconds) is reached.

#### `9.1.14. resources_destroy` ![](data:image/svg+xml;base64,)

Releases, frees, and deallocates all items within the resource struct.

### 9.2. Code for Send, Receive, RDMA Read, RDMA Write ![](data:image/svg+xml;base64,)
...
### 9.3. Synopsis for Multicast Example Using RDMA_CM and IBV Verbs ![](data:image/svg+xml;base64,)
...
#### 9.3.1. Main ![](data:image/svg+xml;base64,)
...
#### 9.3.2. Run ![](data:image/svg+xml;base64,)
...
4.  Upon ending – release network resources (per all connections: leaves the multicast group and detaches its associated QP from the group)

### 9.4. Code for Multicast Using RDMA_CM and IBV Verbs ![](data:image/svg+xml;base64,)
...
#### 9.5.1. Automatic Path Migration (APM) ![](data:image/svg+xml;base64,)
...
#### 9.5.2. Multicast Code Example Using RDMA CM ![](data:image/svg+xml;base64,)
...
#### 9.5.3. Shared Received Queue (SRQ) ![](data:image/svg+xml;base64,)
...
### 9.6. Experimental APIs ![](data:image/svg+xml;base64,)

#### 9.6.1. Dynamically Connected Transport ![](data:image/svg+xml;base64,)
...
##### 9.6.1.1. DC Usage Model ![](data:image/svg+xml;base64,)

1.  Query Device: Query the device capabilities to see if the DC transport is supported, and if so, what its characteristics are.

2.  Create DCIs: The user creates DCIs (Dynamically Connected Initiators). The number of DCIs depends on the user's strategy for handling concurrent data transmissions.

3.  Create DCT: The user defines a DC Access Key and initializes a DCT (Dynamically Connected Target) using this access key.

4.  Query: The user can query the DCI with the `ibv_exp_query_qp()` routine, and can query the DCT with the `ibv_exp_query_dct()` routine.

5.  Arm DCT: The user can arm the DCT so that an event is generated when a DC Access Key violation occurs.

6.  Post Send: Send work requests are posted to the DCIs. Data can be sent to a different DCT only after all previous sends complete, so send CQEs (Completion Queue Entries) can be used to detect such completions.

7.  Detect Arrival: The CQ associated with the DCT is used to detect data arrival.

8.  Destroy: Destroy resources when done.

##### 9.6.1.2. Query Device ![](data:image/svg+xml;base64,)

The following function is used to query for device capabilities: 

    int ibv_exp_query_device(struct ibv_context *context, struct ibv_exp_device_attr *attr)

![](data:image/svg+xml;base64,)

- DC transport support: The flag `IBV_EXP_DEVICE_DC_TRANSPORT` in the field `exp_atomic_cap` of `struct ibv_exp_device_attr` defines if the DC transport is supported.

- Atomic support: The fields `int max_dc_req_rd_atom;` and `int max_dc_res_rd_atom;` in the same structure describe the DC's atomic support characteristics.

##### 9.6.1.3. Create DCT ![](data:image/svg+xml;base64,)

To create a DC target object, use:

    struct ibv_dct *ibv_exp_create_dct(struct ibv_context *context, struct ibv_exp_dct_init_attr *attr);
...
- `attr`: Defines attributes of the DCT, which include:

  - `struct ibv_pd *pd`: The PD to verify access validity with respect to protection domains.

    The PD is not checked against the PD of the scatter entry. This check is done with the PD of the DC target.
  ...
  - `access flags`: Semantics similar to RC QPs (e.g., remote read, remote write, remote atomics).
  ...
  - `pkey_index`: P_Key index used by the DC target.

  - `gid_index`: GID index associated with the DCT. Used to verify incoming packets if GRH is used. 

    This field is mandatory.

  - `hop_limit`: Used by packets sent by the DCT in case GRH is used.

##### 9.6.1.4. Destroy DCT ![](data:image/svg+xml;base64,)

To destroy a DCT object, use:

    int ibv_exp_destroy_dct(struct ibv_exp_dct *dct);

![](data:image/svg+xml;base64,)

Destroys a DC target. This call may take some time until all DCRs (Dynamically Connected Responders) are disconnected.

  

##### 9.6.1.5. Query DCT ![](data:image/svg+xml;base64,)

To query DCT attributes, use:

    int ibv_exp_query_dct(struct ibv_exp_dct *dct, struct ibv_exp_dct_attr *attr);

![](data:image/svg+xml;base64,)

Attributes queried include:
...
##### 9.6.1.6. Arm DCT ![](data:image/svg+xml;base64,)

A DC target can be armed to request notification when DC key violations occur.

- After returning from a call to `ibv_exp_arm_dct`, the DC target is moved into the `ARMED` state.

- If a packet targeting this DCT with a wrong key is received, the DCT moves to the `FIRED` state, and the `IBV_EXP_EVENT_DCT_KEY_VIOLATION` event is generated.

##### 9.6.1.7. Create DCI ![](data:image/svg+xml;base64,)

DCIs (Dynamically Connected Initiators) are created by the user. The number of DCIs required depends heavily on the user's specific strategy for handling concurrent data transmissions.

### 9.7. Verbs API for Extended Atomics Support ![](data:image/svg+xml;base64,)
...
![verbs-API-for-extended-atomics-support.png](/doca/__attachments/a_d0d0f9d25f55843828e3199484db16583086ae2f5f6e376b28ab5f08056640a8/verbs-API-for-extended-atomics-support.png?cb=f323996196d6d42dce67d4d4543de205)

In the figure above, the total operand size is N bits, with the length of each data field being four bits. The 1's in the mask indicate the termination of a data field. With ConnectX® family of NICs and Connect-IB®, there is always an implicit 1 in the mask.

##### 9.7.1.1. Supported Hardware ![](data:image/svg+xml;base64,)

NVIDIA NICs devices employ read-modify-write operations on regions that are sized as multiples of 64 bits with 64 bit alignment. Therefore, when operations are performed on user buffers that are smaller than 64 bits, the unmodified sections of such regions will be written back unmodified when the results are committed to user memory. Connect-IB® and subsequent devices operate on memory regions that are multiples of 32 or 64 bits, with natural alignment.

##### 9.7.1.2. Verbs Interface Changes ![](data:image/svg+xml;base64,)
...
##### 9.7.1.3. Query Device Capabilities ![](data:image/svg+xml;base64,)

The device capabilities flags enumeration is updated to reflect the support for extended atomic operations by adding the flag `IBV_EXP_DEVICE_EXT_ATOMICS`.

The device attribute comp mask enumeration `ibv_exp_device_attr_comp_mask` is updated using the flag `IBV_EXP_DEVICE_ATTR_EXT_ATOMIC_ARGS`.
...
Atomic fetch&add operations on subsections of the operands are also supported, with `max_fa_bit_boundary` being the log-base-2 of the largest such subfield, in bytes.

`log_max_atomic_inline` is the log of the largest amount of atomic data, in bytes, that can be put in the work request and includes the space for all required fields.
...
##### 9.7.1.4. Response Format ![](data:image/svg+xml;base64,)

The returned data is formatted in units that correspond to the host's natural word size. For example, if extended atomics are used for a 16 byte field, and returned in big-endian format, each eight byte portion is arranged in big-endian format, regardless of the size the fields used in an association in a multi-field fetch-and-add operation.

##### 9.7.1.5. QP Initialization ![](data:image/svg+xml;base64,)
...
The QP attribute enumeration comp-mask, `ibv_exp_qp_init_attr_comp_mask`, is expanded by adding `IBV_EXP_QP_INIT_ATTR_ATOMICS_ARG`.

##### 9.7.1.6. Send Work Request Changes ![](data:image/svg+xml;base64,)
...
### 9.8. User-Mode Memory Registration ![](data:image/svg+xml;base64,)

User-Mode Memory Registration (UMR) supports the creation of memory keys for non-contiguous memory regions. This includes the concatenation of arbitrary contiguous regions of memory, as well as regions with regular structure.

Three examples of non-contiguous regions of memory that are used to form new contiguous regions of memory are described below. This figure shows an example where portions of three separate contiguous regions of memory are combined to create a single logically contiguous region of memory. The base address of the new memory region is defined by the user when the new memory key is defined.

![Memory-region-described-by-Indirect-Memory-key.jpg](/doca/__attachments/a_c6292fdcdd190327e1886edaa946904e74056e4672a81fec3443804f91c3ede1/Memory-region-described-by-Indirect-Memory-key.jpg?cb=220db5b05905c0eff4fc88ae4e3027ed)

The following figure shows a non-contiguous memory region with regular. This region is defined by a base address, stride between adjacent elements, the extent of each element, and a repeat count.

![non-contiguous-memory-region.png](/doca/__attachments/a_5afdfc33c1fa00f40d2a4761d5f00caca7850610ccac3ba021c652432ef9b1f6/non-contiguous-memory-region.png?cb=132ec14dc3ddc28b2b4358c345ecbeae)

The following figure shows an example where two non-contiguous memory regions are interleaved, using the repeat structure UMR.

![Interleaving-data-from-two-separate-non-contiguous-regions-of-memory.jpg](/doca/__attachments/a_a90b5322da6d42a1b3504d97b7346607676ca88bf002ec3fded8b4eecbdf094c/Interleaving-data-from-two-separate-non-contiguous-regions-of-memory.jpg?cb=5f2996191bf7d6951014bdf3af39ae78)
...
##### 9.8.1.1. Device Capabilities ![](data:image/svg+xml;base64,)
...
The `struct ibv_exp_umr_caps umr_caps` field describes the UMR capabilities. This structure is defined as:
...
##### 9.8.1.2. QP Creation ![](data:image/svg+xml;base64,)

To configure QP UMR support the following routine must be used:

    ibv_qp * ibv_exp_create_qp(struct ibv_context *context, struct ibv_exp_qp_init_attr *qp_init_attr)

![](data:image/svg+xml;base64,)

When the attribute `IBV_EXP_QP_CREATE_UMR` is set in the exp_create_flags field of struct ibv_exp_qp_init_attr enables UMR support. The attribute `IBV_ IBV_EXP_QP_INIT_ATTR_MAX_INL_KLMS` is set in the field `comp_mask struct ibv_exp_qp_init_attr`, with the field `max_inl_send_klms` defining this number.

##### 9.8.1.3. Memory Key Manipulation ![](data:image/svg+xml;base64,)

To create an uninitialized memory key for future use: 
...
To query the resources associated with the memory key:
...
##### 9.8.1.4. Non-inline Memory Objects ![](data:image/svg+xml;base64,)
...
##### 9.8.1.5. Memory Key Initialization ![](data:image/svg+xml;base64,)
...
### 9.9. Cross-Channel Communications Support ![](data:image/svg+xml;base64,)
...
#### 9.9.1. Usage Model ![](data:image/svg+xml;base64,)
...
#### 9.9.2. Resource Initialization ![](data:image/svg+xml;base64,)

##### 9.9.2.1. Device Capabilities ![](data:image/svg+xml;base64,)
...
##### 9.9.2.2. Completion Queue ![](data:image/svg+xml;base64,)
...
##### 9.9.2.3. QP Creation ![](data:image/svg+xml;base64,)
...
The `exp_create_flags` that are available:
...
#### 9.9.3. Posting Request List ![](data:image/svg+xml;base64,)

A single operation is defined with by a set of work requests posted to multiple QP's, as described in the figure below.

![work-requests-operation.jpg](/doca/__attachments/a_1c2aef79f844e17ac8fbf85f84363d3488215f4934a9138300828bbfb04ebd86/work-requests-operation.jpg?cb=b2d5a78db13c2572b5acab8b9047aaf4)
...
For `ibv_exp_calc_data_type` the following types are supported:
...
##### 9.9.3.1. ConnectX-3/Connect-IB Data Endianess ![](data:image/svg+xml;base64,)
...
- [](/doca/archive/3-5-0/rdma)
  ![](data:image/svg+xml;base64,)

  Previous Page

  RDMA
- [](/doca/archive/3-5-0/rdma-over-converged-ethernet)
  Next Page

  RDMA over Converged Ethernet

  ![](data:image/svg+xml;base64,)
