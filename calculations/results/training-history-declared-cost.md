...
输入：`{"comparisons": [], "duration_scenarios": [], "lifecycle": [{"currency": "teaching_units", "model": "deepseek-v3-pretraining", "other_cost": 0, "scope": "Teaching scenario: selected reported training row and declared service usage; quality not matched; other costs explicitly excluded", "service_price_per_unit": "1/100", "service_unit": "request", "service_usage": 1000000, "training_price_per_gpu_hour": "2"}, {"currency": "teaching_units", "model": "qwen3-8b-proxy", "other_cost": 0, "scope": "Teaching scenario: selected reported training row and declared service usage; quality not matched; other costs explicitly excluded", "service_price_per_unit": "1/100", "service_unit": "request", "service_usage": 1000000, "training_price_per_gpu_hour": "2"}]}`
...
- `{"input": {"model": "deepseek-v3-pretraining", "currency": "teaching_units", "service_unit": "request", "scope": "Teaching scenario: selected reported training row and declared service usage; quality not matched; other costs explicitly excluded", "training_price_per_gpu_hour": "2", "service_usage": 1000000, "service_price_per_unit": "1/100", "other_cost": 0}, "training_gpu_hours_exact": "2664000", "training_cost_exact": "5328000", "service_cost_exact": "10000", "scoped_lifecycle_cost_exact": "5338000", "interpretation": "caller_supplied_cost_scenario_for_selected_training_row_and_service_usage"}`
- `{"input": {"model": "qwen3-8b-proxy", "currency": "teaching_units", "service_unit": "request", "scope": "Teaching scenario: selected reported training row and declared service usage; quality not matched; other costs explicitly excluded", "training_price_per_gpu_hour": "2", "service_usage": 1000000, "service_price_per_unit": "1/100", "other_cost": 0}, "training_gpu_hours_exact": null, "training_cost_exact": null, "service_cost_exact": "10000", "scoped_lifecycle_cost_exact": null, "interpretation": "caller_supplied_cost_scenario_for_selected_training_row_and_service_usage"}`
