...
输入：`{"batches": [1, 64], "device": "rtx-pro6000-blackwell-ws", "history": 2742, "model": "qwen3-8b", "workspace_bytes": 0}`
...
| per_request_history_read_bytes | 404,324,352 |
| nominal_device_capacity_bytes | 96,000,000,000 |
| declared_capacity_max_batch | 196 |
| kv_history_equals_weights_batch | 38 |
| compute_memory_crossover_batch | `null` |
| crossover_capacity_feasible | `false` |
| single_request_matrix_flops | 16,754,081,792 |
| hardware_ridge_flops_per_byte_exact | `"62975/224"` |

| batch | 矩阵FLOPs | 旧KV读bytes | 总声明流量bytes | 省权重读bytes | 声明驻留bytes | 容量可行 | 资源主导 |
| ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| 1 | 16754081792 | 404324352 | 15541291008 | 0 | 16785942528 | True | memory |
| 64 | 1072261234688 | 25876758528 | 41023531008 | 953619093504 | 42267666432 | True | memory |
