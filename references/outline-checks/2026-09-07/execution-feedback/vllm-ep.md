<!-- 从 vllm-ep.html 迁移的资料快照；原始 HTML SHA-256: 6e1d1cf58deeba5a9d3b2f596ddfb8563c51237ae1342eef2b14f684d5993f4c。 -->
...
[ Offline Inference ](../offline_inference/)

[ Online Serving ](../online_serving/)

Online Serving

- [ Derenderer APIs ](../online_serving/derenderer/)
- [ Generative Scoring ](../online_serving/generative_scoring/)
- [ OpenAI-Compatible Server ](../online_serving/openai_compatible_server/)
- [ Renderer APIs ](../online_serving/renderer/)
- [ Speech to Text APIs ](../online_serving/speech_to_text/)
- [ Trace Replay ](../online_serving/trace_replay/)

[ Context Parallel Deployment ](../context_parallel_deployment/)

[ Data Parallel Deployment ](../data_parallel_deployment/)

[ Troubleshooting distributed deployments ](../distributed_troubleshooting/)

Expert Parallel Deployment [ Expert Parallel Deployment ](./)
...
- [ Single Node Deployment ](#single-node-deployment)
  ...
  - [ Layer Behavior with EP Enabled ](#layer-behavior-with-ep-enabled)
  - [ Example Command ](#example-command)
- [ Multi-Node Deployment ](#multi-node-deployment)
  - [ Deployment Steps ](#deployment-steps)
  - [ Example: 2-Node Deployment ](#example-2-node-deployment)
  - [ Key Configuration Notes ](#key-configuration-notes)
  - [ Network Configuration ](#network-configuration)
- [ Expert Parallel Load Balancer (EPLB) ](#expert-parallel-load-balancer-eplb)
  - [ Configuration ](#configuration_1)
  - [ EPLB Parameters ](#eplb-parameters)
  - [ Expert Distribution Formula ](#expert-distribution-formula)
  - [ Memory Footprint Overhead ](#memory-footprint-overhead)
  - [ Example Command ](#example-command_1)
- [ Advanced Configuration ](#advanced-configuration)
  - [ Performance Optimization ](#performance-optimization)
  - [ Troubleshooting ](#troubleshooting)
  - [ Benchmarking ](#benchmarking)
- [ Disaggregated Serving (Prefill/Decode Split) ](#disaggregated-serving-prefilldecode-split)
  - [ Architecture Overview ](#architecture-overview)
  - [ Setup Steps ](#setup-steps)
  - [ Client Orchestration Example ](#client-orchestration-example)
  - [ Benchmarking ](#benchmarking_1)

[ Parallelism and Scaling ](../parallelism_scaling/)

Integrations

Integrations

- [ Claude Code ](../integrations/claude_code/)
...
1.  [ Home ](../..)
2.  [ User Guide ](../../usage/)
3.  [ Inference and Serving ](../offline_inference/)

[![](data:image/svg+xml;base64,)](https://github.com/vllm-project/vllm/edit/main/docs/serving/expert_parallel_deployment.md "Edit this page")
