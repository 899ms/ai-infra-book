...
{'batch': 1, 'tokens': 1, 'history': 8192, 'execution': 'ced', 'index_algorithm': 'candidate', 'output_head': 'last'}

| 项目 | 结果 |
| --- | ---: |
| 文本逻辑参数（含 Engram） | 748,494,684,784 |
| 完整矩阵 FLOPs | 35,917,045,760 |
| 上下文交互 FLOPs | 3,657,474,048 |
| 调用前 BF16 逻辑状态（B） | 31,547,392 |
| 调用后 BF16 逻辑状态（B） | 31,548,680 |
