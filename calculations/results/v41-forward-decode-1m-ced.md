...
{'batch': 1, 'tokens': 1, 'history': 1048575, 'execution': 'ced', 'index_algorithm': 'candidate', 'output_head': 'last'}

| 项目 | 结果 |
| --- | ---: |
| 文本逻辑参数（含 Engram） | 748,494,684,784 |
| 完整矩阵 FLOPs | 57,492,897,792 |
| 上下文交互 FLOPs | 25,232,932,864 |
| 调用前 BF16 逻辑状态（B） | 3,369,094,136 |
| 调用后 BF16 逻辑状态（B） | 3,369,099,264 |
...
| index_projection | 87,031,808 |
| index_interaction | 22,011,707,392 |
