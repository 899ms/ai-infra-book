<!-- 从 vllm-hybrid-disagg.html 迁移的资料快照；原始 HTML SHA-256: 44b718d8d8ef4d95e328a4338e10d123e58d618eed73ade590ea1141d544aac4。 -->
...
[\#disaggregation](/blog/tags/disaggregation)[\#mamba](/blog/tags/mamba)

- [Introduction](#introduction)
- [Background: The NIXL KV Transfer Workflow](#background-the-nixl-kv-transfer-workflow)
- [The Challenge: FA and SSM State Are Fundamentally Different](#the-challenge-fa-and-ssm-state-are-fundamentally-different)
- [The HMA Shared-Tensor Layout](#the-hma-shared-tensor-layout)
- [Dual Descriptor Views](#dual-descriptor-views)
- [Physical vs. Logical Block Sizes](#physical-vs-logical-block-sizes)
- [The 3-Descriptors Conv Transfer](#the-3-descriptors-conv-transfer)
- [The DS Layout Solution](#the-ds-layout-solution)
- [Zero-Overhead: No Extra Buffers, No Permutation](#zero-overhead-no-extra-buffers-no-permutation)
- [Putting It Together: Nemotron-H Example](#putting-it-together-nemotron-h-example)
...
![Figure 1: P→D transfer volume vs. input sequence length for Nemotron Super 120B (TP=4, FA block_size=4224). The Naive and Optimal baselines are computed analytically from the model's page sizes and block counts. The Measured line reports the actual bytes transferred (as reported by NIXL) during disaggregated P/D serving. Our approach (Optimal) eliminates HMA padding overhead, which is reflected in the measured transfer.](/blog-assets/figures/2026-04-21-hybrid-ssm-disagg/transfer-volume-vs-isl.png)
...
![Figure 2: Disaggregated P/D vs. co-located serving for a hybrid SSM model. Throughput-vs-latency Pareto curve across concurrency levels. Prefix-caching disabled.](/blog-assets/figures/2026-04-21-hybrid-ssm-disagg/disagg-vs-colocated.png)
...
[](/blog/2026-07-14-vllm-tilert-pd)
