...
artifacts=outputs+[HERE/'teaching_revision.py',HERE/'figure-index.json',HERE/'teaching-layout-validation.json',HERE/'visual_examples.py',HERE/'figure-catalog.json',HERE/'figure-data.json',HERE/'continuity-model.json',HERE/'continuity_model.py',hp,md]+active_assets
