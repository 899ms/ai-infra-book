...
| over_budget_ranks | `[]` |
| serialized_copy_setup_ns_exact | `"15555064/25"` |
| baseline_batch_ns_exact | `"920649728/1675"` |
| replicated_batch_ns_exact | `"517865472/1675"` |
| per_batch_saving_ns_exact | `"402784256/1675"` |
| algebraic_strict_payback_batches | 3 |
| feasible_strict_payback_batches | 3 |
| baseline_window_ns_exact | `"117843165184/1675"` |
| replicated_window_ns_exact | `"67328969704/1675"` |
| window_saving_ns_exact | `"10102839096/335"` |
| selected_deployment | `"replicated"` |
| selected_window_ns_exact | `"67328969704/1675"` |
