...
输入：`{"batch": 1, "decode_steps": 1024, "element_bytes": 2, "kv_layout": "mla", "kv_model": "deepseek-v3", "length": 8192, "model": "qwen3-8b", "network_bandwidth": 25000000000, "path": "direct", "staging_bandwidth": 25000000000, "startup_ns": 5000}`
...
| head_dim | 128 |
| kv_layout | `"mla"` |
| kv_bytes_per_token | 70,272 |
| pd_snapshot_bytes | 575,668,224 |
| af_one_direction_bytes | 8,192 |
| af_total_bytes | 603,979,776 |
| af_directional_messages | 73,728 |
| hops_per_message | 1 |
| pd_serialized_ns_exact | `"575793224/25"` |
| af_serialized_ns_exact | `"9819979776/25"` |
| byte_matched_extra_ns_exact | `"368635000"` |
| equal_time_startup_ns_exact | `null` |
| af_faster_at_selected_startup | `false` |

| 交接 | payload bytes | 消息数 | 接口 | 接口bytes | 启动次数 | 载荷ns | 启动ns |
| --- | ---: | ---: | --- | ---: | ---: | --- | ---: |
| PD snapshot | 575668224 | 1 | network | 575668224 | 1 | 575668224/25 | 5000 |
| AF decode activations | 603979776 | 73728 | network | 603979776 | 73728 | 603979776/25 | 368640000 |
| byte-matched repeated handoffs | 575668224 | 73728 | network | 575668224 | 73728 | 575668224/25 | 368640000 |

| 消息缓冲 | 源GPU bytes | 目的GPU bytes | 源host bytes | 目的host bytes |
| --- | ---: | ---: | ---: | ---: |
| pd | 575668224 | 575668224 | 0 | 0 |
