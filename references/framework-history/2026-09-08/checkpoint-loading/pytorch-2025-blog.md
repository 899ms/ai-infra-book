<!-- 从 pytorch-2025-blog.html 迁移的资料快照；原始 HTML SHA-256: 9bb36aea7ba7e20d453d79d20c63f27c83565f19ada5a5f7a07ff3c7de49a224。 -->

[Blog](https://pytorch.org/blog/category/blog/)

# 6x faster Async Checkpointing in PyTorch, using Cached Plans, no GIL contention

By [Meta and Crusoe](#)April 30, 2025May 3rd, 2025[No Comments](https://pytorch.org/blog/6x-faster-async-checkpointing/#respond)
...
![](https://pytorch.org/wp-content/uploads/2025/04/fg1-2.png)
...
*![](https://pytorch.org/wp-content/uploads/2025/04/fg2-2.png)Fig 2: One can see a sustained drop in training QPS even after staging (i.e. blocking operation to trainer) is complete.*
...
*![](https://pytorch.org/wp-content/uploads/2025/04/fg3-1.png)Fig 3: The red box shows the non-cached plan checkpoint, which also includes Checkpoint Background Init process overhead, while the purple box highlights the first checkpoint to run with the cached plan.*
