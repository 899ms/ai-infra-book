<!-- 从 sglang-inkling-2026.html 迁移的资料快照；原始 HTML SHA-256: 4826b792abb4d432c2f7ff0edd5fb82a7b47dad807d9623c88d7543bebd38e55。 -->
...
- [Inkling Model Architecture](#inkling-model-architecture)
- [Overview](#overview)
- [Short Convolution (ShortConv)](#short-convolution-shortconv)
- [Attention with Relative Positional Embedding](#attention-with-relative-positional-embedding)
- [MoE With Shared Expert Sink](#moe-with-shared-expert-sink)
- [SGLang Optimization](#sglang-optimization)
- [ShortConv Optimization](#shortconv-optimization)
- [Relative Logits Optimization](#relative-logits-optimization)
- [Shared-Expert Sink Optimization](#shared-expert-sink-optimization)
- [Feature Support](#feature-support)
- [Speculative Decoding with Multi-layer Eagle](#speculative-decoding-with-multi-layer-eagle)
- [Speculative Decoding with DFlash](#speculative-decoding-with-dflash)
- [Prefill-Decode Disaggregation](#prefill-decode-disaggregation)
- [AMD GPU Support](#amd-gpu-support)
- [LoRA Serving](#lora-serving)
- [Radix Cache and HiCache](#radix-cache-and-hicache)
- [Multimodal Optimization](#multimodal-optimization)
- [Performance Results](#performance-results)
- [Reinforcement Learning with Miles](#reinforcement-learning-with-miles)
- [RL Training Backend with DP/PP/TP/SP/EP/CP Support](#rl-training-backend-with-dppptpspepcp-support)
- [Full-Parameter RL](#full-parameter-rl)
- [Customized Efficient Kernels for Train–Inference Consistency](#customized-efficient-kernels-for-traininference-consistency)
- [Routing Replay for the Shared-Sink MoE](#routing-replay-for-the-shared-sink-moe)
- [LoRA Implementation in Inkling](#lora-implementation-in-inkling)
- [End-to-End LoRA RL with Adapter-Only Synchronization](#end-to-end-lora-rl-with-adapter-only-synchronization)
- [Multimodal LoRA RL with Expansion-Aligned Routing Replay](#multimodal-lora-rl-with-expansion-aligned-routing-replay)
- [Acknowledgment](#acknowledgment)

# SGLang and Miles Add Day-0 Support for Inkling, a Frontier Multimodal Model

SGLang Team & Thinking Machines LabJuly 15, 2026
...
![Inkling model architecture: attention and MoE submodules with ShortConv, relative logits, and the shared-expert sink](/images/blog/inkling-day0-support/model_arch.png)
...
![CPU call-stack trace under BCG replay, showing each ShortConv site's eager execution](/images/blog/inkling-day0-support/prefill-full-cuda-graph.png)
...
![FA4 warp-specialized schedule in the MXFP8 + sheared-bias configuration](/images/blog/inkling-day0-support/fig_fa4_warp_schedule.svg)
...
![Shared-expert fusion: from an expert-batched implementation to a linearized GEMM layout](/images/blog/inkling-day0-support/fig_shared_expert_fusion.svg)
...
![One decode round of Inkling's multi-layer MTP](/images/blog/inkling-day0-support/fig_mtp_chain.svg)
...
![Inkling's two-stream LoRA serving schedule](/images/blog/inkling-day0-support/fig_lora_serving.svg)
...
![Inkling serving performance on B200: throughput-interactivity Pareto curve for TP=4 vs TP=8, and ITL bar comparison across batch sizes](/images/blog/inkling-day0-support/fig_performance_pareto.png)
...
![Train-rollout KL during full-parameter RL](/images/blog/inkling-day0-support/full-para-kl.png)  
  
![Raw reward during full-parameter RL](/images/blog/inkling-day0-support/full-para-reward.png)  
  
![AIME25 evaluation during full-parameter RL](/images/blog/inkling-day0-support/full-para-eval.png)
...
![Bidirectional LoRA RL contract. SGLang sends rollout data to Miles; Miles updates and exports the adapter tensors back to SGLang.](/images/blog/inkling-day0-support/moonrise_rl_lora.jpg)
...
![Raw reward during LoRA RL](/images/blog/inkling-day0-support/lora-text-reward.png)
...
![Image and audio sentinels expand into vision-patch and audio-frame positions, with R3 expert IDs indexed over the expanded sequence.](/images/blog/inkling-day0-support/moonrise_rl_mm.jpg)
...
![Geo3K evaluation during vision LoRA RL](/images/blog/inkling-day0-support/lora-vision-eval.png)
