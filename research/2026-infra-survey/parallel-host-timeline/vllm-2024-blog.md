<!-- 从 vllm-2024-blog.html 迁移的资料快照；原始 HTML SHA-256: 5420dc0f2aa3146e27aaac367d015a7fe6dd9e091d70997f1ab921e095af25d0。 -->
...
![](/assets/figures/perf-v060/llama8B_comparison.png)     ![](/assets/figures/perf-v060/llama70B_comparison.png)  
...
![](/assets/figures/perf-v060/illustration-api-server.png) Illustration of the serving process architecture before and after. We separated the http serving component from the vLLM engine, and connected them with a ZMQ socket. This architecture ensures both CPU heavy components are isolated from each other.
...
![](/assets/figures/perf-v060/illustration-multi-step.png)  
...
![](/assets/figures/perf-v060/illustration-async-output-processing.png)  
...
![](/assets/figures/perf-v060/overall_throughput.png)  
...
![](/assets/figures/perf-v060/A100_8B.png)
...
![](/assets/figures/perf-v060/A100_70B.png)
...
![](/assets/figures/perf-v060/H100_8B.png)
...
![](/assets/figures/perf-v060/H100_70B.png)

[](/2024/09/05/perf-update.html)
