...
> 2026-09-09 六节重组配套。正文顺序为计算基线、完整生成、历史状态、专家权重、网络组织与整模型比较；核算证据、配置、实验变体和质量限制保留原文。

本页与[本章大纲](../02-%E6%A8%A1%E5%9E%8B%E6%9E%B6%E6%9E%84.md)采用同一组节号。以下来源段落中的“随后”“本节”等局部叙述沿用归档措辞，现行讲解顺序以小节标题与正文为准；既有计算状态反映各记录写入时的范围，后续汇总由同名计算结果提供。实验与配图编号不变，目录和旧新映射见[重组记录](../../../research/ch02-reorganization-2026-09-09/README.md)。
