<!-- 从 source-arxiv-v1.html 迁移的资料快照；原始 HTML SHA-256: 3be631297ddcf7ed082f1f2109d810fbed9f4d0bdaf4dd5cb69466ac53654702。 -->

# Computer Science \> Hardware Architecture

**arXiv:2408.12073v1** (cs)

\[Submitted on 22 Aug 2024 (this version), *latest version 28 Feb 2025* ([v2](https://arxiv.org/abs/2408.12073v2))\]

# Title:Virgo: Cluster-level Matrix Unit Integration in GPUs for Scalability and Energy Efficiency

Authors:[Hansung Kim](https://arxiv.org/search/cs?searchtype=author&query=Kim,+H), [Ruohan Yan](https://arxiv.org/search/cs?searchtype=author&query=Yan,+R), [Joshua You](https://arxiv.org/search/cs?searchtype=author&query=You,+J), [Tieliang Vamber Yang](https://arxiv.org/search/cs?searchtype=author&query=Yang,+T+V), [Yakun Sophia Shao](https://arxiv.org/search/cs?searchtype=author&query=Shao,+Y+S)
...
[View PDF](/pdf/2408.12073v1) [HTML (experimental)](https://arxiv.org/html/2408.12073v1)
...
**[\[v2\]](/abs/2408.12073v2)** Fri, 28 Feb 2025 23:32:44 UTC (3,027 KB)  
...
- [View PDF](/pdf/2408.12073v1)

- [HTML (experimental)](https://arxiv.org/html/2408.12073v1)

- [TeX Source](/src/2408.12073v1)
