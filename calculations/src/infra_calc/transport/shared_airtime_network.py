"""Shared half-duplex access hop over the public media feedback engine."""
from fractions import Fraction as F
from collections import deque
import copy
import heapq
from . import media_network as base
from . import airtime
...
def verify_sources():
    return reference_sources("shared_airtime")
...
class Network(base.Network):
    ...
    def run(self):
        ...
        result["wireless_reference_root"] = str(PROJECT)
