<!-- 从 sglang-dspark-2026.html 迁移的资料快照；原始 HTML SHA-256: 9fbfd7842a2c66ab8fae835e6a7634194ef6f28a95df88b989edc90b6da50745。 -->
...
- [The speedup over MTP and non-spec](#the-speedup-over-mtp-and-non-spec)
- [Adopting DSpark in SGLang](#adopting-dspark-in-sglang)
- [Verify modes](#verify-modes)
- [Ragged verify under full CUDA graphs](#ragged-verify-under-full-cuda-graphs)
- [Observability](#observability)
- [Estimating the ceiling under trimming](#estimating-the-ceiling-under-trimming)
- [A preliminary look at dynamic vs. fixed scheduling](#a-preliminary-look-at-dynamic-vs-fixed-scheduling)
- [Per-request differentiation on mixed traffic](#per-request-differentiation-on-mixed-traffic)
- [Performance optimizations and zero-overhead scheduling (ZOS)](#performance-optimizations-and-zero-overhead-scheduling-zos)
- [Profiling the cost table](#profiling-the-cost-table)
...
![Aggregate throughput vs. per-user decode speed on H200 dp4, one curve per arm: non-spec floor, MTP, and DSpark. Right-and-up is better; each marker is a batch size averaged over three rounds.](/images/blog/dspark-sglang/perf-compare.png)
...
![](/images/blog/dspark-sglang/dyn-schedule-gsm8k.png) ![](/images/blog/dspark-sglang/dyn-schedule-arena.png)
