<!-- 从 sglang-specv2-2026.html 迁移的资料快照；原始 HTML SHA-256: b301c565db0dba8b86e2b00d49003c3ca90eb1b22a37c6248ab7cee65d1de727。 -->
...
- [DFlash: Parallel drafting with KV injection](#dflash-parallel-drafting-with-kv-injection)
- [Why is DFlash so fast?](#why-is-dflash-so-fast)
- [Implementing DFlash in SGLang](#implementing-dflash-in-sglang)
- [Eliminating host overhead for DFlash with Spec V2 and overlap scheduling](#eliminating-host-overhead-for-dflash-with-spec-v2-and-overlap-scheduling)
- [High-performance DFlash draft models are available for a variety of models](#high-performance-dflash-draft-models-are-available-for-a-variety-of-models)
- [Try DFlash in SGLang now](#try-dflash-in-sglang-now)
- [Acknowledgements](#acknowledgements)

# The next generation of speculative decoding: DFlash and Spec V2

Z Lab, Modal, and SGLang TeamsJune 15, 2026
...
![](/images/blog/dflash-v2/dflash-vs-eagle-draft-latency.webp)
...
![](/images/blog/dflash-v2/dflash-perf-big-sweep.webp) For benchmark details and to reproduce the numbers yourself, see [the Hugging Face repo](https://huggingface.co/modal-labs/Qwen3.5-397B-A17B-DFlash/tree/main/benchmark).
