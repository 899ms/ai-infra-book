<!-- 从 nvidia-gb300-page.html 迁移的资料快照；原始 HTML SHA-256: 029c5eebdc1c4bddeebb1f8133c2301fd5d268605af7de06764f9f5a30158bbe。 -->
...
![NVIDIA GB300 NVL72](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII= "NVIDIA GB300 NVL72")
...
[View Datasheet](https://resources.nvidia.com/en-us-blackwell-architecture/blackwell-ultra-datasheet)
...
The NVIDIA GB300 NVL72 features a fully liquid-cooled, rack-scale architecture that integrates 72 [NVIDIA Blackwell Ultra GPUs](https://www.nvidia.com/en-us/data-center/technologies/blackwell-architecture/) and 36 Arm®-based [NVIDIA Grace™ CPUs](https://www.nvidia.com/en-us/data-center/grace-cpu/) into a single platform. The system delivers 1.5x more dense FP4 Tensor Core FLOPS and 2x higher attention performance compared to NVIDIA Blackwell GPUs. It’s purpose-built for test-time scaling inference and AI reasoning tasks. [AI factories](https://www.nvidia.com/en-us/solutions/ai-factories/) accelerated by the GB300 NVL72—leveraging NVIDIA Quantum-X800 InfiniBand or Spectrum-X™ Ethernet, ConnectX-8 SuperNIC™s, and NVIDIA Mission Control management—deliver up to a 50x overall increase in AI factory output performance compared to [NVIDIA Hopper-based platforms](https://www.nvidia.com/en-us/data-center/technologies/hopper-architecture/).

## Wistron Opens Advanced Manufacturing Plant to Produce NVIDIA AI Systems

The 324,000-square-foot Texas facility produces NVIDIA Grace Blackwell Ultra and will produce Vera Rubin Superchips — part of a combined \$700 million investment in advanced American manufacturing.

[Read the Press Release ](https://blogs.nvidia.com/blog/wistron-manufacturing-texas/)

## Performance

## Increase AI Factory Output Performance by 50x

![NVIDIA Blackwell Ultra AI Factory Output](/content/nvidiaGDC/us/en_US/data-center/gb300-nvl72/_jcr_content/root/responsivegrid/nv_container/nv_container_1005881640/nv_image.coreimg.svg/1759899525667/gb300-nvl72-supercharged-ai-factory-perf-chart.svg "NVIDIA Blackwell Ultra AI Factory Output")
...
![Blackwell Architecture AI Icon](/content/nvidiaGDC/us/en_US/data-center/gb300-nvl72/_jcr_content/root/responsivegrid/nv_container_906576169/nv_container/nv_container/nv_image_copy.coreimg.svg/1759899526026/neural-network-3-icon.svg "Blackwell Architecture AI Icon")

### AI Reasoning Inference

Test-time scaling and AI reasoning increase the compute necessary to achieve quality of service and maximum throughput. NVIDIA Blackwell Ultra’s [Tensor Cores](https://www.nvidia.com/en-us/data-center/tensor-cores/) are supercharged with 2x the attention-layer acceleration and 1.5x more AI compute floating-point operations per second (FLOPS) compared to NVIDIA Blackwell GPUs.

![Grace CPU Icon](/content/nvidiaGDC/us/en_US/data-center/gb300-nvl72/_jcr_content/root/responsivegrid/nv_container_906576169/nv_container/nv_container_copy/nv_image_copy.coreimg.svg/1759899526093/m48-ram-memory.svg "Grace CPU Icon")
...
![NVSwitch Icon](/content/nvidiaGDC/us/en_US/data-center/gb300-nvl72/_jcr_content/root/responsivegrid/nv_container_906576169/nv_container/nv_container_copy_2127417559/nv_image_copy.coreimg.svg/1759899526160/blackwell-ai-superchip-icon.svg "NVSwitch Icon")

### NVIDIA Blackwell Architecture

The [NVIDIA Blackwell architecture](https://www.nvidia.com/en-us/data-center/technologies/blackwell-architecture/) delivers groundbreaking advancements in accelerated computing, powering a new era of unparalleled performance, efficiency, and scale.

![NVIDIA Networking DPU Icon](/content/nvidiaGDC/us/en_US/data-center/gb300-nvl72/_jcr_content/root/responsivegrid/nv_container_906576169/nv_container/nv_container_copy_580810006/nv_image_copy.coreimg.svg/1759899526227/m48-dpu-chip.svg "NVIDIA Networking DPU Icon")

### NVIDIA ConnectX-8 SuperNIC

The [NVIDIA ConnectX-8 SuperNIC’s](https://resources.nvidia.com/en-us-accelerated-networking-resource-library/connectx-datasheet-c) input/output (IO) module hosts two ConnectX-8 devices, providing 800 gigabits per second (Gb/s) of network connectivity for each GPU in the NVIDIA GB300 NVL72. This delivers best-in-class remote direct-memory access (RDMA) capabilities with either [NVIDIA Quantum-X800 InfiniBand](https://www.nvidia.com/en-us/networking/products/infiniband/quantum-x800/) or [Spectrum-X Ethernet](https://www.nvidia.com/en-us/networking/spectrumx/) networking platforms, enabling peak AI workload efficiency.

![NVIDIA RAM Memory Icon](/content/nvidiaGDC/us/en_US/data-center/gb300-nvl72/_jcr_content/root/responsivegrid/nv_container_906576169/nv_container/nv_container_copy_1559866324/nv_image_copy.coreimg.svg/1759899526294/m48-gpu-chip.svg "NVIDIA RAM Memory Icon")
...
![NVIDIA Neural Network Icon](/content/nvidiaGDC/us/en_US/data-center/gb300-nvl72/_jcr_content/root/responsivegrid/nv_container_906576169/nv_container/nv_container_copy_1630138163/nv_image_copy.coreimg.svg/1759899526360/m48-nvswitch-1.svg "NVIDIA Neural Network Icon")

### Fifth-Generation NVIDIA NVLink

Unlocking the full potential of accelerated computing requires seamless communication between every GPU. The fifth generation of [NVIDIA NVLink™](https://www.nvidia.com/en-us/data-center/nvlink/) is a scale–up interconnect that unleashes accelerated performance for AI reasoning models.
...
[Learn More About NVIDIA DGX Station ](https://www.nvidia.com/en-us/products/workstations/dgx-station/)
...
[View All Blogs](https://developer.nvidia.com/blog/search-posts/?q=grace)

[View All Sessions](https://www.nvidia.com/gtc/session-catalog/)

## Get Started

### Get NVIDIA GB300 NVL72

Reach out to sales to get NVIDIA GB300 NVL72.
...
[Subscribe Now](https://www.nvidia.com/en-us/preferences/email-signup/)
