<!-- 从 isca2026-program.html 迁移的资料快照；原始 HTML SHA-256: 2e460a2b4f7a441be75b2206045242e42660ad4e604704493910aefc67f6abe6。 -->

[ISCA 2026](../index.php)

- [Submit Work ](#)
  - Papers
  - [Call for Papers](../submit/callforpapers.php)
  - [ Industry Track](../submit/industry.php)
  - [Submission Guidelines](../submit/guidelines.php)
  - [ Submit](../submit/submit.php)
  - [Reviewer Guidelines](../submit/reviewers.php)
  - [Artifact Evaluation](../submit/artifactevaluation.php)
  - [Camera-Ready Guidelines](../submit/cameraready.php)
  - 
  - Workshops / Tutorials
  - [Call for Workshops & Tutorials](../submit/workshops.php)
- [Program ](#)
  - [Main Program](../program/)
  - [Workshops / Tutorials](../program/workshops.php)
- [Attend ](#)
  - Registration
  - [ Register](../attend/register.php)
  - [Remote Attendance](../attend/remoteattendance.php)
  - 
  - Visiting Raleigh
  - [Venue & Hotel](../attend/venuehotel.php)
  - [Tourism](../attend/tourism.php)
  - [Excursion](../attend/excursion.php)
  - 
  - Travel Support
  - [Visa Information](../attend/visa.php)
  - [Student Travel Grants](../attend/travelgrants.php)
  - [Childcare](../attend/childcare.php)
- [Sponsor](../sponsor/callforsponsorship.php)
- [Committees ](#)
  - [Organizing Committee](../committees/org.php)
  - [Program Committees](../committees/pc.php)
  - [Artifact Evaluation Committee](../committees/aec.php)
  - [Steering Committee](../committees/steering.php)
- [Code of Conduct](../codeofconduct.php)

&nbsp;

- [](https://www.linkedin.com/company/international-symposium-on-computer-architecture)
- [](https://x.com/ISCAConfOrg)
- [](https://www.instagram.com/iscaconf/)
- [ iscaconf.org](https://www.iscaconf.org/)
- [](../)
...
- [Saturday, June 27](#sat)
- [Sunday, June 28](#sun)
- [Monday, June 29](#mon)
- [Tuesday, June 30](#tue)
- [Wednesday, July 1](#wed)

## Saturday, June 27

The workshop / tutorial portion of ISCA 2026 begins!

View the the [workshops / tutorials program.](./workshops.php) Please visit the respective webpage of a workshop/tutorial for its detailed schedule.
...
#### [Keynote - Computing at the Crossroads: Architecture, Economics, and the Next Era](#k1)
...
#### [Session 1A: Best Paper Candidate Session (Plenary)](#1a)

##### Location: Ballroom A

Session Chair: José F. Martínez (Cornell University)

10:15 – 10:35

MLX: Multi-Layer Execution for Structured LLM Workload Acceleration on Spatial Architectures

Haibin Wu (Institute of Computing Technology, CAS), Wenming Li (Institute of Computing Technology, CAS), Zhihua Fan (Institute of Computing Technology, CAS), Zirui Ma (Institute of Computing Technology, CAS), Yuqun Liu (Institute of Computing Technology, CAS), Tengfei Xia (Institute of Computing Technology, CAS), Yanhuan Liu (Institute of Computing Technology, CAS), Kunming Zhang (Institute of Computing Technology, CAS), Xiaochun Ye (Institute of Computing Technology, CAS), Dongrui Fan (Institute of Computing Technology, CAS), Jian Weng (KAUST)
...
#### [Session 2B: Memory Systems and PIM/PNM](#2b)
...
#### [Session 2C: Sustainability](#2c)

##### Location: Room 402

Session Chair: Yan Solihin (UCF)
...
#### [Session 2D: Storage](#2d)

##### Location: Room 301

Session Chair: Mark D. Hill (Univ. of Wisconsin-Madison)
...
#### [Session 3A: ML Accelerators 1](#3a)

##### Location: Ballroom A

Session Chair: Bahar Asgari (UMD College Park)
...
#### [Session 3B: DRAM and SRAM PIM/PNM](#3b)
...
#### [Session 3D: Microarchitecture](#3d)

##### Location: Room 301

Session Chair: Sagar Karandikar (UC Berkeley)
...
Session Chair: Pantea Zardoshti (NVIDIA)
...
#### [Session 4B: Industry Track 1](#4b)

##### Location: Room 302

Session Chair: Shanmathi Natarajan (Meta)
...
#### [Session 4C: Domain Specific Accelerators 1](#4c)
...
#### [Session 4D: Quantum 1](#4d)

##### Location: Room 301

Session Chair: Di Wu (University of Central Florida)
...
#### [SIGARCH-TCCA Business Meeting](#tcca)
...
#### [ACM SIGARCH WICArch Meetup](#wicarch)

##### Location: [Sitti](https://www.sitti-raleigh.com/)

[ACM SIGARCH's Women in Computer Architecture (WICArch)](https://www.sigarch.org/wicarch/) meetup will take place over dinner at [Sitti](https://www.sitti-raleigh.com/) (137 S Wilmington St, Raleigh, NC 27601) starting at 8:00 PM. If you would like to connect with fellow women in computer architecture in a welcoming and informal setting, we would love to have you join us! Thank you to ACM SIGARCH for supporting WICArch!
...
#### [Keynote - Architecting Hybrid Quantum-Classical Computing for Scale and Fault Tolerance](#k2)
...
Session Chair: Augusto Vega (IBM Research)
...
#### [Session 5B: Industry Track 2](#5b)

##### Location: Room 302

Session Chair: Stefan Saroiu (Microsoft)
...
#### [Session 5C: Crypto and Security](#5c)

##### Location: Room 402

Session Chair: Caroline Trippel (Stanford University)
...
#### [Session 5D: Potpourri](#5d)

##### Location: Room 301

Session Chair: Biswabandan Panda (IIT Bombay)
...
Session Chair: Sumanth Gudaparthi (AMD)

14:15 – 14:20

Tetris: Efﬁcient Long-context LLM Serving with Chunkwise Dynamic Sequence Parallelism
...
#### [Session 6B: Deep Learning / Memory Acceleration](#6b)

##### Location: Room 302

Session Chair: Hongxiang Fan (Imperial College London)
...
#### [Session 6C: GPUs and Compilation](#6c)

##### Location: Room 402

Session Chair: Chen Zhang (Shanghai Jiao Tong University)
...
#### [Session 6D: Rowhammer and Security](#6d)
...
#### [Panel - Computer Architecture Research and Education in the GenAI Era](#p1)

##### Location: Ballroom A

Akansha Jain (Google), Daniel Jimenez (TAMU), Bobbie Manne (AMD), Saptadeep Pal (Etched), Dimitrios Skarlatos (CMU/Lithos AI), Caroline Trippel (Stanford)  
Moderator: Karu Sankaralingam (UW-Madison / NVIDIA)

With traditional scaling at an end, microarchitectural innovation remains the primary engine for computing performance. Yet, as we navigate this highly constrained design space, the fundamental mechanics of how we conduct architecture research and train engineers are undergoing a seismic shift. Generative AI and automated discovery pipelines are rapidly evolving from mere syntax checkers into active participants in the architectural process—capable of exploring design spaces, analyzing papers, and even ideating.

This plenary panel explores the immediate future of the computer architecture discipline. We will tackle the pressing questions facing our community: If AI and automated pipelines can handle design space exploration and ideation, what is the evolving role of the human architect? How must our foundational tools (simulators, formal methods, analytical models) adapt to this new paradigm? Finally, how should we update our educational curriculum to train the next generation of architects, and how do we redefine the bar for peer review when AI accelerates research output?

18:00 EDT

#### [Excursion: Dinner & Social](#excursion)

##### Location: City Market

Join us for a Dinner and Social at Raleigh's historic [City Market](https://citymarketraleigh.com/) district, built in 1914. City Market is known for its cobblestone streets, 19th-century lamp lighting, and its open-air shopping and dining. The casual dinner will feature hors d'oeuvres and multiple food stations, featuring NC-inspired dishes, along with beer and wine options, in both [Market Hall](https://www.visitraleigh.com/listing/market-hall-a-historic-event-space/68878/) and [The Grove](https://thegroveatcitymarket.com/) and outdoors. It's a short walk (~10 mins) from the Convention Center. This will be a great chance to relax, mingle, and enjoy some tasty treats.

Please visit the [excursion page](../attend/excursion.php) for more info.
...
#### [Keynote - Beyond the AI Energy Wall: Optimal Server Design and Operation](#k3)
...
#### [Session 7A: Emerging Technologies: Chiplet, Wafer-Scale, etc.](#7a)
...
#### [Session 7B: Performance Modeling / Datacenter](#7b)

##### Location: Room 302

Session Chair: Adwait Jog (University of Virginia)
...
#### [Session 7C: Domain Specific Accelerators 2](#7c)

##### Location: Room 402

Session Chair: Shuwen Deng (Tsinghua University)
...
Session Chair: Hongyuan Liu (Stevens Institute of Technology)
...
#### [Session 8A: Rendering](#8a)

##### Location: Ballroom A

Session Chair: Tony Geng (Rice University)
...
#### [Session 8B: Prefetching and Caches 1](#8b)
...
Session Chair: Yuanchao Xu (University of California, Santa Cruz)
...
#### [Session 9A: Verification and Robustness](#9a)
...
#### [Session 9B: Prefetching and Caches 2](#9b)
...
#### [Session 9C: Quantum 3](#9c)

##### Location: Room 402

Session Chair: Greg Byrd (NC State)
...
#### [Session 9D: Sustainability and Energy Efficiency](#9d)

##### Location: Room 301

Session Chair: Gage Hills (Harvard University)
...
#### [Session 10A: LLM 5](#10a)

##### Location: Ballroom A

Session Chair: Jovan Stojkovic (UT Austin & Meta)
...
#### [Session 10B: ML Accelerators 2](#10b)

##### Location: Room 302

Session Chair: Cong Guo (Duke University)
...
ELSA: An ELastic SNN Inference Architecture for Efﬁcient Neuromorphic Computing
...
#### [Session 10C: PIM/PNM, cont.](#10c)

##### Location: Room 402

Session Chair: Stefanos Kaxiras / Yuan Yao (Uppsala universitet)
...
#### [Session 10D: Domain Specific Accelerators 3](#10d)

##### Location: Room 301

Session Chair: Mohammad Alian (Cornell University)
