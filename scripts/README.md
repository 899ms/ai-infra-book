...
| [render_outline.py](render_outline.py) | 同步各章索引与参考资料索引 |
| [verify_outline.py](verify_outline.py) | 检查章节结构、编号、链接与保留的证据；主要用于历史大纲，不作为发布门槛 |
| [verify_core_principles.py](verify_core_principles.py) | 检查章末小结、参考链接、图号与新增推导 |
