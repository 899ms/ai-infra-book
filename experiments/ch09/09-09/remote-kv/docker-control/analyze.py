...
result=dict(status='colocated_docker_network_kv_recovery_verified',requests=records,outputs_identical=True,
    ...
    scope='One producer and one fresh consumer, six model requests. Native SGLang dynamic backend over HTTP through SSH, colocated Docker storage on RTX host. Not a production remote-cache benchmark, physical SSD I/O, representative p95, complete Agent quality, or complete9-9 matrix.',
