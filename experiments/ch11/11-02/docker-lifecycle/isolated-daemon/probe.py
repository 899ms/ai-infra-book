...
commands=[]
def cmd(args):
 if args[0]=="docker":args=args[:1]+["-H","unix://"+str(P/"docker.sock")]+args[1:]
...
for mode in ['default','unconfined']:
 ...
 try:
  ...
  def watch():
   roots=[P/'exec/runtime-runc/book1102'/cid,P/'exec/containerd/daemon/io.containerd.runtime.v2.task/book1102'/cid,P/'data/containers'/cid]
