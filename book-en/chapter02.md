...
For the figures, computed data, and reconstruction methods in this chapter, see the [figure directory](https://github.com/bojieli/ai-infra-book/blob/main/ch02/README.md). The end-of-chapter material describes the structure and design of each model.
