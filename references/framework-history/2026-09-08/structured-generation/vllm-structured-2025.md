<!-- 从 vllm-structured-2025.html 迁移的资料快照；原始 HTML SHA-256: cd1544a55126ca7ad74632a4f3c1ee34f3e2e32aca10c8c0176619e0667793bc。 -->
...
- [Language models: A brief historical context](#language-models-a-brief-historical-context)
- [Why do we need structured decoding?](#why-do-we-need-structured-decoding)
- [Structured decoding and vLLM](#structured-decoding-and-vllm)
- [Previous limitations in vLLM](#previous-limitations-in-vllm)
- [Integration with XGrammar](#integration-with-xgrammar)
- [Tentative plans for v1](#tentative-plans-for-v1)
...
![](/blog-assets/figures/struct-decode-intro/shogoth-gpt.png)
...
![top level view of structure decoding](/blog-assets/figures/struct-decode-intro/mermaid-intro.svg)
...
![](/blog-assets/figures/struct-decode-intro/constrained-json-fsm.webp)
...
![](/blog-assets/figures/struct-decode-intro/vllm-new-xgrammar.png)

![](/blog-assets/figures/struct-decode-intro/vllm-xgrammar-decode-time-per-output-token.png)
