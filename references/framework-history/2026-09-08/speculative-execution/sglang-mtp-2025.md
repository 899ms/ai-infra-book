<!-- 从 sglang-mtp-2025.html 迁移的资料快照；原始 HTML SHA-256: ad5e778b97aeb7d29adf29039206bba117e0d49aaf1feb8f8ee01acee52719a2。 -->
...
- [What is Multiple Token Prediction (MTP)?](#what-is-multiple-token-prediction-mtp)
- [Why MTP is Fast](#why-mtp-is-fast)
- [Performance Evaluation](#performance-evaluation)
- [Deployment Scenarios and Design Motivation](#deployment-scenarios-and-design-motivation)
- [Case Study 1: Small-Scale Deployment](#case-study-1-small-scale-deployment)
- [Case Study 2: Large-Scale Deployment](#case-study-2-large-scale-deployment)
- [MTP Best Practices](#mtp-best-practices)
- [Future Work](#future-work)
- [Acknowledgment](#acknowledgment)

# Accelerating SGLang with Multiple Token Prediction

Eigen AI TeamJuly 17, 2025
