...
输入：`{"accumulator_precision": "FP32", "batch": 1, "beta": 0, "device": "b200-sxm", "execution_unit": "tensor", "input_precision": "BF16", "output_precision": "BF16", "sparsity": "dense", "tokens": 1}`
...
| compute_service_seconds | 1.491308088888889e-08 |
| memory_service_seconds | 4.196352e-06 |
| roofline_lower_bound_seconds | 4.196352e-06 |
...
- NVIDIA HGX B200 PCF summary identifies180GB perGPU and8xSXM6;1000W is configurable perGPU maximum. Other PCF-table performance/memory rows are not adopted because of unit/rounding discrepancies.
