...
输入：`{"compute_efficiency": null, "device": null, "full_compute_ns": 180000000, "hit_probability": "9/10", "host_gpu_bytes_per_second": 25000000000, "lookup_ns": 10000000, "model": "qwen3-8b", "prefix_tokens": 8192, "queue_a_ns": 250000000, "queue_b_ns": 20000000, "remote_bytes_per_second": 20000000000, "requests_per_second": 16, "retrieval_after_queue": false, "slo_ns": 220000000, "suffix_tokens": 256, "warm_compute_ns": 10000000}`
...
| remote_transfer_ns_exact | `"301989888/5"` |
...
| a_all_tiers_miss_ns_exact | `"430000000"` |
| a_expected_ns_exact | `"277000000"` |
| a_p99_ns_exact | `"430000000"` |
| a_slo_pass_probability_exact | `"0"` |
| a_mean_better_than_b | `false` |
| a_p99_passes_slo | `false` |
| strict_mean_hit_probability_threshold_exact | `"23/17"` |
| fastest_known_valid_path | `"B remote through host"` |

| 路径 | GPU等待ns | 状态取回耗时ns | 首token ns |
| --- | ---: | --- | --- |
| A valid HBM | 250000000 | 0 | 260000000 |
| B recompute | 20000000 | 0 | 200000000 |
| B remote through host | 20000000 | 2967908992/25 | 3217908992/25 |
| A CPU copy survives | 250000000 | 1207959552/25 | 260000000 |
