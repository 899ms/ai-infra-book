...
class ObservedScheduler(Scheduler):
    ...
    def snapshot(self,event,**extra):
        ...
        for rid,r in self.requests.items():
            ...
            requests.append(dict(id=rid,lora_name=r.lora_request.lora_name if r.lora_request else None,lora_id=r.lora_request.lora_int_id if r.lora_request else None,status=r.status.name,computed=r.num_computed_tokens,
