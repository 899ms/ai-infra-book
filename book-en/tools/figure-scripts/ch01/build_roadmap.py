...
rows=[(204,72,'blue',"Part I  Models and Workloads",
       ["1  Introduction to AI Infrastructure","2  Model Architecture","3  Inference and Training Workloads"]),
      (116,72,'green',"Part II  Chips and Systems",
       ["4  Accelerator Architecture","5  Operators and Runtime","6  Supernodes","7  Datacenter Networks"]),
      (4,96,'orange',"Part III  Inference and Training Systems",
       ["8  Inference Optimization","9  Distributed Inference","10  Training Systems","11  Resource Scheduling and Runtime Environment","12  Edge-Cloud Collaboration"])]
