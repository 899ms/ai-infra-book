...
输入：`{"bandwidth_bytes_per_second": 1008000000000, "batch": 1, "latency_ns": 500, "length": 8192, "transaction_bytes": 128, "transactions": 128}`
...
| allocated_window_bytes | 16,384 |
| outstanding_window_bytes | 16,384 |
| active_transactions | 128 |
| throughput_bounds_exact_bytes_per_second | `{"interface": "1008000000000", "transaction_window": "32768000000"}` |
| effective_bandwidth_upper_exact_bytes_per_second | `"32768000000"` |
| serial_service_can_reach_interface | `true` |
| binding_limiters | `["transaction_window"]` |
| required_window_bytes | 504,000.0 |
| required_transactions | 3,938 |
| transaction_limited_bytes_per_second | 32,768,000,000.0 |
| effective_bandwidth_upper_bytes_per_second | 32,768,000,000.0 |
| bandwidth_utilization_upper | 0.032507936507936507 |
| ideal_interface_service_seconds | 0.0011983725714285714 |
| window_constrained_service_lower_seconds | 0.036864 |
| finite_transfer_lower_seconds | 0.036864 |
| assumed_fixed_size_transfer_count | 9,437,184 |
| assumed_fixed_size_payload_bytes | 1,207,959,552 |
| limiter | `"transaction_window"` |
