...
输入：`{"capacity_bytes": 101376, "causal": false, "kv_blocks": [1, 64, 128], "kv_slots": 1, "tokens": 8192}`
...
| best_enumerated_interface_bytes | 272,629,760 |
| measured_hbm_bytes | `null` |
| predicted_kernel_seconds | `null` |

| b | a | 可放 | 接口 bytes | 块对更新 | 旧输出缩放乘法 |
| --- | --- | --- | ---: | ---: | ---: |
| 1 | 128 | True | 272629760 | 524288 | 8588886016 |
| 64 | 82 | True | 423624704 | 12800 | 133169152 |
| 128 | 53 | True | 654311424 | 9920 | 66060288 |
