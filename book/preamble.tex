...
\IfFontExistsTF{Songti SC}{
  \setCJKmainfont[Scale=1,BoldFont={../manuscripts/figure_style/fonts/SourceHanSansCN-Bold.otf}]{Songti SC}
}{
  \setCJKmainfont[Scale=1,BoldFont={../manuscripts/figure_style/fonts/SourceHanSansCN-Bold.otf}]{Noto Sans CJK SC}
}
% Use repository-pinned fonts, independent of fonts installed on the reader's system.
