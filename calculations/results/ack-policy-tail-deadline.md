...
|---|---:|---:|---:|---:|---:|---:|
| up | 9824 | 1 | 1 | 1200 | 28 | 1228 |
| down | 736 | 1 | 1 | 64 | 28 | 92 |

截至 horizon 实际串行线上字节：**1320 B**；已开始包的完整声明字节可能包含截止后尚未发完部分。接收唯一字节：**1168 B**。
...
| down/0 | ack | 控制 | 5/2 | 7/2 | 9/2 | 9/2 | 92 | False | None | —/— |
...
| 方向 | 时刻 s | 事件 | 已知反馈 |
|---|---|---|---|
| up | 9/2 | ack | `{"ranges": [[0, 0]], "ack_delay": "1/2", "app_limited": true, "flow_limited": false}` |
...
{
  "wire_bytes": 1320,
  "serialized_wire_bytes_by_horizon": "1320",
...
|---|---|---|---|---|---:|---|
| down/0 | 5/2 | [[0, 0]] | 1/2 | 1/2 | 8 | False |
