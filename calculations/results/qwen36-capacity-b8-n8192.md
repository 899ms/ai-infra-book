...
| full_attention_kv_bytes | 1342177280 |
| recurrent_fp32_bytes | 503316480 |
| convolution_bf16_bytes | 15728640 |
| declared_reserve_bytes | 2147483648 |

| 设备 | 名义 bytes | 必要预算通过 | 剩余 bytes |
|---|---:|---|---:|
| rtx4090 | 24000000000 | False | -49329927424 |
| rtx5090 | 32000000000 | False | -41329927424 |
| h100-sxm | 80000000000 | True | 6670072576 |
| rtx-pro6000-blackwell-ws | 96000000000 | True | 22670072576 |
| m2-max-38gpu-96gb | 96000000000 | True | 22670072576 |
...
```json
{
  ...
  "summary": {
    ...
    "necessary_budget_bytes": 73329927424
  },
  "devices": [
    {
      "device": "rtx4090",
      ...
      "headroom_after_declared_budget_bytes": -49329927424,
    ...
    },
    {
      ...
      "necessary_budget_fits": false,
      "headroom_after_declared_budget_bytes": -41329927424,
      "runtime_feasibility": null,
      "tokens_per_second": null
    },
    {
      ...
      "headroom_after_declared_budget_bytes": 6670072576,
      "runtime_feasibility": null,
      "tokens_per_second": null
    },
    {
      ...
      "necessary_budget_fits": true,
      "headroom_after_declared_budget_bytes": 22670072576,
      "runtime_feasibility": null,
      "tokens_per_second": null
    },
    {
