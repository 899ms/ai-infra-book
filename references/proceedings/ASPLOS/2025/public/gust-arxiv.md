<!-- 从 gust-arxiv.html 迁移的资料快照；原始 HTML SHA-256: dfc7de5354814759583b399989cc0efc65db9e14089735a44a9dcb31c706247a。 -->
...
Authors:[Armin Gerami](https://arxiv.org/search/cs?searchtype=author&query=Gerami,+A), [Bahar Asgari](https://arxiv.org/search/cs?searchtype=author&query=Asgari,+B)

View a PDF of the paper titled GUST: Graph Edge-Coloring Utilization for Accelerating Sparse Matrix Vector Multiplication, by Armin Gerami and 1 other authors

[View PDF](/pdf/2410.09106)
...
From: Armin Gerami \[[view email](/show-email/cb5f3b94/2410.09106)\]  
**\[v1\]** Thu, 10 Oct 2024 03:32:01 UTC (725 KB)  
...
[\< prev](/prevnext?id=2410.09106&function=prev&context=cs.AR "previous in cs.AR (accesskey p)")   \|   [next \>](/prevnext?id=2410.09106&function=next&context=cs.AR "next in cs.AR (accesskey n)")   

[new](/list/cs.AR/new) \| [recent](/list/cs.AR/recent) \| [2024-10](/list/cs.AR/2024-10)

Change to browse by:

[cs](/abs/2410.09106?context=cs)  

### References & Citations

- [NASA ADS](https://ui.adsabs.harvard.edu/abs/arXiv:2410.09106)
- [Google Scholar](https://scholar.google.com/scholar_lookup?arxiv_id=2410.09106)
- [Semantic Scholar](https://api.semanticscholar.org/arXiv:2410.09106)
...
[![BibSonomy](/static/browse/0.3.4/images/icons/social/bibsonomy.png)](http://www.bibsonomy.org/BibtexHandler?requTask=upload&url=https://arxiv.org/abs/2410.09106&description=GUST:%20Graph%20Edge-Coloring%20Utilization%20for%20Accelerating%20Sparse%20Matrix%20Vector%20Multiplication "Bookmark on BibSonomy") [![Reddit](/static/browse/0.3.4/images/icons/social/reddit.png)](https://reddit.com/submit?url=https://arxiv.org/abs/2410.09106&title=GUST:%20Graph%20Edge-Coloring%20Utilization%20for%20Accelerating%20Sparse%20Matrix%20Vector%20Multiplication "Bookmark on Reddit")
...
[Which authors of this paper are endorsers?](/auth/show-endorsers/2410.09106) \| [Disable MathJax](javascript:setMathjaxCookie()) ([What is MathJax?](https://info.arxiv.org/help/mathjax.html))
