...
| full_attention_kv_bytes | 5368709120 |
| recurrent_fp32_bytes | 2013265920 |
| convolution_bf16_bytes | 62914560 |
| declared_reserve_bytes | 2147483648 |

| 设备 | 名义 bytes | 必要预算通过 | 剩余 bytes |
|---|---:|---|---:|
| rtx4090 | 24000000000 | False | -54913594624 |
| rtx5090 | 32000000000 | False | -46913594624 |
| h100-sxm | 80000000000 | True | 1086405376 |
| rtx-pro6000-blackwell-ws | 96000000000 | True | 17086405376 |
| m2-max-38gpu-96gb | 96000000000 | True | 17086405376 |
...
```json
{
  ...
  "summary": {
    ...
    "necessary_budget_bytes": 78913594624
  },
  "devices": [
    {
      "device": "rtx4090",
      ...
      "headroom_after_declared_budget_bytes": -54913594624,
    ...
    },
    {
      ...
      "necessary_budget_fits": false,
      "headroom_after_declared_budget_bytes": -46913594624,
      "runtime_feasibility": null,
      "tokens_per_second": null
    },
    {
      ...
      "headroom_after_declared_budget_bytes": 1086405376,
      "runtime_feasibility": null,
      "tokens_per_second": null
    },
    {
      ...
      "necessary_budget_fits": true,
      "headroom_after_declared_budget_bytes": 17086405376,
      "runtime_feasibility": null,
      "tokens_per_second": null
    },
    {
