<!-- 从 apple-m3-pro-max-14-specs.html 迁移的资料快照；原始 HTML SHA-256: b1907b1885859dfbb8ea41947be3207625f9fd313edf80b64df954a6284f70dd。 -->
...
- **Weight (M3 Max):** 3.6 pounds (1.62 kg)⁶
...
- **70W USB-C Power Adapter (M3 or M3 Pro with 11-core CPU) or 96W USB-C Power Adapter (M3 Pro with 12-core CPU or M3 Max)**
...
- 96W USB-C Power Adapter (included with M3 Pro with 12-core CPU and M3 Max)

### MacBook Pro and the Environment

The 14-inch MacBook Pro is designed with the following features to reduce its environmental impact:⁹

[See the 14-inch MacBook Pro Product Environmental Report (PDF)](https://www.apple.com/environment/pdf/products/notebooks/14-inch_MacBook_Pro_PER_Oct2023.pdf)

**Made with better materials**

- 32% recycled or renewable content in the device,¹⁰ including:
...
- Over 27% manufacturing electricity sourced from supplier clean energy projects¹³
...
- Over 40% emissions reduction against baseline¹⁴
...
7.  Configuration tested: M3 Max, 14-core CPU, 30-core GPU, 36GB unified memory, 1TB storage.
