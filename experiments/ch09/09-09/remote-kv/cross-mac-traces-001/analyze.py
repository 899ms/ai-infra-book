...
execution=read(O/'execution.json');assert len(execution['rows'])==4 and all(r['exit_code']==0 for r in execution['rows']) and not execution['after_gpu'].strip()
