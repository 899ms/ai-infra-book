...
输入：`{"lost_packets": [0], "model": "qwen3-8b", "packet_bytes": 4096, "path_bytes_per_second": 50000000000, "path_delays_ns": [1000, 9000], "recovery_delay_ns": 20000, "tokens": 4}`
...
| reorder_area_exact_byte_ns | `"2203451392/5"` |
| first_ordered_delivery_exact_ns | `"529096/25"` |
| completion_exact_ns | `"529096/25"` |
