<!-- 从 opencost.html 迁移的资料快照；原始 HTML SHA-256: 0ac1e6cb380ac3c3674af25560c30aaa975934dac7c8af6ce975222f9f074a57。 -->
...
## Foundational definitions[​](#foundational-definitions "Direct link to Foundational definitions")
...
![image4](/assets/images/image4-75c3340ff17c5673798af64af449f667.png)
...
![image2](/assets/images/image2-90cf9b38f360dc4efd181ff230b36847.png)

## Cluster Asset Costs[​](#cluster-asset-costs "Direct link to Cluster Asset Costs")
...
## Shared Costs[​](#shared-costs "Direct link to Shared Costs")
...
## Idle Costs[​](#idle-costs "Direct link to Idle Costs")
...
![image3](/assets/images/image3-bf541a159fddd5a3e1ec455731f0d8fa.png)
...
## Pod States[​](#pod-states "Direct link to Pod States")
...
## Appendix A[​](#appendix-a "Direct link to Appendix A")
...
## Appendix B[​](#appendix-b "Direct link to Appendix B")
...
## Appendix C[​](#appendix-c "Direct link to Appendix C")
...
1.  Resource **usage** costs cannot be part of the idle cost because they are always used, the corresponding resource never "sits idle." [↩](#user-content-fnref-1)

2.  This is because containers are the smallest identifiable unit of "thing that uses resources." For example, the lowest level of reliable CPU usage information is usually a container. [↩](#user-content-fnref-2)

[![](data:image/svg+xml;base64,)Edit this page](https://github.com/opencost/opencost-website/tree/main/docs/specification.md)

[](/docs/developer/export-api)
