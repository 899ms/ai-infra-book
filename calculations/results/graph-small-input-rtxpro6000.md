...
输入：`{"calls": 100000, "config_ns": 20000, "config_speedup": 4, "copy_bandwidth_bytes_per_second": 1792000000000, "device_ns": 20000, "device_speedup": 4, "exposed_submit_ns": 20000, "indirect_ns": 6000, "input_tokens": 256, "metadata_ns": 2000, "padded_tokens": 2048, "real_tokens": 1536, "replay_ns": 3000, "segments": 100, "setup_ns": 1000000000}`

数值是分析计算；字节以 bytes 保存，FMA=2，不是硬件测量。

| 结果 | 值 |
| --- | ---: |
| input_tensor_bytes | 2,097,152 |
| extra_copy_interface_bytes | 4,194,304 |
| extra_copy_ns | 2,340.5714285714284 |
| extra_copy_exact_ns | `"16384/7"` |
...
| minimum_serial_steady_external_input_path | `"copy"` |
| minimum_lifetime_external_input_path | `"copy"` |
| actual_gpu_seconds | `null` |

| 路径 | 每次 us | 含准备总计 ms | 不亏调用数 | 严格更快调用数 |
| --- | ---: | ---: | ---: | ---: |
| eager | 40.000000 | 4000.000000 | 1 | None |
| copy | 27.340571 | 3734.057143 | 78993 | 78993 |
| indirect | 31.000000 | 4100.000000 | 111112 | 111112 |
| direct-output | 25.000000 | 3500.000000 | 66667 | 66667 |
