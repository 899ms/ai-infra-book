<!-- 从 sglang-waterfill-lplb-2026.html 迁移的资料快照；原始 HTML SHA-256: 3f371634ed4ddeee9a2d3d454bbd4ef5893ea104ec73a6ea3f994b91272e768f。 -->
...
- [Background: Load Imbalance in DeepEP MoE Inference](#background-load-imbalance-in-deepep-moe-inference)
- [Waterfill: Lightweight Load Balancing for Shared Expert Dispatch](#waterfill-lightweight-load-balancing-for-shared-expert-dispatch)
- [Waterfill Dispatch Strategy](#waterfill-dispatch-strategy)
- [Shared Expert Fusion as the Enabling Mechanism](#shared-expert-fusion-as-the-enabling-mechanism)
- [LPLB: LP-Based Load Balancing for Redundant Expert Replicas](#lplb-lp-based-load-balancing-for-redundant-expert-replicas)
- [The Problem LPLB Solves](#the-problem-lplb-solves)
- [The LP Formulation](#the-lp-formulation)
- [From Global Counts to a Solved LP](#from-global-counts-to-a-solved-lp)
- [From LP Solution to Token Dispatch](#from-lp-solution-to-token-dispatch)
- [How LPLB Differs from Waterfill](#how-lplb-differs-from-waterfill)
- [When LPLB Helps Most](#when-lplb-helps-most)
- [Evaluation](#evaluation)
- [Waterfill and LPLB on DeepSeek V3/R1](#waterfill-and-lplb-on-deepseek-v3r1)
- [Waterfill on DeepSeek V4](#waterfill-on-deepseek-v4)
- [Accuracy Validation](#accuracy-validation)
- [How to Use](#how-to-use)
- [Enable Waterfill](#enable-waterfill)
- [Enable LPLB](#enable-lplb)
- [Acknowledgment](#acknowledgment)

# Improving DeepEP MoE Load Balance in SGLang with Waterfill and LPLB

NVIDIA TeamJune 26, 2026
...
- Benchmark shape: `batch_size=1000`, `concurrency=256`, `request_rate=inf`, `max_tokens=1`.
...
DeepSeek V4 can use a `HashTopK` routing path, where Waterfill must append and remap the shared-expert slot in the `HashTopK` output path as well. [\#25391](https://github.com/sgl-project/sglang/pull/25391) extends Waterfill to that path. The shared-expert balancing idea itself is not specific to `HashTopK`; it also applies to non-`HashTopK` routing paths.
...
![](data:image/svg+xml;base64,)![](data:image/svg+xml;base64,)
...
DeepSeek V4 support uses the `HashTopK` path added in [\#25391](https://github.com/sgl-project/sglang/pull/25391).
