<!-- 从 vllm-current-tuning.html 迁移的资料快照；原始 HTML SHA-256: 9a1bddb887256138bafd3b706fa9ea8dff120bf6b42046ff4587f77bcec15154。 -->
...
[ Conserving Memory ](../conserving_memory/)
...
- [ Chunked Prefill ](#chunked-prefill)
  - [ Performance Tuning with Chunked Prefill ](#performance-tuning-with-chunked-prefill)
- [ Parallelism Strategies ](#parallelism-strategies)
  - [ Tensor Parallelism (TP) ](#tensor-parallelism-tp)
  - [ Pipeline Parallelism (PP) ](#pipeline-parallelism-pp)
  - [ Expert Parallelism (EP) ](#expert-parallelism-ep)
  - [ Data Parallelism (DP) ](#data-parallelism-dp)
  - [ NUMA Binding for Multi-Socket GPU Nodes ](#numa-binding-for-multi-socket-gpu-nodes)
  - [ CPU Backend Thread Affinity ](#cpu-backend-thread-affinity)
  - [ Batch-level DP for Multi-Modal Encoders ](#batch-level-dp-for-multi-modal-encoders)
- [ Input Processing ](#input-processing)
  - [ fastokens Backend ](#fastokens-backend)
  - [ Parallel Processing ](#parallel-processing)
- [ Multi-Modal Caching ](#multi-modal-caching)
  - [ Processor Caching ](#processor-caching)
  - [ IPC Caching ](#ipc-caching)
    - [ Key-Replicated Cache ](#key-replicated-cache)
    - [ Shared Memory Cache ](#shared-memory-cache)
  - [ Configuration ](#configuration)
  - [ Cache Placement ](#cache-placement)
- [ CPU Resources for GPU Deployments ](#cpu-resources-for-gpu-deployments)
  - [ Minimum CPU Requirements ](#minimum-cpu-requirements)
  - [ Data Parallel and Multi-API Server Deployments ](#data-parallel-and-multi-api-server-deployments)
  - [ Performance Impact ](#performance-impact)
- [ Attention Backend Selection ](#attention-backend-selection)

[ Server Arguments ](../serve_args/)
...
[ cohere_compass ](../../api/vllm/model_executor/models/cohere_compass/)
...
- [ jit_warmup_cutedsl_helper ](../../api/vllm/model_executor/warmup/jit_warmup_cutedsl_helper/)
...
1.  [ Home ](../..)
2.  [ User Guide ](../../usage/)
3.  [ Configuration ](../conserving_memory/)

[![](data:image/svg+xml;base64,)](https://github.com/vllm-project/vllm/edit/main/docs/configuration/optimization.md "Edit this page")
...
For more information, see the [optimization level documentation](../../design/optimization_levels/).

## Faster Startup[¶](#faster-startup "Permanent link")
...
### NUMA Binding for Multi-Socket GPU Nodes[¶](#numa-binding-for-multi-socket-gpu-nodes "Permanent link")
...
- The current implementation binds GPU execution processes such as [`EngineCore`](../../api/vllm/v1/engine/core/#vllm.v1.engine.core.EngineCore "            EngineCore") and multiprocessing workers. It does not apply NUMA binding to frontend API server processes or the DP coordinator.
...
### CPU Backend Thread Affinity[¶](#cpu-backend-thread-affinity "Permanent link")
...
- [Related runtime environment variables](../../getting_started/installation/cpu/#related-runtime-environment-variables)
- [How to decide `VLLM_CPU_OMP_THREADS_BIND`](../../getting_started/installation/cpu/#how-to-decide-vllm_cpu_omp_threads_bind)
...
Multi-modal processor caching is automatically enabled to avoid repeatedly processing the same multi-modal inputs in [`BaseMultiModalProcessor`](../../api/vllm/multimodal/processing/processor/#vllm.multimodal.processing.processor.BaseMultiModalProcessor "            BaseMultiModalProcessor").
...
You can adjust the size of the cache by setting the value of `mm_processor_cache_gb` (default 4 GiB). A processed item larger than this budget is served uncached (with a warning) instead of failing engine startup; raise `mm_processor_cache_gb` if you want those items cached.
...
## CPU Resources for GPU Deployments[¶](#cpu-resources-for-gpu-deployments "Permanent link")

vLLM V1 uses a multi-process architecture (see [V1 Process Architecture](../../design/arch_overview/#v1-process-architecture)) where each process requires CPU resources. Underprovisioning CPU cores is a common source of performance degradation, especially in virtualized environments.

### Minimum CPU Requirements[¶](#minimum-cpu-requirements "Permanent link")
...
### Data Parallel and Multi-API Server Deployments[¶](#data-parallel-and-multi-api-server-deployments "Permanent link")
...
## Attention Backend Selection[¶](#attention-backend-selection "Permanent link")
...
For detailed information on available backends, their feature support, and how to configure them, see the [Attention Backend Feature Support](../../design/attention_backends/) documentation.
