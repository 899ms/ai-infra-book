...
输入：`{"b_hit_fraction": "1", "deadline_seconds": 3, "fresh_tokens": 1000, "prefix_tokens": 19000, "tasks": 1000}`
...
| minimum_b_hit_for_joint_target_exact | `null` |
| b_meets_joint_target | `false` |

| 假想服务 | 总费用 | 预期质量成功数 | 每质量成功费用 | 预期质量且按时成功数 | 每联合成功费用 |
| --- | --- | --- | --- | --- | --- |
| A | 129/10 | 800 | 129/8000 | 0 | None |
| B | 44/5 | 980 | 11/1225 | 0 | None |
