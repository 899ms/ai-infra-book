...
输入：`{"batch": 1, "decode_steps": 1, "element_bytes": 2, "kv_layout": "gqa", "kv_model": "deepseek-v3", "length": 8192, "model": "qwen3-8b", "network_bandwidth": 50000000000, "path": "direct", "staging_bandwidth": 25000000000, "startup_ns": 5000}`
...
| hops_per_message | 1 |
| pd_serialized_ns_exact | `"604104776/25"` |
| af_serialized_ns_exact | `"9294912/25"` |
| byte_matched_extra_ns_exact | `"355000"` |
| equal_time_startup_ns_exact | `"603684864/1775"` |
| af_faster_at_selected_startup | `true` |

| 交接 | payload bytes | 消息数 | 接口 | 接口bytes | 启动次数 | 载荷ns | 启动ns |
| --- | ---: | ---: | --- | ---: | ---: | --- | ---: |
| PD snapshot | 1207959552 | 1 | network | 1207959552 | 1 | 603979776/25 | 5000 |
| AF decode activations | 589824 | 72 | network | 589824 | 72 | 294912/25 | 360000 |
| byte-matched repeated handoffs | 1207959552 | 72 | network | 1207959552 | 72 | 603979776/25 | 360000 |
