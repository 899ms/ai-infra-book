...
输入：`{"accumulator_precision": "FP32", "batch": 256, "beta": 0, "device": "h200-sxm", "execution_unit": "tensor", "input_precision": "BF16", "output_precision": "BF16", "sparsity": "dense", "tokens": 1}`
...
| compute_service_seconds | 8.681085994946943e-06 |
| memory_service_seconds | 7.86432e-06 |
| roofline_lower_bound_seconds | 8.681085994946943e-06 |
| ridge_point_flops_per_byte | 206.14583333333334 |
...
- dense BF16/TF32 按 Hopper 明示的 sparse=2×dense 关系派生，保留产品页舍入精度；不补入不存在的更多有效数字。
- 功率是最高可配置 TDP；持续供给仍依赖功率设置与具体服务器。
- 数据表脚注 1 仍标 preliminary；保存原版本，不能将发布时间或字段完整误作实测。
...
- [sources/hardware/nvidia-h200-specs.pdf](https://dam-cdn.nvd.orangelogic.com/AssetLink/5o2qgy5d2835ve2pm11i62kv8mphqta8.pdf)，SHA256 `ccfeaf25d4dfcd1981d7a02f19355559fa9715ad32cf8f2b14dcf75eb6e0ac6f`。
