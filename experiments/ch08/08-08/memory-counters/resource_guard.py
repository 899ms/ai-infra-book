...
(a.out/'launch.json').write_text(json.dumps(dict(command=a.command,pid=proc.pid,token=token,start_s=start,
    timeout_s=3600,own_rss_limit_bytes=96*1024**3,own_gpu_limit_mib=32*1024,global_available_min_bytes=24*1024**3),indent=2)+'\n')
try:
    while proc.poll() is None:
        ...
        elif own_gpu>32*1024:reason='own_gpu_limit'
